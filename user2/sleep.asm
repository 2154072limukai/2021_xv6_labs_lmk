...
sec = atoi(argv[1]);
  ...
  14:	1aa080e7          	jalr	426(ra) # 1ba <atoi>
sleep(sec);
  18:	00000097          	auipc	ra,0x0
  1c:	332080e7          	jalr	818(ra) # 34a <sleep>
exit(0);
  20:	4501                	li	a0,0
  22:	00000097          	auipc	ra,0x0
  26:	298080e7          	jalr	664(ra) # 2ba <exit>
printf("usage: sleep [seconds]\n");
  2a:	00000517          	auipc	a0,0x0
  2e:	7be50513          	addi	a0,a0,1982 # 7e8 <malloc+0xe8>
  32:	00000097          	auipc	ra,0x0
  36:	610080e7          	jalr	1552(ra) # 642 <printf>
exit(0);
  3a:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b2:	45a50513          	addi	a0,a0,1114 # 808 <digits>
 3b6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 47e:	38eb8b93          	addi	s7,s7,910 # 808 <digits>
 ...
 5be:	24690913          	addi	s2,s2,582 # 800 <malloc+0x100>
        while(*s != 0){
...
free(void *ap)
{
 ...
 686:	19e7b783          	ld	a5,414(a5) # 820 <freep>
 ...
 6b4:	00e6ea63          	bltu	a3,a4,6c8 <free+0x50>
{
 ...
 6f6:	12f73723          	sd	a5,302(a4) # 820 <freep>
}
 6fa:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 728:	0fc53503          	ld	a0,252(a0) # 820 <freep>
 ...
 750:	0d490913          	addi	s2,s2,212 # 820 <freep>
  if(p == (char*)-1)
 754:	5afd                	li	s5,-1
 756:	a88d                	j	7c8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 758:	00000797          	auipc	a5,0x0
 75c:	0d078793          	addi	a5,a5,208 # 828 <base>
 760:	00000717          	auipc	a4,0x0
 764:	0cf73023          	sd	a5,192(a4) # 820 <freep>
 768:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
