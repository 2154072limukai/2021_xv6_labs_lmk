...
int main(int argc, char *argv[])
{
  ...
  14:	37a080e7          	jalr	890(ra) # 38a <pipe>
    pipe(p2);
  18:	fd040513          	addi	a0,s0,-48
  1c:	00000097          	auipc	ra,0x0
  20:	36e080e7          	jalr	878(ra) # 38a <pipe>

    if (fork() == 0)
  24:	00000097          	auipc	ra,0x0
  28:	34e080e7          	jalr	846(ra) # 372 <fork>
  2c:	e935                	bnez	a0,a0 <main+0xa0>
    {
        close(p2[1]);
  2e:	fd442503          	lw	a0,-44(s0)
  32:	00000097          	auipc	ra,0x0
  36:	370080e7          	jalr	880(ra) # 3a2 <close>
        close(p1[0]);
  3a:	fd842503          	lw	a0,-40(s0)
  3e:	00000097          	auipc	ra,0x0
  42:	364080e7          	jalr	868(ra) # 3a2 <close>
        pid = getpid();
  46:	00000097          	auipc	ra,0x0
  4a:	3b4080e7          	jalr	948(ra) # 3fa <getpid>
  4e:	84aa                	mv	s1,a0
        int num_read = read(p2[0], buf, 1);
  50:	4605                	li	a2,1
  52:	00001597          	auipc	a1,0x1
  56:	89e58593          	addi	a1,a1,-1890 # 8f0 <buf>
  5a:	fd042503          	lw	a0,-48(s0)
  5e:	00000097          	auipc	ra,0x0
  62:	334080e7          	jalr	820(ra) # 392 <read>
        if (num_read == 1)
  66:	4785                	li	a5,1
  ...
  72:	30c080e7          	jalr	780(ra) # 37a <exit>
            printf("%d: received ping\n", pid);
  76:	85a6                	mv	a1,s1
  78:	00001517          	auipc	a0,0x1
  7c:	82050513          	addi	a0,a0,-2016 # 898 <malloc+0xe8>
  80:	00000097          	auipc	ra,0x0
  84:	672080e7          	jalr	1650(ra) # 6f2 <printf>
            write(p1[1], buf, 1);
  88:	4605                	li	a2,1
  8a:	00001597          	auipc	a1,0x1
  8e:	86658593          	addi	a1,a1,-1946 # 8f0 <buf>
  92:	fdc42503          	lw	a0,-36(s0)
  96:	00000097          	auipc	ra,0x0
  9a:	304080e7          	jalr	772(ra) # 39a <write>
  9e:	b7f9                	j	6c <main+0x6c>
        close(p1[1]);
  a0:	fdc42503          	lw	a0,-36(s0)
  a4:	00000097          	auipc	ra,0x0
  a8:	2fe080e7          	jalr	766(ra) # 3a2 <close>
        close(p2[0]);
  ...
  c6:	82e90913          	addi	s2,s2,-2002 # 8f0 <buf>
  ca:	4605                	li	a2,1
  cc:	85ca                	mv	a1,s2
  ce:	fd442503          	lw	a0,-44(s0)
  d2:	00000097          	auipc	ra,0x0
  d6:	2c8080e7          	jalr	712(ra) # 39a <write>
  ...
  f6:	7be50513          	addi	a0,a0,1982 # 8b0 <malloc+0x100>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 462:	47250513          	addi	a0,a0,1138 # 8d0 <digits>
 466:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 52e:	3a6b8b93          	addi	s7,s7,934 # 8d0 <digits>
 ...
 66e:	25e90913          	addi	s2,s2,606 # 8c8 <malloc+0x118>
        while(*s != 0){
...
free(void *ap)
{
 ...
 736:	1b67b783          	ld	a5,438(a5) # 8e8 <freep>
...
malloc(uint nbytes)
{
 ...
 7d8:	11453503          	ld	a0,276(a0) # 8e8 <freep>
 ...
 800:	0ec90913          	addi	s2,s2,236 # 8e8 <freep>
  if(p == (char*)-1)
 804:	5afd                	li	s5,-1
 806:	a88d                	j	878 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 808:	00000797          	auipc	a5,0x0
 80c:	16878793          	addi	a5,a5,360 # 970 <base>
 810:	00000717          	auipc	a4,0x0
 814:	0cf73c23          	sd	a5,216(a4) # 8e8 <freep>
 818:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 83a:	0aa73923          	sd	a0,178(a4) # 8e8 <freep>
      return (void*)(p + 1);
