...
int main(int argc, char *argv[])
{
  ...
  56:	8ae58593          	addi	a1,a1,-1874 # 900 <buf>
  ...
  7c:	83050513          	addi	a0,a0,-2000 # 8a8 <malloc+0xe8>
  80:	00000097          	auipc	ra,0x0
  84:	682080e7          	jalr	1666(ra) # 702 <printf>
            write(p1[1], buf, 1);
  88:	4605                	li	a2,1
  8a:	00001597          	auipc	a1,0x1
  8e:	87658593          	addi	a1,a1,-1930 # 900 <buf>
  ...
  c6:	83e90913          	addi	s2,s2,-1986 # 900 <buf>
  ca:	4605                	li	a2,1
  cc:	85ca                	mv	a1,s2
  ...
  f6:	7ce50513          	addi	a0,a0,1998 # 8c0 <malloc+0x100>
  fa:	00000097          	auipc	ra,0x0
  fe:	608080e7          	jalr	1544(ra) # 702 <printf>
...
malloc(uint nbytes)
{
 ...
 81c:	16878793          	addi	a5,a5,360 # 980 <base>
