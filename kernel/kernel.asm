...
0000000080000000 <_entry>:
    ...
    80000016:	75e060ef          	jal	ra,80006774 <start>
...
kfree(void *pa)
{
  ...
  acquire(&kmem.lock);
    ...
    8000005e:	114080e7          	jalr	276(ra) # 8000716e <acquire>
  ...
  release(&kmem.lock);
    ...
    80000072:	1b4080e7          	jalr	436(ra) # 80007222 <release>
}
    ...
    8000008e:	b9a080e7          	jalr	-1126(ra) # 80006c24 <panic>
...
00000000800000dc <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    800000f8:	fea080e7          	jalr	-22(ra) # 800070de <initlock>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000130:	042080e7          	jalr	66(ra) # 8000716e <acquire>
  r = kmem.freelist;
  ...
  release(&kmem.lock);
    ...
    80000148:	0de080e7          	jalr	222(ra) # 80007222 <release>
  ...
  release(&kmem.lock);
    ...
    80000172:	0b4080e7          	jalr	180(ra) # 80007222 <release>
  if(r)
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000348:	f3c080e7          	jalr	-196(ra) # 80007280 <lockfree_read4>
    ...
    80000368:	90a080e7          	jalr	-1782(ra) # 80006c6e <printf>
  ...
  scheduler();        
    ...
    80000430:	248080e7          	jalr	584(ra) # 80006674 <pci_init>
    sockinit();
    80000434:	00006097          	auipc	ra,0x6
    80000438:	e36080e7          	jalr	-458(ra) # 8000626a <sockinit>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    800004aa:	77e080e7          	jalr	1918(ra) # 80006c24 <panic>
...
0000000080000600 <kvmmap>:
{
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    8000062c:	5fc080e7          	jalr	1532(ra) # 80006c24 <panic>
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  memmove(mem, src, sz);
    ...
    800008ca:	35e080e7          	jalr	862(ra) # 80006c24 <panic>
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    80000a0c:	21c080e7          	jalr	540(ra) # 80006c24 <panic>
    }
  }
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000b62:	0c6080e7          	jalr	198(ra) # 80006c24 <panic>
...
proc_mapstacks(pagetable_t kpgtbl) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000dc2:	e66080e7          	jalr	-410(ra) # 80006c24 <panic>
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000dee:	2f4080e7          	jalr	756(ra) # 800070de <initlock>
  initlock(&wait_lock, "wait_lock");
    ...
    80000e06:	2dc080e7          	jalr	732(ra) # 800070de <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000e3c:	2a6080e7          	jalr	678(ra) # 800070de <initlock>
      p->kstack = KSTACK((int) (p - proc));
...
myproc(void) {
  ...
  push_off();
    ...
    80000eae:	278080e7          	jalr	632(ra) # 80007122 <push_off>
  ...
  pop_off();
    ...
    80000ec8:	2fe080e7          	jalr	766(ra) # 800071c2 <pop_off>
  return p;
}
...
forkret(void)
{
  ...
  release(&myproc()->lock);
    ...
    80000eec:	33a080e7          	jalr	826(ra) # 80007222 <release>

  if (first) {
    80000ef0:	00009797          	auipc	a5,0x9
    80000ef4:	9e07a783          	lw	a5,-1568(a5) # 800098d0 <first.1722>
  ...
  usertrapret();
    ...
    80000f0e:	9c07a323          	sw	zero,-1594(a5) # 800098d0 <first.1722>
    fsinit(ROOTDEV);
...
allocpid() {
  ...
  acquire(&pid_lock);
    ...
    80000f38:	23a080e7          	jalr	570(ra) # 8000716e <acquire>
  pid = nextpid;
    80000f3c:	00009797          	auipc	a5,0x9
    80000f40:	99878793          	addi	a5,a5,-1640 # 800098d4 <nextpid>
  ...
  release(&pid_lock);
    ...
    80000f52:	2d4080e7          	jalr	724(ra) # 80007222 <release>
}
...
00000000800010aa <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800010cc:	0a6080e7          	jalr	166(ra) # 8000716e <acquire>
    if(p->state == UNUSED) {
    ...
    800010da:	14c080e7          	jalr	332(ra) # 80007222 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  p->context.sp = p->kstack + PGSIZE;
    ...
    80001158:	0ce080e7          	jalr	206(ra) # 80007222 <release>
    return 0;
    ...
    80001170:	0b6080e7          	jalr	182(ra) # 80007222 <release>
    return 0;
...
0000000080001178 <userinit>:
{
  ...
  uvminit(p->pagetable, initcode, sizeof(initcode));
    ...
    8000119c:	75858593          	addi	a1,a1,1880 # 800098f0 <initcode>
  ...
  release(&p->lock);
    ...
    800011ec:	03a080e7          	jalr	58(ra) # 80007222 <release>
}
...
000000008000126e <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    80001304:	f22080e7          	jalr	-222(ra) # 80007222 <release>
    return -1;
  ...
  release(&np->lock);
    ...
    80001356:	ed0080e7          	jalr	-304(ra) # 80007222 <release>
  acquire(&wait_lock);
    ...
    80001368:	e0a080e7          	jalr	-502(ra) # 8000716e <acquire>
  np->parent = p;
    8000136c:	0329bc23          	sd	s2,56(s3)
  release(&wait_lock);
    80001370:	8526                	mv	a0,s1
    80001372:	00006097          	auipc	ra,0x6
    80001376:	eb0080e7          	jalr	-336(ra) # 80007222 <release>
  acquire(&np->lock);
    8000137a:	854e                	mv	a0,s3
    8000137c:	00006097          	auipc	ra,0x6
    80001380:	df2080e7          	jalr	-526(ra) # 8000716e <acquire>
  np->state = RUNNABLE;
  ...
  release(&np->lock);
    ...
    80001390:	e96080e7          	jalr	-362(ra) # 80007222 <release>
}
...
00000000800013aa <scheduler>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    8000142c:	dfa080e7          	jalr	-518(ra) # 80007222 <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000143e:	d34080e7          	jalr	-716(ra) # 8000716e <acquire>
      if(p->state == RUNNABLE) {
...
000000008000144a <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    80001466:	c92080e7          	jalr	-878(ra) # 800070f4 <holding>
...
0000000080001520 <yield>:
{
  ...
  acquire(&p->lock);
    ...
    80001538:	c3a080e7          	jalr	-966(ra) # 8000716e <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    8000154e:	cd8080e7          	jalr	-808(ra) # 80007222 <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    ...
    8000157c:	bf6080e7          	jalr	-1034(ra) # 8000716e <acquire>
  release(lk);
    80001580:	854a                	mv	a0,s2
    80001582:	00006097          	auipc	ra,0x6
    80001586:	ca0080e7          	jalr	-864(ra) # 80007222 <release>
  ...
  release(&p->lock);
    ...
    800015a4:	c82080e7          	jalr	-894(ra) # 80007222 <release>
  acquire(lk);
    800015a8:	854a                	mv	a0,s2
    800015aa:	00006097          	auipc	ra,0x6
    800015ae:	bc4080e7          	jalr	-1084(ra) # 8000716e <acquire>
}
...
00000000800015c0 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    800015f0:	b82080e7          	jalr	-1150(ra) # 8000716e <acquire>
    havekids = 0;
    ...
    8000168e:	ae4080e7          	jalr	-1308(ra) # 8000716e <acquire>
        if(np->state == ZOMBIE){
    ...
    8000169e:	b88080e7          	jalr	-1144(ra) # 80007222 <release>
        havekids = 1;
    ...
    800016ba:	b6c080e7          	jalr	-1172(ra) # 80007222 <release>
      return -1;
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000171c:	b0a080e7          	jalr	-1270(ra) # 80007222 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000173a:	a38080e7          	jalr	-1480(ra) # 8000716e <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
...
00000000800017b8 <exit>:
{
  ...
  if(p == initproc)
    ...
    800017f4:	434080e7          	jalr	1076(ra) # 80006c24 <panic>
      fileclose(f);
  ...
  acquire(&wait_lock);
    ...
    8000183e:	934080e7          	jalr	-1740(ra) # 8000716e <acquire>
  reparent(p);
  ...
  acquire(&p->lock);
    ...
    8000185e:	914080e7          	jalr	-1772(ra) # 8000716e <acquire>
  p->xstate = status;
  ...
  release(&wait_lock);
    ...
    80001872:	9b4080e7          	jalr	-1612(ra) # 80007222 <release>
  sched();
  ...
  panic("zombie exit");
    ...
    8000188a:	39e080e7          	jalr	926(ra) # 80006c24 <panic>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800018b4:	8be080e7          	jalr	-1858(ra) # 8000716e <acquire>
    if(p->pid == pid){
    ...
    800018c4:	962080e7          	jalr	-1694(ra) # 80007222 <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    800018e6:	940080e7          	jalr	-1728(ra) # 80007222 <release>
      return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    800019ce:	2a4080e7          	jalr	676(ra) # 80006c6e <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80001a10:	262080e7          	jalr	610(ra) # 80006c6e <printf>
    printf("\n");
    80001a14:	8552                	mv	a0,s4
    80001a16:	00005097          	auipc	ra,0x5
    80001a1a:	258080e7          	jalr	600(ra) # 80006c6e <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001ae0:	602080e7          	jalr	1538(ra) # 800070de <initlock>
}
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001bba:	5b8080e7          	jalr	1464(ra) # 8000716e <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001bda:	64c080e7          	jalr	1612(ra) # 80007222 <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001c4a:	028080e7          	jalr	40(ra) # 80006c6e <printf>
    80001c4e:	a029                	j	80001c58 <devintr+0x70>
      uartintr();
    80001c50:	00005097          	auipc	ra,0x5
    80001c54:	43e080e7          	jalr	1086(ra) # 8000708e <uartintr>
      plic_complete(irq);
    ...
    80001c74:	d8a080e7          	jalr	-630(ra) # 800059fa <e1000_intr>
...
0000000080001c9c <usertrap>:
{
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001cee:	596080e7          	jalr	1430(ra) # 80007280 <lockfree_read4>
    ...
    80001d02:	f26080e7          	jalr	-218(ra) # 80006c24 <panic>
    if(lockfree_read4(&p->killed))
    80001d06:	02850513          	addi	a0,a0,40
    80001d0a:	00005097          	auipc	ra,0x5
    80001d0e:	576080e7          	jalr	1398(ra) # 80007280 <lockfree_read4>
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001d38:	54c080e7          	jalr	1356(ra) # 80007280 <lockfree_read4>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001d82:	ef0080e7          	jalr	-272(ra) # 80006c6e <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001d9a:	ed8080e7          	jalr	-296(ra) # 80006c6e <printf>
    p->killed = 1;
...
0000000080001dae <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001e08:	e20080e7          	jalr	-480(ra) # 80006c24 <panic>
    ...
    80001e18:	e10080e7          	jalr	-496(ra) # 80006c24 <panic>
    printf("scause %p\n", scause);
    ...
    80001e2a:	e48080e7          	jalr	-440(ra) # 80006c6e <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001ede:	d4a080e7          	jalr	-694(ra) # 80006c24 <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002046:	c2c080e7          	jalr	-980(ra) # 80006c6e <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    8000216c:	006080e7          	jalr	6(ra) # 8000716e <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    800021c0:	066080e7          	jalr	102(ra) # 80007222 <release>
  return 0;
    ...
    800021e2:	044080e7          	jalr	68(ra) # 80007222 <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002232:	f40080e7          	jalr	-192(ra) # 8000716e <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    8000224a:	fdc080e7          	jalr	-36(ra) # 80007222 <release>
  return xticks;
}
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002282:	e60080e7          	jalr	-416(ra) # 800070de <initlock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    8000230a:	e68080e7          	jalr	-408(ra) # 8000716e <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    8000234a:	edc080e7          	jalr	-292(ra) # 80007222 <release>
      acquiresleep(&b->lock);
  ...
  panic("bget: no buffers");
    ...
    80002388:	8a0080e7          	jalr	-1888(ra) # 80006c24 <panic>
      b->dev = dev;
    ...
    800023a8:	e7e080e7          	jalr	-386(ra) # 80007222 <release>
      acquiresleep(&b->lock);
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002414:	00005097          	auipc	ra,0x5
    80002418:	810080e7          	jalr	-2032(ra) # 80006c24 <panic>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002450:	d22080e7          	jalr	-734(ra) # 8000716e <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    8000249a:	d8c080e7          	jalr	-628(ra) # 80007222 <release>
}
    ...
    800024b6:	772080e7          	jalr	1906(ra) # 80006c24 <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800024d2:	ca0080e7          	jalr	-864(ra) # 8000716e <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    800024e8:	d3e080e7          	jalr	-706(ra) # 80007222 <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000250e:	c64080e7          	jalr	-924(ra) # 8000716e <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002524:	d02080e7          	jalr	-766(ra) # 80007222 <release>
}
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    800025aa:	67e080e7          	jalr	1662(ra) # 80006c24 <panic>
...
00000000800025ae <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    80002670:	5b8080e7          	jalr	1464(ra) # 80006c24 <panic>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800027b6:	472080e7          	jalr	1138(ra) # 80006c24 <panic>
...
00000000800027ba <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    800027da:	998080e7          	jalr	-1640(ra) # 8000716e <acquire>
  empty = 0;
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80002820:	a06080e7          	jalr	-1530(ra) # 80007222 <release>
      return ip;
  ...
  release(&itable.lock);
    ...
    80002850:	9d6080e7          	jalr	-1578(ra) # 80007222 <release>
}
    ...
    80002872:	3b6080e7          	jalr	950(ra) # 80006c24 <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    800028f2:	336080e7          	jalr	822(ra) # 80006c24 <panic>
...
00000000800028f6 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80002918:	7ca080e7          	jalr	1994(ra) # 800070de <initlock>
  for(i = 0; i < NINODE; i++) {
...
0000000080002956 <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    800029d6:	252080e7          	jalr	594(ra) # 80006c24 <panic>
...
0000000080002ab0 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002ac8:	6aa080e7          	jalr	1706(ra) # 8000716e <acquire>
  ip->ref++;
  ...
  release(&itable.lock);
    ...
    80002ade:	748080e7          	jalr	1864(ra) # 80007222 <release>
}
...
0000000080002aee <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002b2a:	0fe080e7          	jalr	254(ra) # 80006c24 <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002bac:	07c080e7          	jalr	124(ra) # 80006c24 <panic>
...
0000000080002bb0 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002bf8:	030080e7          	jalr	48(ra) # 80006c24 <panic>
...
0000000080002ca8 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80002cc2:	4b0080e7          	jalr	1200(ra) # 8000716e <acquire>
  ...
  release(&itable.lock);
    ...
    80002ce0:	546080e7          	jalr	1350(ra) # 80007222 <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002d14:	512080e7          	jalr	1298(ra) # 80007222 <release>
    itrunc(ip);
    ...
    80002d4a:	428080e7          	jalr	1064(ra) # 8000716e <acquire>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003008:	c20080e7          	jalr	-992(ra) # 80006c24 <panic>
    ...
    80003018:	c10080e7          	jalr	-1008(ra) # 80006c24 <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
...
000000008000341c <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003444:	c9e080e7          	jalr	-866(ra) # 800070de <initlock>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800034d8:	c9a080e7          	jalr	-870(ra) # 8000716e <acquire>
  while(1){
    if(log.committing){
    ...
    80003530:	cf6080e7          	jalr	-778(ra) # 80007222 <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003560:	c12080e7          	jalr	-1006(ra) # 8000716e <acquire>
  log.outstanding -= 1;
  ...
  release(&log.lock);
    ...
    80003588:	c9e080e7          	jalr	-866(ra) # 80007222 <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800035a0:	bd2080e7          	jalr	-1070(ra) # 8000716e <acquire>
    log.committing = 0;
    ...
    800035b8:	c6e080e7          	jalr	-914(ra) # 80007222 <release>
}
    ...
    800035da:	64e080e7          	jalr	1614(ra) # 80006c24 <panic>
    wakeup(&log);
  ...
  release(&log.lock);
    ...
    800035f6:	c30080e7          	jalr	-976(ra) # 80007222 <release>
  if(do_commit){
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800036b4:	abe080e7          	jalr	-1346(ra) # 8000716e <acquire>
  ...
  release(&log.lock);
    ...
    8000376e:	ab8080e7          	jalr	-1352(ra) # 80007222 <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    8000379c:	946080e7          	jalr	-1722(ra) # 800070de <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800037d0:	9a2080e7          	jalr	-1630(ra) # 8000716e <acquire>
  while (lk->locked) {
  ...
  release(&lk->lk);
    ...
    800037fe:	a28080e7          	jalr	-1496(ra) # 80007222 <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003826:	94c080e7          	jalr	-1716(ra) # 8000716e <acquire>
  lk->locked = 0;
  ...
  release(&lk->lk);
    ...
    80003842:	9e4080e7          	jalr	-1564(ra) # 80007222 <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    8000386c:	906080e7          	jalr	-1786(ra) # 8000716e <acquire>
  ...
  release(&lk->lk);
    ...
    8000387c:	9aa080e7          	jalr	-1622(ra) # 80007222 <release>
  return r;
}
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800038c0:	00004097          	auipc	ra,0x4
    800038c4:	81e080e7          	jalr	-2018(ra) # 800070de <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    800038e6:	88c080e7          	jalr	-1908(ra) # 8000716e <acquire>
  ...
  release(&ftable.lock);
    ...
    80003912:	914080e7          	jalr	-1772(ra) # 80007222 <release>
  return 0;
    ...
    8000392a:	8fc080e7          	jalr	-1796(ra) # 80007222 <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    8000394e:	00004097          	auipc	ra,0x4
    80003952:	820080e7          	jalr	-2016(ra) # 8000716e <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    8000396c:	8ba080e7          	jalr	-1862(ra) # 80007222 <release>
  return f;
}
    ...
    80003988:	2a0080e7          	jalr	672(ra) # 80006c24 <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800039ae:	7c4080e7          	jalr	1988(ra) # 8000716e <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    800039ec:	83a080e7          	jalr	-1990(ra) # 80007222 <release>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003a0c:	9b0080e7          	jalr	-1616(ra) # 800063b8 <sockclose>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003b1c:	930080e7          	jalr	-1744(ra) # 80006448 <sockread>
  ...
  return r;
    ...
    80003ba8:	080080e7          	jalr	128(ra) # 80006c24 <panic>
    return -1;
    ...
    80003bbc:	12078263          	beqz	a5,80003ce0 <filewrite+0x128>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003bfe:	91e080e7          	jalr	-1762(ra) # 80006518 <sockwrite>
  else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    80003cdc:	f4c080e7          	jalr	-180(ra) # 80006c24 <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003d4c:	396080e7          	jalr	918(ra) # 800070de <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003dda:	398080e7          	jalr	920(ra) # 8000716e <acquire>
  if(writable){
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003dfe:	428080e7          	jalr	1064(ra) # 80007222 <release>
    kfree((char*)pi);
    ...
    80003e30:	3f6080e7          	jalr	1014(ra) # 80007222 <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003e66:	30c080e7          	jalr	780(ra) # 8000716e <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003e84:	3a2080e7          	jalr	930(ra) # 80007222 <release>
      return -1;
  ...
  release(&pi->lock);
    ...
    80003f26:	300080e7          	jalr	768(ra) # 80007222 <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003f5c:	216080e7          	jalr	534(ra) # 8000716e <acquire>
  ...
  release(&pi->lock);
    ...
    80003ff0:	236080e7          	jalr	566(ra) # 80007222 <release>
  return i;
}
    ...
    80004010:	216080e7          	jalr	534(ra) # 80007222 <release>
      return -1;
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004118:	b10080e7          	jalr	-1264(ra) # 80006c24 <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    80004424:	0d050793          	addi	a5,a0,208 # fffffffffffff0d0 <end+0xffffffff7ffd7b50>
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    8000454a:	6de080e7          	jalr	1758(ra) # 80006c24 <panic>
    dp->nlink++;  // for ".."
...
00000000800048b8 <sys_unlink>:
{
  ...
  return 0;
    ...
    800049e4:	244080e7          	jalr	580(ra) # 80006c24 <panic>
...
sys_connect(void)
{
  ...
  if(sockalloc(&f, raddr, lport, rport) < 0)
    ...
    80005022:	274080e7          	jalr	628(ra) # 80006292 <sockalloc>
...
000000008000527c <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    8000529a:	e48080e7          	jalr	-440(ra) # 800070de <initlock>
  ...
  *R(VIRTIO_MMIO_QUEUE_PFN) = ((uint64)disk.pages) >> PGSHIFT;
  ...
  disk.used = (struct virtq_used *) (disk.pages + PGSIZE);
    ...
    8000539c:	88c080e7          	jalr	-1908(ra) # 80006c24 <panic>
    ...
    800053ac:	87c080e7          	jalr	-1924(ra) # 80006c24 <panic>
    ...
    800053bc:	86c080e7          	jalr	-1940(ra) # 80006c24 <panic>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800053fa:	d78080e7          	jalr	-648(ra) # 8000716e <acquire>
  for(int i = 0; i < 3; i++){
  ...
  disk.desc[idx[0]].next = idx[1];
    ...
    800054fa:	00e61723          	sh	a4,14(a2) # ffffffffffffe00e <end+0xffffffff7ffd6a8e>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  release(&disk.vdisk_lock);
    ...
    80005634:	bf2080e7          	jalr	-1038(ra) # 80007222 <release>
}
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800056ae:	ac4080e7          	jalr	-1340(ra) # 8000716e <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80005740:	ae6080e7          	jalr	-1306(ra) # 80007222 <release>
}
    ...
    8000575c:	4cc080e7          	jalr	1228(ra) # 80006c24 <panic>
...
e1000_init(uint32 *xregs)
{
  ...
  initlock(&e1000_lock, "e1000");
    ...
    8000577c:	88850513          	addi	a0,a0,-1912 # 8001f000 <e1000_lock>
    80005780:	00002097          	auipc	ra,0x2
    80005784:	95e080e7          	jalr	-1698(ra) # 800070de <initlock>

  regs = xregs;
    80005788:	00005797          	auipc	a5,0x5
    8000578c:	8897bc23          	sd	s1,-1896(a5) # 8000a020 <regs>

  // Reset the device
  regs[E1000_IMS] = 0; // disable interrupts
    80005790:	0c04a823          	sw	zero,208(s1)
  regs[E1000_CTL] |= E1000_CTL_RST;
    80005794:	409c                	lw	a5,0(s1)
    80005796:	00400737          	lui	a4,0x400
    8000579a:	8fd9                	or	a5,a5,a4
    8000579c:	2781                	sext.w	a5,a5
    8000579e:	c09c                	sw	a5,0(s1)
  regs[E1000_IMS] = 0; // redisable interrupts
    800057a0:	0c04a823          	sw	zero,208(s1)
  __sync_synchronize();
    800057a4:	0ff0000f          	fence

  // [E1000 14.5] Transmit initialization
  memset(tx_ring, 0, sizeof(tx_ring));
    800057a8:	10000613          	li	a2,256
    800057ac:	4581                	li	a1,0
    800057ae:	0001a517          	auipc	a0,0x1a
    800057b2:	87250513          	addi	a0,a0,-1934 # 8001f020 <tx_ring>
    800057b6:	ffffb097          	auipc	ra,0xffffb
    800057ba:	9c2080e7          	jalr	-1598(ra) # 80000178 <memset>
  for (i = 0; i < TX_RING_SIZE; i++) {
    800057be:	0001a717          	auipc	a4,0x1a
    800057c2:	86e70713          	addi	a4,a4,-1938 # 8001f02c <tx_ring+0xc>
    800057c6:	0001a797          	auipc	a5,0x1a
    800057ca:	95a78793          	addi	a5,a5,-1702 # 8001f120 <tx_mbufs>
    800057ce:	0001a617          	auipc	a2,0x1a
    800057d2:	9d260613          	addi	a2,a2,-1582 # 8001f1a0 <rx_ring>
    tx_ring[i].status = E1000_TXD_STAT_DD;
    800057d6:	4685                	li	a3,1
    800057d8:	00d70023          	sb	a3,0(a4)
    tx_mbufs[i] = 0;
    800057dc:	0007b023          	sd	zero,0(a5)
  for (i = 0; i < TX_RING_SIZE; i++) {
    800057e0:	0741                	addi	a4,a4,16
    800057e2:	07a1                	addi	a5,a5,8
    800057e4:	fec79ae3          	bne	a5,a2,800057d8 <e1000_init+0x78>
  }
  regs[E1000_TDBAL] = (uint64) tx_ring;
    800057e8:	0001a717          	auipc	a4,0x1a
    800057ec:	83870713          	addi	a4,a4,-1992 # 8001f020 <tx_ring>
    800057f0:	00005797          	auipc	a5,0x5
    800057f4:	8307b783          	ld	a5,-2000(a5) # 8000a020 <regs>
    800057f8:	6691                	lui	a3,0x4
    800057fa:	97b6                	add	a5,a5,a3
    800057fc:	80e7a023          	sw	a4,-2048(a5)
  if(sizeof(tx_ring) % 128 != 0)
    panic("e1000");
  regs[E1000_TDLEN] = sizeof(tx_ring);
    80005800:	10000713          	li	a4,256
    80005804:	80e7a423          	sw	a4,-2040(a5)
  regs[E1000_TDH] = regs[E1000_TDT] = 0;
    80005808:	8007ac23          	sw	zero,-2024(a5)
    8000580c:	8007a823          	sw	zero,-2032(a5)
  
  // [E1000 14.4] Receive initialization
  memset(rx_ring, 0, sizeof(rx_ring));
    80005810:	0001a917          	auipc	s2,0x1a
    80005814:	99090913          	addi	s2,s2,-1648 # 8001f1a0 <rx_ring>
    80005818:	10000613          	li	a2,256
    8000581c:	4581                	li	a1,0
    8000581e:	854a                	mv	a0,s2
    80005820:	ffffb097          	auipc	ra,0xffffb
    80005824:	958080e7          	jalr	-1704(ra) # 80000178 <memset>
  for (i = 0; i < RX_RING_SIZE; i++) {
    80005828:	0001a497          	auipc	s1,0x1a
    8000582c:	a7848493          	addi	s1,s1,-1416 # 8001f2a0 <rx_mbufs>
    80005830:	0001a997          	auipc	s3,0x1a
    80005834:	af098993          	addi	s3,s3,-1296 # 8001f320 <lock>
    rx_mbufs[i] = mbufalloc(0);
    80005838:	4501                	li	a0,0
    8000583a:	00000097          	auipc	ra,0x0
    8000583e:	472080e7          	jalr	1138(ra) # 80005cac <mbufalloc>
    80005842:	e088                	sd	a0,0(s1)
    if (!rx_mbufs[i])
    80005844:	c945                	beqz	a0,800058f4 <e1000_init+0x194>
      panic("e1000");
    rx_ring[i].addr = (uint64) rx_mbufs[i]->head;
    80005846:	651c                	ld	a5,8(a0)
    80005848:	00f93023          	sd	a5,0(s2)
  for (i = 0; i < RX_RING_SIZE; i++) {
    8000584c:	04a1                	addi	s1,s1,8
    8000584e:	0941                	addi	s2,s2,16
    80005850:	ff3494e3          	bne	s1,s3,80005838 <e1000_init+0xd8>
  }
  regs[E1000_RDBAL] = (uint64) rx_ring;
    80005854:	00004697          	auipc	a3,0x4
    80005858:	7cc6b683          	ld	a3,1996(a3) # 8000a020 <regs>
    8000585c:	0001a717          	auipc	a4,0x1a
    80005860:	94470713          	addi	a4,a4,-1724 # 8001f1a0 <rx_ring>
    80005864:	678d                	lui	a5,0x3
    80005866:	97b6                	add	a5,a5,a3
    80005868:	80e7a023          	sw	a4,-2048(a5) # 2800 <_entry-0x7fffd800>
  if(sizeof(rx_ring) % 128 != 0)
    panic("e1000");
  regs[E1000_RDH] = 0;
    8000586c:	8007a823          	sw	zero,-2032(a5)
  regs[E1000_RDT] = RX_RING_SIZE - 1;
    80005870:	473d                	li	a4,15
    80005872:	80e7ac23          	sw	a4,-2024(a5)
  regs[E1000_RDLEN] = sizeof(rx_ring);
    80005876:	10000713          	li	a4,256
    8000587a:	80e7a423          	sw	a4,-2040(a5)

  // filter by qemu's MAC address, 52:54:00:12:34:56
  regs[E1000_RA] = 0x12005452;
    8000587e:	6715                	lui	a4,0x5
    80005880:	00e68633          	add	a2,a3,a4
    80005884:	120057b7          	lui	a5,0x12005
    80005888:	4527879b          	addiw	a5,a5,1106
    8000588c:	40f62023          	sw	a5,1024(a2)
  regs[E1000_RA+1] = 0x5634 | (1<<31);
    80005890:	800057b7          	lui	a5,0x80005
    80005894:	6347879b          	addiw	a5,a5,1588
    80005898:	40f62223          	sw	a5,1028(a2)
  // multicast table
  for (int i = 0; i < 4096/32; i++)
    8000589c:	20070793          	addi	a5,a4,512 # 5200 <_entry-0x7fffae00>
    800058a0:	97b6                	add	a5,a5,a3
    800058a2:	40070713          	addi	a4,a4,1024
    800058a6:	9736                	add	a4,a4,a3
    regs[E1000_MTA + i] = 0;
    800058a8:	0007a023          	sw	zero,0(a5) # ffffffff80005000 <end+0xfffffffefffdda80>
  for (int i = 0; i < 4096/32; i++)
    800058ac:	0791                	addi	a5,a5,4
    800058ae:	fee79de3          	bne	a5,a4,800058a8 <e1000_init+0x148>

  // transmitter control bits.
  regs[E1000_TCTL] = E1000_TCTL_EN |  // enable
    800058b2:	000407b7          	lui	a5,0x40
    800058b6:	10a7879b          	addiw	a5,a5,266
    800058ba:	40f6a023          	sw	a5,1024(a3)
    E1000_TCTL_PSP |                  // pad short packets
    (0x10 << E1000_TCTL_CT_SHIFT) |   // collision stuff
    (0x40 << E1000_TCTL_COLD_SHIFT);
  regs[E1000_TIPG] = 10 | (8<<10) | (6<<20); // inter-pkt gap
    800058be:	006027b7          	lui	a5,0x602
    800058c2:	27a9                	addiw	a5,a5,10
    800058c4:	40f6a823          	sw	a5,1040(a3)

  // receiver control bits.
  regs[E1000_RCTL] = E1000_RCTL_EN | // enable receiver
    800058c8:	040087b7          	lui	a5,0x4008
    800058cc:	2789                	addiw	a5,a5,2
    800058ce:	10f6a023          	sw	a5,256(a3)
  ...
  regs[E1000_RDTR] = 0; // interrupt after every received packet (no timer)
    800058d2:	678d                	lui	a5,0x3
    800058d4:	97b6                	add	a5,a5,a3
    800058d6:	8207a023          	sw	zero,-2016(a5) # 2820 <_entry-0x7fffd7e0>
  regs[E1000_RADV] = 0; // interrupt after every packet (no timer)
    800058da:	8207a623          	sw	zero,-2004(a5)
  regs[E1000_IMS] = (1 << 7); // RXDW -- Receiver Descriptor Write Back
    800058de:	08000793          	li	a5,128
    800058e2:	0cf6a823          	sw	a5,208(a3)
}
    800058e6:	70a2                	ld	ra,40(sp)
    800058e8:	7402                	ld	s0,32(sp)
    800058ea:	64e2                	ld	s1,24(sp)
    800058ec:	6942                	ld	s2,16(sp)
    800058ee:	69a2                	ld	s3,8(sp)
    800058f0:	6145                	addi	sp,sp,48
    800058f2:	8082                	ret
      panic("e1000");
    800058f4:	00004517          	auipc	a0,0x4
    800058f8:	eec50513          	addi	a0,a0,-276 # 800097e0 <syscalls+0x408>
    800058fc:	00001097          	auipc	ra,0x1
    80005900:	328080e7          	jalr	808(ra) # 80006c24 <panic>

0000000080005904 <e1000_transmit>:
...
e1000_transmit(struct mbuf *m)
{
  ...
  //
  acquire(&e1000_lock);
    80005914:	00019997          	auipc	s3,0x19
    80005918:	6ec98993          	addi	s3,s3,1772 # 8001f000 <e1000_lock>
    8000591c:	854e                	mv	a0,s3
    8000591e:	00002097          	auipc	ra,0x2
    80005922:	850080e7          	jalr	-1968(ra) # 8000716e <acquire>
  // printf("e1000_transmit: called mbuf=%p\n",m);
  uint32 idx = regs[E1000_TDT]; 
    80005926:	00004797          	auipc	a5,0x4
    8000592a:	6fa7b783          	ld	a5,1786(a5) # 8000a020 <regs>
    8000592e:	6711                	lui	a4,0x4
    80005930:	97ba                	add	a5,a5,a4
    80005932:	8187a783          	lw	a5,-2024(a5)
    80005936:	0007849b          	sext.w	s1,a5
  ...
  if (tx_ring[idx].status != E1000_TXD_STAT_DD)
    8000593a:	1782                	slli	a5,a5,0x20
    8000593c:	9381                	srli	a5,a5,0x20
    8000593e:	0792                	slli	a5,a5,0x4
    80005940:	97ce                	add	a5,a5,s3
    80005942:	02c7c703          	lbu	a4,44(a5)
    80005946:	4785                	li	a5,1
    80005948:	08f71863          	bne	a4,a5,800059d8 <e1000_transmit+0xd4>
    ...
    if (tx_mbufs[idx] != 0)
    8000594c:	02049793          	slli	a5,s1,0x20
    80005950:	9381                	srli	a5,a5,0x20
    80005952:	00379713          	slli	a4,a5,0x3
    80005956:	00019797          	auipc	a5,0x19
    8000595a:	6aa78793          	addi	a5,a5,1706 # 8001f000 <e1000_lock>
    8000595e:	97ba                	add	a5,a5,a4
    80005960:	1207b503          	ld	a0,288(a5)
    80005964:	c509                	beqz	a0,8000596e <e1000_transmit+0x6a>
    {
      // printf("e1000_transmit: freeing old mbuf tx_mbufs[%d]=%p\n",idx,tx_mbufs[idx]);
      mbuffree(tx_mbufs[idx]);
    80005966:	00000097          	auipc	ra,0x0
    8000596a:	39e080e7          	jalr	926(ra) # 80005d04 <mbuffree>
    }
    ...
    8000596e:	00019517          	auipc	a0,0x19
    80005972:	69250513          	addi	a0,a0,1682 # 8001f000 <e1000_lock>
    80005976:	1482                	slli	s1,s1,0x20
    80005978:	9081                	srli	s1,s1,0x20
    8000597a:	00449793          	slli	a5,s1,0x4
    8000597e:	97aa                	add	a5,a5,a0
    80005980:	00893703          	ld	a4,8(s2)
    80005984:	f398                	sd	a4,32(a5)
    tx_ring[idx].length = (uint16) m->len;
    80005986:	01092703          	lw	a4,16(s2)
    8000598a:	02e79423          	sh	a4,40(a5)
    tx_ring[idx].cso = 0;
    8000598e:	02078523          	sb	zero,42(a5)
    tx_ring[idx].css = 0;
    80005992:	020786a3          	sb	zero,45(a5)
    // Set the necessary cmd flags 
    // (look at Section 3.3 in the E1000 manual)
    tx_ring[idx].cmd = E1000_TXD_CMD_RS | E1000_TXD_CMD_EOP;
    80005996:	4725                	li	a4,9
    80005998:	02e785a3          	sb	a4,43(a5)
    // and stash away a pointer to the mbuf for later freeing.
    tx_mbufs[idx] = m;
    8000599c:	048e                	slli	s1,s1,0x3
    8000599e:	94aa                	add	s1,s1,a0
    800059a0:	1324b023          	sd	s2,288(s1)
    // Finally, update the ring position 
    // by adding one to E1000_TDT modulo TX_RING_SIZE.
    regs[E1000_TDT] = (regs[E1000_TDT] + 1) % TX_RING_SIZE;
    800059a4:	00004717          	auipc	a4,0x4
    800059a8:	67c73703          	ld	a4,1660(a4) # 8000a020 <regs>
    800059ac:	6791                	lui	a5,0x4
    800059ae:	973e                	add	a4,a4,a5
    800059b0:	81872783          	lw	a5,-2024(a4)
    800059b4:	2785                	addiw	a5,a5,1
    800059b6:	8bbd                	andi	a5,a5,15
    800059b8:	80f72c23          	sw	a5,-2024(a4)
  ...
  release(&e1000_lock);
    800059c0:	00002097          	auipc	ra,0x2
    800059c4:	862080e7          	jalr	-1950(ra) # 80007222 <release>
  ...
  return 0;
    ...
    800059d2:	69a2                	ld	s3,8(sp)
    800059d4:	6145                	addi	sp,sp,48
    800059d6:	8082                	ret
    printf("e1000_transmit: tx queue full\n");
    800059d8:	00004517          	auipc	a0,0x4
    800059dc:	e1050513          	addi	a0,a0,-496 # 800097e8 <syscalls+0x410>
    800059e0:	00001097          	auipc	ra,0x1
    800059e4:	28e080e7          	jalr	654(ra) # 80006c6e <printf>
    __sync_synchronize();
    800059e8:	0ff0000f          	fence
    release(&e1000_lock);
    800059ec:	854e                	mv	a0,s3
    800059ee:	00002097          	auipc	ra,0x2
    800059f2:	834080e7          	jalr	-1996(ra) # 80007222 <release>
    return -1;
    800059f6:	557d                	li	a0,-1
    800059f8:	bfc9                	j	800059ca <e1000_transmit+0xc6>

00000000800059fa <e1000_intr>:
...
e1000_intr(void)
{
    ...
    80005a00:	fc26                	sd	s1,56(sp)
    80005a02:	f84a                	sd	s2,48(sp)
    80005a04:	f44e                	sd	s3,40(sp)
    80005a06:	f052                	sd	s4,32(sp)
    80005a08:	ec56                	sd	s5,24(sp)
    80005a0a:	e85a                	sd	s6,16(sp)
    80005a0c:	e45e                	sd	s7,8(sp)
    80005a0e:	e062                	sd	s8,0(sp)
    80005a10:	0880                	addi	s0,sp,80
  // tell the e1000 we've seen this interrupt;
  // without this the e1000 won't raise any
  // further interrupts.
  regs[E1000_ICR] = 0xffffffff;
    80005a12:	00004797          	auipc	a5,0x4
    80005a16:	60e7b783          	ld	a5,1550(a5) # 8000a020 <regs>
    80005a1a:	577d                	li	a4,-1
    80005a1c:	0ce7a023          	sw	a4,192(a5)
  uint32 idx = (regs[E1000_RDT] + 1) % RX_RING_SIZE;
    80005a20:	670d                	lui	a4,0x3
    80005a22:	97ba                	add	a5,a5,a4
    80005a24:	8187a783          	lw	a5,-2024(a5)
    80005a28:	2785                	addiw	a5,a5,1
    80005a2a:	00f7f993          	andi	s3,a5,15
  struct rx_desc* dest = &rx_ring[idx];
    80005a2e:	00499793          	slli	a5,s3,0x4
    80005a32:	00019497          	auipc	s1,0x19
    80005a36:	76e48493          	addi	s1,s1,1902 # 8001f1a0 <rx_ring>
    80005a3a:	94be                	add	s1,s1,a5
  while (rx_ring[idx].status & E1000_RXD_STAT_DD)
    80005a3c:	00019717          	auipc	a4,0x19
    80005a40:	5c470713          	addi	a4,a4,1476 # 8001f000 <e1000_lock>
    80005a44:	97ba                	add	a5,a5,a4
    80005a46:	1ac7c783          	lbu	a5,428(a5)
    80005a4a:	8b85                	andi	a5,a5,1
    80005a4c:	cbd1                	beqz	a5,80005ae0 <e1000_intr+0xe6>
    acquire(&e1000_lock);
    80005a4e:	893a                	mv	s2,a4
    regs[E1000_RDT] = idx;
    80005a50:	00004a97          	auipc	s5,0x4
    80005a54:	5d0a8a93          	addi	s5,s5,1488 # 8000a020 <regs>
    80005a58:	6a0d                	lui	s4,0x3
    dest = &rx_ring[idx];
    80005a5a:	00019b17          	auipc	s6,0x19
    80005a5e:	746b0b13          	addi	s6,s6,1862 # 8001f1a0 <rx_ring>
    acquire(&e1000_lock);
    80005a62:	854a                	mv	a0,s2
    80005a64:	00001097          	auipc	ra,0x1
    80005a68:	70a080e7          	jalr	1802(ra) # 8000716e <acquire>
    struct mbuf *buf = rx_mbufs[idx];
    80005a6c:	00399b93          	slli	s7,s3,0x3
    80005a70:	9bca                	add	s7,s7,s2
    80005a72:	2a0bbc03          	ld	s8,672(s7)
    mbufput(buf, dest->length);
    80005a76:	0084d583          	lhu	a1,8(s1)
    80005a7a:	8562                	mv	a0,s8
    80005a7c:	00000097          	auipc	ra,0x0
    80005a80:	1d4080e7          	jalr	468(ra) # 80005c50 <mbufput>
    if (!(rx_mbufs[idx] = mbufalloc(0)))
    80005a84:	4501                	li	a0,0
    80005a86:	00000097          	auipc	ra,0x0
    80005a8a:	226080e7          	jalr	550(ra) # 80005cac <mbufalloc>
    80005a8e:	2aabb023          	sd	a0,672(s7)
    80005a92:	c13d                	beqz	a0,80005af8 <e1000_intr+0xfe>
    dest->addr = (uint64)rx_mbufs[idx]->head;
    80005a94:	651c                	ld	a5,8(a0)
    80005a96:	e09c                	sd	a5,0(s1)
    dest->status = 0;
    80005a98:	00048623          	sb	zero,12(s1)
    regs[E1000_RDT] = idx;
    80005a9c:	000ab783          	ld	a5,0(s5)
    80005aa0:	97d2                	add	a5,a5,s4
    80005aa2:	8137ac23          	sw	s3,-2024(a5)
    __sync_synchronize();
    80005aa6:	0ff0000f          	fence
    release(&e1000_lock);
    80005aaa:	854a                	mv	a0,s2
    80005aac:	00001097          	auipc	ra,0x1
    80005ab0:	776080e7          	jalr	1910(ra) # 80007222 <release>
    net_rx(buf);
    80005ab4:	8562                	mv	a0,s8
    80005ab6:	00000097          	auipc	ra,0x0
    80005aba:	3c2080e7          	jalr	962(ra) # 80005e78 <net_rx>
    idx = (regs[E1000_RDT] + 1) % RX_RING_SIZE;
    80005abe:	000ab783          	ld	a5,0(s5)
    80005ac2:	97d2                	add	a5,a5,s4
    80005ac4:	8187a783          	lw	a5,-2024(a5)
    80005ac8:	2785                	addiw	a5,a5,1
    80005aca:	00f7f993          	andi	s3,a5,15
    dest = &rx_ring[idx];
    80005ace:	00499793          	slli	a5,s3,0x4
    80005ad2:	00fb04b3          	add	s1,s6,a5
  while (rx_ring[idx].status & E1000_RXD_STAT_DD)
    80005ad6:	97ca                	add	a5,a5,s2
    80005ad8:	1ac7c783          	lbu	a5,428(a5)
    80005adc:	8b85                	andi	a5,a5,1
    80005ade:	f3d1                	bnez	a5,80005a62 <e1000_intr+0x68>

  e1000_recv();
}
    80005ae0:	60a6                	ld	ra,72(sp)
    80005ae2:	6406                	ld	s0,64(sp)
    80005ae4:	74e2                	ld	s1,56(sp)
    80005ae6:	7942                	ld	s2,48(sp)
    80005ae8:	79a2                	ld	s3,40(sp)
    80005aea:	7a02                	ld	s4,32(sp)
    80005aec:	6ae2                	ld	s5,24(sp)
    80005aee:	6b42                	ld	s6,16(sp)
    80005af0:	6ba2                	ld	s7,8(sp)
    80005af2:	6c02                	ld	s8,0(sp)
    80005af4:	6161                	addi	sp,sp,80
    80005af6:	8082                	ret
      panic("mbuf alloc failed");
    80005af8:	00004517          	auipc	a0,0x4
    80005afc:	d1050513          	addi	a0,a0,-752 # 80009808 <syscalls+0x430>
    80005b00:	00001097          	auipc	ra,0x1
    80005b04:	124080e7          	jalr	292(ra) # 80006c24 <panic>

0000000080005b08 <in_cksum>:
...
in_cksum(const unsigned char *addr, int len)
{
    ...
    80005b0a:	ec22                	sd	s0,24(sp)
    80005b0c:	1000                	addi	s0,sp,32
  int nleft = len;
  const unsigned short *w = (const unsigned short *)addr;
  unsigned int sum = 0;
  unsigned short answer = 0;
    80005b0e:	fe041723          	sh	zero,-18(s0)
  /*
  ...
  while (nleft > 1)  {
    ...
    80005b14:	04b7d963          	bge	a5,a1,80005b66 <in_cksum+0x5e>
    80005b18:	ffe5879b          	addiw	a5,a1,-2
    80005b1c:	0017d61b          	srliw	a2,a5,0x1
    80005b20:	0017d71b          	srliw	a4,a5,0x1
    80005b24:	0705                	addi	a4,a4,1
    80005b26:	0706                	slli	a4,a4,0x1
    80005b28:	972a                	add	a4,a4,a0
  unsigned int sum = 0;
    80005b2a:	4781                	li	a5,0
    sum += *w++;
    80005b2c:	0509                	addi	a0,a0,2
    80005b2e:	ffe55683          	lhu	a3,-2(a0)
    80005b32:	9fb5                	addw	a5,a5,a3
  while (nleft > 1)  {
    80005b34:	fee51ce3          	bne	a0,a4,80005b2c <in_cksum+0x24>
    80005b38:	35f9                	addiw	a1,a1,-2
    80005b3a:	0016169b          	slliw	a3,a2,0x1
    80005b3e:	9d95                	subw	a1,a1,a3
    nleft -= 2;
  }

  /* mop up an odd byte, if necessary */
  if (nleft == 1) {
    80005b40:	4685                	li	a3,1
    80005b42:	02d58563          	beq	a1,a3,80005b6c <in_cksum+0x64>
  ...
  sum = (sum & 0xffff) + (sum >> 16);
    80005b46:	03079513          	slli	a0,a5,0x30
    80005b4a:	9141                	srli	a0,a0,0x30
    80005b4c:	0107d79b          	srliw	a5,a5,0x10
    80005b50:	9fa9                	addw	a5,a5,a0
  sum += (sum >> 16);
    80005b52:	0107d51b          	srliw	a0,a5,0x10
  /* guaranteed now that the lower 16 bits of sum are correct */

  answer = ~sum; /* truncate to 16 bits */
    80005b56:	9d3d                	addw	a0,a0,a5
    80005b58:	fff54513          	not	a0,a0
  return answer;
}
    80005b5c:	1542                	slli	a0,a0,0x30
    80005b5e:	9141                	srli	a0,a0,0x30
    80005b60:	6462                	ld	s0,24(sp)
    80005b62:	6105                	addi	sp,sp,32
    80005b64:	8082                	ret
  const unsigned short *w = (const unsigned short *)addr;
    80005b66:	872a                	mv	a4,a0
  unsigned int sum = 0;
    80005b68:	4781                	li	a5,0
    80005b6a:	bfd9                	j	80005b40 <in_cksum+0x38>
    *(unsigned char *)(&answer) = *(const unsigned char *)w;
    80005b6c:	00074703          	lbu	a4,0(a4)
    80005b70:	fee40723          	sb	a4,-18(s0)
    sum += answer;
    80005b74:	fee45703          	lhu	a4,-18(s0)
    80005b78:	9fb9                	addw	a5,a5,a4
    80005b7a:	b7f1                	j	80005b46 <in_cksum+0x3e>

0000000080005b7c <mbufpull>:
{
    80005b7c:	1141                	addi	sp,sp,-16
    80005b7e:	e422                	sd	s0,8(sp)
    80005b80:	0800                	addi	s0,sp,16
    80005b82:	87aa                	mv	a5,a0
  char *tmp = m->head;
    80005b84:	6508                	ld	a0,8(a0)
  if (m->len < len)
    80005b86:	4b98                	lw	a4,16(a5)
    80005b88:	00b76b63          	bltu	a4,a1,80005b9e <mbufpull+0x22>
  m->len -= len;
    80005b8c:	9f0d                	subw	a4,a4,a1
    80005b8e:	cb98                	sw	a4,16(a5)
  m->head += len;
    80005b90:	1582                	slli	a1,a1,0x20
    80005b92:	9181                	srli	a1,a1,0x20
    80005b94:	95aa                	add	a1,a1,a0
    80005b96:	e78c                	sd	a1,8(a5)
}
    ...
    80005ba0:	bfe5                	j	80005b98 <mbufpull+0x1c>

0000000080005ba2 <mbufpush>:
{
    80005ba2:	87aa                	mv	a5,a0
  m->head -= len;
    80005ba4:	02059713          	slli	a4,a1,0x20
    80005ba8:	9301                	srli	a4,a4,0x20
    80005baa:	6508                	ld	a0,8(a0)
    80005bac:	8d19                	sub	a0,a0,a4
    80005bae:	e788                	sd	a0,8(a5)
  if (m->head < m->buf)
    80005bb0:	01478713          	addi	a4,a5,20
    80005bb4:	00e56663          	bltu	a0,a4,80005bc0 <mbufpush+0x1e>
  m->len += len;
    80005bb8:	4b98                	lw	a4,16(a5)
    80005bba:	9db9                	addw	a1,a1,a4
    80005bbc:	cb8c                	sw	a1,16(a5)
}
    80005bbe:	8082                	ret
{
    ...
    80005bcc:	c5850513          	addi	a0,a0,-936 # 80009820 <syscalls+0x448>
    80005bd0:	00001097          	auipc	ra,0x1
    80005bd4:	054080e7          	jalr	84(ra) # 80006c24 <panic>

0000000080005bd8 <net_tx_eth>:
...
net_tx_eth(struct mbuf *m, uint16 ethtype)
{
    ...
    80005bde:	ec26                	sd	s1,24(sp)
    80005be0:	e84a                	sd	s2,16(sp)
    80005be2:	e44e                	sd	s3,8(sp)
    80005be4:	1800                	addi	s0,sp,48
    80005be6:	89aa                	mv	s3,a0
    80005be8:	892e                	mv	s2,a1
  struct eth *ethhdr;

  ethhdr = mbufpushhdr(m, *ethhdr);
    80005bea:	45b9                	li	a1,14
    80005bec:	00000097          	auipc	ra,0x0
    80005bf0:	fb6080e7          	jalr	-74(ra) # 80005ba2 <mbufpush>
    80005bf4:	84aa                	mv	s1,a0
  memmove(ethhdr->shost, local_mac, ETHADDR_LEN);
    80005bf6:	4619                	li	a2,6
    80005bf8:	00004597          	auipc	a1,0x4
    80005bfc:	ce858593          	addi	a1,a1,-792 # 800098e0 <local_mac>
    80005c00:	0519                	addi	a0,a0,6
    80005c02:	ffffa097          	auipc	ra,0xffffa
    80005c06:	5d6080e7          	jalr	1494(ra) # 800001d8 <memmove>
  // In a real networking stack, dhost would be set to the address discovered
  // through ARP. Because we don't support enough of the ARP protocol, set it
  // to broadcast instead.
  memmove(ethhdr->dhost, broadcast_mac, ETHADDR_LEN);
    80005c0a:	4619                	li	a2,6
    80005c0c:	00004597          	auipc	a1,0x4
    80005c10:	ccc58593          	addi	a1,a1,-820 # 800098d8 <broadcast_mac>
    80005c14:	8526                	mv	a0,s1
    80005c16:	ffffa097          	auipc	ra,0xffffa
    80005c1a:	5c2080e7          	jalr	1474(ra) # 800001d8 <memmove>
// endianness support
//
...
static inline uint16 bswaps(uint16 val)
{
  return (((val & 0x00ffU) << 8) |
    80005c1e:	0089579b          	srliw	a5,s2,0x8
  ethhdr->type = htons(ethtype);
    80005c22:	00f48623          	sb	a5,12(s1)
    80005c26:	012486a3          	sb	s2,13(s1)
  if (e1000_transmit(m)) {
    80005c2a:	854e                	mv	a0,s3
    80005c2c:	00000097          	auipc	ra,0x0
    80005c30:	cd8080e7          	jalr	-808(ra) # 80005904 <e1000_transmit>
    80005c34:	e901                	bnez	a0,80005c44 <net_tx_eth+0x6c>
    mbuffree(m);
  }
}
    80005c36:	70a2                	ld	ra,40(sp)
    80005c38:	7402                	ld	s0,32(sp)
    80005c3a:	64e2                	ld	s1,24(sp)
    80005c3c:	6942                	ld	s2,16(sp)
    80005c3e:	69a2                	ld	s3,8(sp)
    80005c40:	6145                	addi	sp,sp,48
    80005c42:	8082                	ret
  kfree(m);
    80005c44:	854e                	mv	a0,s3
    80005c46:	ffffa097          	auipc	ra,0xffffa
    80005c4a:	3d6080e7          	jalr	982(ra) # 8000001c <kfree>
}
    80005c4e:	b7e5                	j	80005c36 <net_tx_eth+0x5e>

0000000080005c50 <mbufput>:
{
    80005c50:	87aa                	mv	a5,a0
  char *tmp = m->head + m->len;
    80005c52:	4918                	lw	a4,16(a0)
    80005c54:	02071693          	slli	a3,a4,0x20
    80005c58:	9281                	srli	a3,a3,0x20
    80005c5a:	6508                	ld	a0,8(a0)
    80005c5c:	9536                	add	a0,a0,a3
  m->len += len;
    80005c5e:	9f2d                	addw	a4,a4,a1
    80005c60:	0007069b          	sext.w	a3,a4
    80005c64:	cb98                	sw	a4,16(a5)
  if (m->len > MBUF_SIZE)
    80005c66:	6785                	lui	a5,0x1
    80005c68:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    80005c6c:	00d7e363          	bltu	a5,a3,80005c72 <mbufput+0x22>
}
    80005c70:	8082                	ret
{
    ...
    panic("mbufput");
    80005c7a:	00004517          	auipc	a0,0x4
    80005c7e:	bb650513          	addi	a0,a0,-1098 # 80009830 <syscalls+0x458>
    80005c82:	00001097          	auipc	ra,0x1
    80005c86:	fa2080e7          	jalr	-94(ra) # 80006c24 <panic>

0000000080005c8a <mbuftrim>:
{
    80005c8a:	1141                	addi	sp,sp,-16
    80005c8c:	e422                	sd	s0,8(sp)
    80005c8e:	0800                	addi	s0,sp,16
  if (len > m->len)
    80005c90:	491c                	lw	a5,16(a0)
    80005c92:	00b7eb63          	bltu	a5,a1,80005ca8 <mbuftrim+0x1e>
  m->len -= len;
    80005c96:	9f8d                	subw	a5,a5,a1
    80005c98:	c91c                	sw	a5,16(a0)
  return m->head + m->len;
    80005c9a:	1782                	slli	a5,a5,0x20
    80005c9c:	9381                	srli	a5,a5,0x20
    80005c9e:	6508                	ld	a0,8(a0)
    ...
    80005caa:	bfe5                	j	80005ca2 <mbuftrim+0x18>

0000000080005cac <mbufalloc>:
{
  ...
  if (headroom > MBUF_SIZE)
    ...
    80005cba:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    return 0;
    80005cbe:	4901                	li	s2,0
  if (headroom > MBUF_SIZE)
    80005cc0:	02a7eb63          	bltu	a5,a0,80005cf6 <mbufalloc+0x4a>
    80005cc4:	84aa                	mv	s1,a0
  m = kalloc();
    80005cc6:	ffffa097          	auipc	ra,0xffffa
    80005cca:	452080e7          	jalr	1106(ra) # 80000118 <kalloc>
    80005cce:	892a                	mv	s2,a0
  if (m == 0)
    80005cd0:	c11d                	beqz	a0,80005cf6 <mbufalloc+0x4a>
  m->next = 0;
    80005cd2:	00053023          	sd	zero,0(a0)
  m->head = (char *)m->buf + headroom;
    80005cd6:	0551                	addi	a0,a0,20
    80005cd8:	1482                	slli	s1,s1,0x20
    80005cda:	9081                	srli	s1,s1,0x20
    80005cdc:	94aa                	add	s1,s1,a0
    80005cde:	00993423          	sd	s1,8(s2)
  m->len = 0;
    80005ce2:	00092823          	sw	zero,16(s2)
  memset(m->buf, 0, sizeof(m->buf));
    80005ce6:	6605                	lui	a2,0x1
    80005ce8:	80060613          	addi	a2,a2,-2048 # 800 <_entry-0x7ffff800>
    80005cec:	4581                	li	a1,0
    80005cee:	ffffa097          	auipc	ra,0xffffa
    80005cf2:	48a080e7          	jalr	1162(ra) # 80000178 <memset>
}
    80005cf6:	854a                	mv	a0,s2
    80005cf8:	60e2                	ld	ra,24(sp)
    80005cfa:	6442                	ld	s0,16(sp)
    80005cfc:	64a2                	ld	s1,8(sp)
    80005cfe:	6902                	ld	s2,0(sp)
    80005d00:	6105                	addi	sp,sp,32
    80005d02:	8082                	ret

0000000080005d04 <mbuffree>:
{
    80005d04:	1141                	addi	sp,sp,-16
    80005d06:	e406                	sd	ra,8(sp)
    80005d08:	e022                	sd	s0,0(sp)
    80005d0a:	0800                	addi	s0,sp,16
  kfree(m);
    80005d0c:	ffffa097          	auipc	ra,0xffffa
    80005d10:	310080e7          	jalr	784(ra) # 8000001c <kfree>
}
...
0000000080005d1c <mbufq_pushtail>:
{
    80005d1c:	1141                	addi	sp,sp,-16
    80005d1e:	e422                	sd	s0,8(sp)
    80005d20:	0800                	addi	s0,sp,16
  m->next = 0;
    80005d22:	0005b023          	sd	zero,0(a1)
  if (!q->head){
    80005d26:	611c                	ld	a5,0(a0)
    80005d28:	c799                	beqz	a5,80005d36 <mbufq_pushtail+0x1a>
  q->tail->next = m;
    80005d2a:	651c                	ld	a5,8(a0)
    80005d2c:	e38c                	sd	a1,0(a5)
  q->tail = m;
    80005d2e:	e50c                	sd	a1,8(a0)
}
    80005d30:	6422                	ld	s0,8(sp)
    80005d32:	0141                	addi	sp,sp,16
    80005d34:	8082                	ret
    q->head = q->tail = m;
    80005d36:	e50c                	sd	a1,8(a0)
    80005d38:	e10c                	sd	a1,0(a0)
    return;
    80005d3a:	bfdd                	j	80005d30 <mbufq_pushtail+0x14>

0000000080005d3c <mbufq_pophead>:
{
    80005d3c:	1141                	addi	sp,sp,-16
    80005d3e:	e422                	sd	s0,8(sp)
    80005d40:	0800                	addi	s0,sp,16
    80005d42:	87aa                	mv	a5,a0
  struct mbuf *head = q->head;
    80005d44:	6108                	ld	a0,0(a0)
  if (!head)
    80005d46:	c119                	beqz	a0,80005d4c <mbufq_pophead+0x10>
  q->head = head->next;
    80005d48:	6118                	ld	a4,0(a0)
    80005d4a:	e398                	sd	a4,0(a5)
}
    80005d4c:	6422                	ld	s0,8(sp)
    80005d4e:	0141                	addi	sp,sp,16
    80005d50:	8082                	ret

0000000080005d52 <mbufq_empty>:
{
    80005d52:	1141                	addi	sp,sp,-16
    80005d54:	e422                	sd	s0,8(sp)
    80005d56:	0800                	addi	s0,sp,16
  return q->head == 0;
    80005d58:	6108                	ld	a0,0(a0)
}
    80005d5a:	00153513          	seqz	a0,a0
    80005d5e:	6422                	ld	s0,8(sp)
    80005d60:	0141                	addi	sp,sp,16
    80005d62:	8082                	ret

0000000080005d64 <mbufq_init>:
{
    80005d64:	1141                	addi	sp,sp,-16
    80005d66:	e422                	sd	s0,8(sp)
    80005d68:	0800                	addi	s0,sp,16
  q->head = 0;
    80005d6a:	00053023          	sd	zero,0(a0)
}
    80005d6e:	6422                	ld	s0,8(sp)
    80005d70:	0141                	addi	sp,sp,16
    80005d72:	8082                	ret

0000000080005d74 <net_tx_udp>:
           ...
           uint16 sport, uint16 dport)
{
    ...
    80005d7e:	e44e                	sd	s3,8(sp)
    80005d80:	e052                	sd	s4,0(sp)
    80005d82:	1800                	addi	s0,sp,48
    80005d84:	8a2a                	mv	s4,a0
    80005d86:	892e                	mv	s2,a1
    80005d88:	89b2                	mv	s3,a2
    80005d8a:	84b6                	mv	s1,a3
  struct udp *udphdr;

  // put the UDP header
  udphdr = mbufpushhdr(m, *udphdr);
    80005d8c:	45a1                	li	a1,8
    80005d8e:	00000097          	auipc	ra,0x0
    80005d92:	e14080e7          	jalr	-492(ra) # 80005ba2 <mbufpush>
    80005d96:	0089d61b          	srliw	a2,s3,0x8
    80005d9a:	0089999b          	slliw	s3,s3,0x8
    80005d9e:	00c9e9b3          	or	s3,s3,a2
  udphdr->sport = htons(sport);
    80005da2:	01351023          	sh	s3,0(a0)
    80005da6:	0084d69b          	srliw	a3,s1,0x8
    80005daa:	0084949b          	slliw	s1,s1,0x8
    80005dae:	8cd5                	or	s1,s1,a3
  udphdr->dport = htons(dport);
    80005db0:	00951123          	sh	s1,2(a0)
  udphdr->ulen = htons(m->len);
    80005db4:	010a2783          	lw	a5,16(s4) # 3010 <_entry-0x7fffcff0>
    80005db8:	0087d713          	srli	a4,a5,0x8
    80005dbc:	0087979b          	slliw	a5,a5,0x8
    80005dc0:	0ff77713          	andi	a4,a4,255
    80005dc4:	8fd9                	or	a5,a5,a4
    80005dc6:	00f51223          	sh	a5,4(a0)
  udphdr->sum = 0; // zero means no checksum is provided
    80005dca:	00051323          	sh	zero,6(a0)
  iphdr = mbufpushhdr(m, *iphdr);
    80005dce:	45d1                	li	a1,20
    80005dd0:	8552                	mv	a0,s4
    80005dd2:	00000097          	auipc	ra,0x0
    80005dd6:	dd0080e7          	jalr	-560(ra) # 80005ba2 <mbufpush>
    80005dda:	84aa                	mv	s1,a0
  memset(iphdr, 0, sizeof(*iphdr));
    80005ddc:	4651                	li	a2,20
    80005dde:	4581                	li	a1,0
    80005de0:	ffffa097          	auipc	ra,0xffffa
    80005de4:	398080e7          	jalr	920(ra) # 80000178 <memset>
  iphdr->ip_vhl = (4 << 4) | (20 >> 2);
    80005de8:	04500793          	li	a5,69
    80005dec:	00f48023          	sb	a5,0(s1)
  iphdr->ip_p = proto;
    80005df0:	47c5                	li	a5,17
    80005df2:	00f484a3          	sb	a5,9(s1)
  iphdr->ip_src = htonl(local_ip);
    80005df6:	0f0207b7          	lui	a5,0xf020
    80005dfa:	27a9                	addiw	a5,a5,10
    80005dfc:	c4dc                	sw	a5,12(s1)
          ((val & 0xff00U) >> 8));
}
...
static inline uint32 bswapl(uint32 val)
{
  return (((val & 0x000000ffUL) << 24) |
    80005dfe:	0189179b          	slliw	a5,s2,0x18
          ((val & 0x0000ff00UL) << 8) |
          ((val & 0x00ff0000UL) >> 8) |
          ((val & 0xff000000UL) >> 24));
    80005e02:	0189571b          	srliw	a4,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005e06:	8fd9                	or	a5,a5,a4
          ((val & 0x0000ff00UL) << 8) |
    80005e08:	0089171b          	slliw	a4,s2,0x8
    80005e0c:	00ff06b7          	lui	a3,0xff0
    80005e10:	8f75                	and	a4,a4,a3
          ((val & 0x00ff0000UL) >> 8) |
    80005e12:	8fd9                	or	a5,a5,a4
    80005e14:	0089591b          	srliw	s2,s2,0x8
    80005e18:	65c1                	lui	a1,0x10
    80005e1a:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80005e1e:	00b97933          	and	s2,s2,a1
    80005e22:	0127e933          	or	s2,a5,s2
  iphdr->ip_dst = htonl(dip);
    80005e26:	0124a823          	sw	s2,16(s1)
  iphdr->ip_len = htons(m->len);
    80005e2a:	010a2783          	lw	a5,16(s4)
  return (((val & 0x00ffU) << 8) |
    80005e2e:	0087d713          	srli	a4,a5,0x8
    80005e32:	0087979b          	slliw	a5,a5,0x8
    80005e36:	0ff77713          	andi	a4,a4,255
    80005e3a:	8fd9                	or	a5,a5,a4
    80005e3c:	00f49123          	sh	a5,2(s1)
  iphdr->ip_ttl = 100;
    80005e40:	06400793          	li	a5,100
    80005e44:	00f48423          	sb	a5,8(s1)
  iphdr->ip_sum = in_cksum((unsigned char *)iphdr, sizeof(*iphdr));
    80005e48:	45d1                	li	a1,20
    80005e4a:	8526                	mv	a0,s1
    80005e4c:	00000097          	auipc	ra,0x0
    80005e50:	cbc080e7          	jalr	-836(ra) # 80005b08 <in_cksum>
    80005e54:	00a49523          	sh	a0,10(s1)
  net_tx_eth(m, ETHTYPE_IP);
    80005e58:	6585                	lui	a1,0x1
    80005e5a:	80058593          	addi	a1,a1,-2048 # 800 <_entry-0x7ffff800>
    80005e5e:	8552                	mv	a0,s4
    80005e60:	00000097          	auipc	ra,0x0
    80005e64:	d78080e7          	jalr	-648(ra) # 80005bd8 <net_tx_eth>
...
{
    80005e78:	715d                	addi	sp,sp,-80
    80005e7a:	e486                	sd	ra,72(sp)
    80005e7c:	e0a2                	sd	s0,64(sp)
    80005e7e:	fc26                	sd	s1,56(sp)
    80005e80:	f84a                	sd	s2,48(sp)
    80005e82:	f44e                	sd	s3,40(sp)
    80005e84:	f052                	sd	s4,32(sp)
    80005e86:	ec56                	sd	s5,24(sp)
    80005e88:	0880                	addi	s0,sp,80
    80005e8a:	84aa                	mv	s1,a0
  struct eth *ethhdr;
  uint16 type;

  ethhdr = mbufpullhdr(m, *ethhdr);
    80005e8c:	45b9                	li	a1,14
    80005e8e:	00000097          	auipc	ra,0x0
    80005e92:	cee080e7          	jalr	-786(ra) # 80005b7c <mbufpull>
  if (!ethhdr) {
    80005e96:	c521                	beqz	a0,80005ede <net_rx+0x66>
    mbuffree(m);
    return;
  }

  type = ntohs(ethhdr->type);
    80005e98:	00c54783          	lbu	a5,12(a0)
    80005e9c:	00d54703          	lbu	a4,13(a0)
    80005ea0:	0722                	slli	a4,a4,0x8
    80005ea2:	8fd9                	or	a5,a5,a4
    80005ea4:	0087979b          	slliw	a5,a5,0x8
    80005ea8:	8321                	srli	a4,a4,0x8
    80005eaa:	8fd9                	or	a5,a5,a4
    80005eac:	17c2                	slli	a5,a5,0x30
    80005eae:	93c1                	srli	a5,a5,0x30
  if (type == ETHTYPE_IP)
    80005eb0:	8007871b          	addiw	a4,a5,-2048
    80005eb4:	cb1d                	beqz	a4,80005eea <net_rx+0x72>
    net_rx_ip(m);
  else if (type == ETHTYPE_ARP)
    80005eb6:	2781                	sext.w	a5,a5
    80005eb8:	6705                	lui	a4,0x1
    80005eba:	80670713          	addi	a4,a4,-2042 # 806 <_entry-0x7ffff7fa>
    80005ebe:	18e78e63          	beq	a5,a4,8000605a <net_rx+0x1e2>
  kfree(m);
    80005ec2:	8526                	mv	a0,s1
    80005ec4:	ffffa097          	auipc	ra,0xffffa
    80005ec8:	158080e7          	jalr	344(ra) # 8000001c <kfree>
    net_rx_arp(m);
  else
    mbuffree(m);
}
  ...
  kfree(m);
    ...
    80005ee4:	13c080e7          	jalr	316(ra) # 8000001c <kfree>
}
    80005ee8:	b7d5                	j	80005ecc <net_rx+0x54>
  iphdr = mbufpullhdr(m, *iphdr);
    80005eea:	45d1                	li	a1,20
    80005eec:	8526                	mv	a0,s1
    80005eee:	00000097          	auipc	ra,0x0
    80005ef2:	c8e080e7          	jalr	-882(ra) # 80005b7c <mbufpull>
    80005ef6:	892a                	mv	s2,a0
  if (!iphdr)
    80005ef8:	c519                	beqz	a0,80005f06 <net_rx+0x8e>
  if (iphdr->ip_vhl != ((4 << 4) | (20 >> 2)))
    80005efa:	00054703          	lbu	a4,0(a0)
    80005efe:	04500793          	li	a5,69
    80005f02:	00f70863          	beq	a4,a5,80005f12 <net_rx+0x9a>
  kfree(m);
    80005f06:	8526                	mv	a0,s1
    80005f08:	ffffa097          	auipc	ra,0xffffa
    80005f0c:	114080e7          	jalr	276(ra) # 8000001c <kfree>
}
    80005f10:	bf75                	j	80005ecc <net_rx+0x54>
  if (in_cksum((unsigned char *)iphdr, sizeof(*iphdr)))
    80005f12:	45d1                	li	a1,20
    80005f14:	00000097          	auipc	ra,0x0
    80005f18:	bf4080e7          	jalr	-1036(ra) # 80005b08 <in_cksum>
    80005f1c:	f56d                	bnez	a0,80005f06 <net_rx+0x8e>
    80005f1e:	00695783          	lhu	a5,6(s2)
    80005f22:	0087d713          	srli	a4,a5,0x8
    80005f26:	0087979b          	slliw	a5,a5,0x8
    80005f2a:	0ff77713          	andi	a4,a4,255
    80005f2e:	8fd9                	or	a5,a5,a4
  if (htons(iphdr->ip_off) != 0)
    80005f30:	17c2                	slli	a5,a5,0x30
    80005f32:	93c1                	srli	a5,a5,0x30
    80005f34:	fbe9                	bnez	a5,80005f06 <net_rx+0x8e>
  if (htonl(iphdr->ip_dst) != local_ip)
    80005f36:	01092703          	lw	a4,16(s2)
  return (((val & 0x000000ffUL) << 24) |
    80005f3a:	0187179b          	slliw	a5,a4,0x18
          ((val & 0xff000000UL) >> 24));
    80005f3e:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005f42:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    80005f44:	0087169b          	slliw	a3,a4,0x8
    80005f48:	00ff0637          	lui	a2,0xff0
    80005f4c:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    80005f4e:	8fd5                	or	a5,a5,a3
    80005f50:	0087571b          	srliw	a4,a4,0x8
    80005f54:	66c1                	lui	a3,0x10
    80005f56:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80005f5a:	8f75                	and	a4,a4,a3
    80005f5c:	8fd9                	or	a5,a5,a4
    80005f5e:	2781                	sext.w	a5,a5
    80005f60:	0a000737          	lui	a4,0xa000
    80005f64:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80005f68:	f8e79fe3          	bne	a5,a4,80005f06 <net_rx+0x8e>
  if (iphdr->ip_p != IPPROTO_UDP)
    80005f6c:	00994703          	lbu	a4,9(s2)
    80005f70:	47c5                	li	a5,17
    80005f72:	f8f71ae3          	bne	a4,a5,80005f06 <net_rx+0x8e>
  return (((val & 0x00ffU) << 8) |
    80005f76:	00295783          	lhu	a5,2(s2)
    80005f7a:	0087d713          	srli	a4,a5,0x8
    80005f7e:	0087999b          	slliw	s3,a5,0x8
    80005f82:	0ff77793          	andi	a5,a4,255
    80005f86:	00f9e9b3          	or	s3,s3,a5
    80005f8a:	19c2                	slli	s3,s3,0x30
    80005f8c:	0309d993          	srli	s3,s3,0x30
  len = ntohs(iphdr->ip_len) - sizeof(*iphdr);
    80005f90:	fec9879b          	addiw	a5,s3,-20
    80005f94:	03079a13          	slli	s4,a5,0x30
    80005f98:	030a5a13          	srli	s4,s4,0x30
  udphdr = mbufpullhdr(m, *udphdr);
    80005f9c:	45a1                	li	a1,8
    80005f9e:	8526                	mv	a0,s1
    80005fa0:	00000097          	auipc	ra,0x0
    80005fa4:	bdc080e7          	jalr	-1060(ra) # 80005b7c <mbufpull>
    80005fa8:	8aaa                	mv	s5,a0
  if (!udphdr)
    80005faa:	c915                	beqz	a0,80005fde <net_rx+0x166>
    80005fac:	00455783          	lhu	a5,4(a0)
    80005fb0:	0087d713          	srli	a4,a5,0x8
    80005fb4:	0087979b          	slliw	a5,a5,0x8
    80005fb8:	0ff77713          	andi	a4,a4,255
    80005fbc:	8fd9                	or	a5,a5,a4
  if (ntohs(udphdr->ulen) != len)
    80005fbe:	2a01                	sext.w	s4,s4
    80005fc0:	17c2                	slli	a5,a5,0x30
    80005fc2:	93c1                	srli	a5,a5,0x30
    80005fc4:	00fa1d63          	bne	s4,a5,80005fde <net_rx+0x166>
  len -= sizeof(*udphdr);
    80005fc8:	fe49879b          	addiw	a5,s3,-28
  if (len > m->len)
    80005fcc:	0107979b          	slliw	a5,a5,0x10
    80005fd0:	0107d79b          	srliw	a5,a5,0x10
    80005fd4:	0007871b          	sext.w	a4,a5
    80005fd8:	488c                	lw	a1,16(s1)
    80005fda:	00e5f863          	bgeu	a1,a4,80005fea <net_rx+0x172>
  kfree(m);
    80005fde:	8526                	mv	a0,s1
    80005fe0:	ffffa097          	auipc	ra,0xffffa
    80005fe4:	03c080e7          	jalr	60(ra) # 8000001c <kfree>
}
    80005fe8:	b5d5                	j	80005ecc <net_rx+0x54>
  mbuftrim(m, m->len - len);
    80005fea:	9d9d                	subw	a1,a1,a5
    80005fec:	8526                	mv	a0,s1
    80005fee:	00000097          	auipc	ra,0x0
    80005ff2:	c9c080e7          	jalr	-868(ra) # 80005c8a <mbuftrim>
  sip = ntohl(iphdr->ip_src);
    80005ff6:	00c92783          	lw	a5,12(s2)
    80005ffa:	000ad703          	lhu	a4,0(s5)
    80005ffe:	00875693          	srli	a3,a4,0x8
    80006002:	0087171b          	slliw	a4,a4,0x8
    80006006:	0ff6f693          	andi	a3,a3,255
    8000600a:	8ed9                	or	a3,a3,a4
    8000600c:	002ad703          	lhu	a4,2(s5)
    80006010:	00875613          	srli	a2,a4,0x8
    80006014:	0087171b          	slliw	a4,a4,0x8
    80006018:	0ff67613          	andi	a2,a2,255
    8000601c:	8e59                	or	a2,a2,a4
  return (((val & 0x000000ffUL) << 24) |
    8000601e:	0187971b          	slliw	a4,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006022:	0187d59b          	srliw	a1,a5,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80006026:	8f4d                	or	a4,a4,a1
          ((val & 0x0000ff00UL) << 8) |
    80006028:	0087959b          	slliw	a1,a5,0x8
    8000602c:	00ff0537          	lui	a0,0xff0
    80006030:	8de9                	and	a1,a1,a0
          ((val & 0x00ff0000UL) >> 8) |
    80006032:	8f4d                	or	a4,a4,a1
    80006034:	0087d79b          	srliw	a5,a5,0x8
    80006038:	65c1                	lui	a1,0x10
    8000603a:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    8000603e:	8fed                	and	a5,a5,a1
    80006040:	8fd9                	or	a5,a5,a4
  sockrecvudp(m, sip, dport, sport);
    80006042:	16c2                	slli	a3,a3,0x30
    80006044:	92c1                	srli	a3,a3,0x30
    80006046:	1642                	slli	a2,a2,0x30
    80006048:	9241                	srli	a2,a2,0x30
    8000604a:	0007859b          	sext.w	a1,a5
    8000604e:	8526                	mv	a0,s1
    80006050:	00000097          	auipc	ra,0x0
    80006054:	55c080e7          	jalr	1372(ra) # 800065ac <sockrecvudp>
  return;
    80006058:	bd95                	j	80005ecc <net_rx+0x54>
  arphdr = mbufpullhdr(m, *arphdr);
    8000605a:	45f1                	li	a1,28
    8000605c:	8526                	mv	a0,s1
    8000605e:	00000097          	auipc	ra,0x0
    80006062:	b1e080e7          	jalr	-1250(ra) # 80005b7c <mbufpull>
    80006066:	892a                	mv	s2,a0
  if (!arphdr)
    80006068:	c179                	beqz	a0,8000612e <net_rx+0x2b6>
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    8000606a:	00054783          	lbu	a5,0(a0) # ff0000 <_entry-0x7f010000>
    8000606e:	00154703          	lbu	a4,1(a0)
    80006072:	0722                	slli	a4,a4,0x8
    80006074:	8fd9                	or	a5,a5,a4
  return (((val & 0x00ffU) << 8) |
    80006076:	0087979b          	slliw	a5,a5,0x8
    8000607a:	8321                	srli	a4,a4,0x8
    8000607c:	8fd9                	or	a5,a5,a4
    8000607e:	17c2                	slli	a5,a5,0x30
    80006080:	93c1                	srli	a5,a5,0x30
    80006082:	4705                	li	a4,1
    80006084:	0ae79563          	bne	a5,a4,8000612e <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006088:	00254783          	lbu	a5,2(a0)
    8000608c:	00354703          	lbu	a4,3(a0)
    80006090:	0722                	slli	a4,a4,0x8
    80006092:	8fd9                	or	a5,a5,a4
    80006094:	0087979b          	slliw	a5,a5,0x8
    80006098:	8321                	srli	a4,a4,0x8
    8000609a:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    8000609c:	0107979b          	slliw	a5,a5,0x10
    800060a0:	0107d79b          	srliw	a5,a5,0x10
    800060a4:	8007879b          	addiw	a5,a5,-2048
    800060a8:	e3d9                	bnez	a5,8000612e <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    800060aa:	00454703          	lbu	a4,4(a0)
    800060ae:	4799                	li	a5,6
    800060b0:	06f71f63          	bne	a4,a5,8000612e <net_rx+0x2b6>
      arphdr->hln != ETHADDR_LEN ||
    800060b4:	00554703          	lbu	a4,5(a0)
    800060b8:	4791                	li	a5,4
    800060ba:	06f71a63          	bne	a4,a5,8000612e <net_rx+0x2b6>
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    800060be:	00654783          	lbu	a5,6(a0)
    800060c2:	00754703          	lbu	a4,7(a0)
    800060c6:	0722                	slli	a4,a4,0x8
    800060c8:	8fd9                	or	a5,a5,a4
    800060ca:	0087979b          	slliw	a5,a5,0x8
    800060ce:	8321                	srli	a4,a4,0x8
    800060d0:	8fd9                	or	a5,a5,a4
    800060d2:	17c2                	slli	a5,a5,0x30
    800060d4:	93c1                	srli	a5,a5,0x30
    800060d6:	4705                	li	a4,1
    800060d8:	04e79b63          	bne	a5,a4,8000612e <net_rx+0x2b6>
  tip = ntohl(arphdr->tip); // target IP address
    800060dc:	01854783          	lbu	a5,24(a0)
    800060e0:	01954703          	lbu	a4,25(a0)
    800060e4:	0722                	slli	a4,a4,0x8
    800060e6:	8f5d                	or	a4,a4,a5
    800060e8:	01a54783          	lbu	a5,26(a0)
    800060ec:	07c2                	slli	a5,a5,0x10
    800060ee:	8f5d                	or	a4,a4,a5
    800060f0:	01b54783          	lbu	a5,27(a0)
    800060f4:	07e2                	slli	a5,a5,0x18
    800060f6:	8fd9                	or	a5,a5,a4
    800060f8:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    800060fc:	0187979b          	slliw	a5,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006100:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80006104:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    80006106:	0087169b          	slliw	a3,a4,0x8
    8000610a:	00ff0637          	lui	a2,0xff0
    8000610e:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    80006110:	8fd5                	or	a5,a5,a3
    80006112:	0087571b          	srliw	a4,a4,0x8
    80006116:	66c1                	lui	a3,0x10
    80006118:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    8000611c:	8f75                	and	a4,a4,a3
    8000611e:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    80006120:	2781                	sext.w	a5,a5
    80006122:	0a000737          	lui	a4,0xa000
    80006126:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    8000612a:	00e78863          	beq	a5,a4,8000613a <net_rx+0x2c2>
  kfree(m);
    8000612e:	8526                	mv	a0,s1
    80006130:	ffffa097          	auipc	ra,0xffffa
    80006134:	eec080e7          	jalr	-276(ra) # 8000001c <kfree>
}
    80006138:	bb51                	j	80005ecc <net_rx+0x54>
  memmove(smac, arphdr->sha, ETHADDR_LEN); // sender's ethernet address
    8000613a:	4619                	li	a2,6
    8000613c:	00850593          	addi	a1,a0,8
    80006140:	fb840513          	addi	a0,s0,-72
    80006144:	ffffa097          	auipc	ra,0xffffa
    80006148:	094080e7          	jalr	148(ra) # 800001d8 <memmove>
  sip = ntohl(arphdr->sip); // sender's IP address (qemu's slirp)
    8000614c:	00e94783          	lbu	a5,14(s2)
    80006150:	00f94703          	lbu	a4,15(s2)
    80006154:	0722                	slli	a4,a4,0x8
    80006156:	8f5d                	or	a4,a4,a5
    80006158:	01094783          	lbu	a5,16(s2)
    8000615c:	07c2                	slli	a5,a5,0x10
    8000615e:	8f5d                	or	a4,a4,a5
    80006160:	01194783          	lbu	a5,17(s2)
    80006164:	07e2                	slli	a5,a5,0x18
    80006166:	8fd9                	or	a5,a5,a4
    80006168:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    8000616c:	0187991b          	slliw	s2,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006170:	0187579b          	srliw	a5,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80006174:	00f96933          	or	s2,s2,a5
          ((val & 0x0000ff00UL) << 8) |
    80006178:	0087179b          	slliw	a5,a4,0x8
    8000617c:	00ff06b7          	lui	a3,0xff0
    80006180:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    80006182:	00f96933          	or	s2,s2,a5
    80006186:	0087579b          	srliw	a5,a4,0x8
    8000618a:	6741                	lui	a4,0x10
    8000618c:	f0070713          	addi	a4,a4,-256 # ff00 <_entry-0x7fff0100>
    80006190:	8ff9                	and	a5,a5,a4
    80006192:	00f96933          	or	s2,s2,a5
    80006196:	2901                	sext.w	s2,s2
  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    80006198:	08000513          	li	a0,128
    8000619c:	00000097          	auipc	ra,0x0
    800061a0:	b10080e7          	jalr	-1264(ra) # 80005cac <mbufalloc>
    800061a4:	8a2a                	mv	s4,a0
  if (!m)
    800061a6:	d541                	beqz	a0,8000612e <net_rx+0x2b6>
  arphdr = mbufputhdr(m, *arphdr);
    800061a8:	45f1                	li	a1,28
    800061aa:	00000097          	auipc	ra,0x0
    800061ae:	aa6080e7          	jalr	-1370(ra) # 80005c50 <mbufput>
    800061b2:	89aa                	mv	s3,a0
  arphdr->hrd = htons(ARP_HRD_ETHER);
    800061b4:	00050023          	sb	zero,0(a0)
    800061b8:	4785                	li	a5,1
    800061ba:	00f500a3          	sb	a5,1(a0)
  arphdr->pro = htons(ETHTYPE_IP);
    800061be:	47a1                	li	a5,8
    800061c0:	00f50123          	sb	a5,2(a0)
    800061c4:	000501a3          	sb	zero,3(a0)
  arphdr->hln = ETHADDR_LEN;
    800061c8:	4799                	li	a5,6
    800061ca:	00f50223          	sb	a5,4(a0)
  arphdr->pln = sizeof(uint32);
    800061ce:	4791                	li	a5,4
    800061d0:	00f502a3          	sb	a5,5(a0)
  arphdr->op = htons(op);
    800061d4:	00050323          	sb	zero,6(a0)
    800061d8:	4a89                	li	s5,2
    800061da:	015503a3          	sb	s5,7(a0)
  memmove(arphdr->sha, local_mac, ETHADDR_LEN);
    800061de:	4619                	li	a2,6
    800061e0:	00003597          	auipc	a1,0x3
    800061e4:	70058593          	addi	a1,a1,1792 # 800098e0 <local_mac>
    800061e8:	0521                	addi	a0,a0,8
    800061ea:	ffffa097          	auipc	ra,0xffffa
    800061ee:	fee080e7          	jalr	-18(ra) # 800001d8 <memmove>
  arphdr->sip = htonl(local_ip);
    800061f2:	47a9                	li	a5,10
    800061f4:	00f98723          	sb	a5,14(s3)
    800061f8:	000987a3          	sb	zero,15(s3)
    800061fc:	01598823          	sb	s5,16(s3)
    80006200:	47bd                	li	a5,15
    80006202:	00f988a3          	sb	a5,17(s3)
  memmove(arphdr->tha, dmac, ETHADDR_LEN);
    80006206:	4619                	li	a2,6
    80006208:	fb840593          	addi	a1,s0,-72
    8000620c:	01298513          	addi	a0,s3,18
    80006210:	ffffa097          	auipc	ra,0xffffa
    80006214:	fc8080e7          	jalr	-56(ra) # 800001d8 <memmove>
  return (((val & 0x000000ffUL) << 24) |
    80006218:	0189171b          	slliw	a4,s2,0x18
          ((val & 0xff000000UL) >> 24));
    8000621c:	0189579b          	srliw	a5,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80006220:	8f5d                	or	a4,a4,a5
          ((val & 0x0000ff00UL) << 8) |
    80006222:	0089179b          	slliw	a5,s2,0x8
    80006226:	00ff06b7          	lui	a3,0xff0
    8000622a:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    8000622c:	8f5d                	or	a4,a4,a5
    8000622e:	0089579b          	srliw	a5,s2,0x8
    80006232:	66c1                	lui	a3,0x10
    80006234:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80006238:	8ff5                	and	a5,a5,a3
    8000623a:	8fd9                	or	a5,a5,a4
  arphdr->tip = htonl(dip);
    8000623c:	00e98c23          	sb	a4,24(s3)
    80006240:	0087d71b          	srliw	a4,a5,0x8
    80006244:	00e98ca3          	sb	a4,25(s3)
    80006248:	0107d71b          	srliw	a4,a5,0x10
    8000624c:	00e98d23          	sb	a4,26(s3)
    80006250:	0187d79b          	srliw	a5,a5,0x18
    80006254:	00f98da3          	sb	a5,27(s3)
  net_tx_eth(m, ETHTYPE_ARP);
    80006258:	6585                	lui	a1,0x1
    8000625a:	80658593          	addi	a1,a1,-2042 # 806 <_entry-0x7ffff7fa>
    8000625e:	8552                	mv	a0,s4
    80006260:	00000097          	auipc	ra,0x0
    80006264:	978080e7          	jalr	-1672(ra) # 80005bd8 <net_tx_eth>
  return 0;
    80006268:	b5d9                	j	8000612e <net_rx+0x2b6>

000000008000626a <sockinit>:
...
sockinit(void)
{
    ...
    8000626c:	e406                	sd	ra,8(sp)
    8000626e:	e022                	sd	s0,0(sp)
    80006270:	0800                	addi	s0,sp,16
  initlock(&lock, "socktbl");
    80006272:	00003597          	auipc	a1,0x3
    80006276:	5c658593          	addi	a1,a1,1478 # 80009838 <syscalls+0x460>
    8000627a:	00019517          	auipc	a0,0x19
    8000627e:	0a650513          	addi	a0,a0,166 # 8001f320 <lock>
    80006282:	00001097          	auipc	ra,0x1
    80006286:	e5c080e7          	jalr	-420(ra) # 800070de <initlock>
}
...
0000000080006292 <sockalloc>:

int
sockalloc(struct file **f, uint32 raddr, uint16 lport, uint16 rport)
{
    80006292:	7139                	addi	sp,sp,-64
    80006294:	fc06                	sd	ra,56(sp)
    80006296:	f822                	sd	s0,48(sp)
    80006298:	f426                	sd	s1,40(sp)
    8000629a:	f04a                	sd	s2,32(sp)
    8000629c:	ec4e                	sd	s3,24(sp)
    8000629e:	e852                	sd	s4,16(sp)
    800062a0:	e456                	sd	s5,8(sp)
    800062a2:	0080                	addi	s0,sp,64
    800062a4:	892a                	mv	s2,a0
    800062a6:	84ae                	mv	s1,a1
    800062a8:	8a32                	mv	s4,a2
    800062aa:	89b6                	mv	s3,a3
  struct sock *si, *pos;
  ...
  *f = 0;
  ...
  if ((*f = filealloc()) == 0)
    ...
    800062b4:	620080e7          	jalr	1568(ra) # 800038d0 <filealloc>
    800062b8:	00a93023          	sd	a0,0(s2)
    800062bc:	c975                	beqz	a0,800063b0 <sockalloc+0x11e>
    goto bad;
  if ((si = (struct sock*)kalloc()) == 0)
    800062be:	ffffa097          	auipc	ra,0xffffa
    800062c2:	e5a080e7          	jalr	-422(ra) # 80000118 <kalloc>
    800062c6:	8aaa                	mv	s5,a0
    800062c8:	c15d                	beqz	a0,8000636e <sockalloc+0xdc>
    goto bad;

  // initialize objects
  si->raddr = raddr;
    800062ca:	c504                	sw	s1,8(a0)
  si->lport = lport;
    800062cc:	01451623          	sh	s4,12(a0)
  si->rport = rport;
    800062d0:	01351723          	sh	s3,14(a0)
  initlock(&si->lock, "sock");
    800062d4:	00003597          	auipc	a1,0x3
    800062d8:	56c58593          	addi	a1,a1,1388 # 80009840 <syscalls+0x468>
    800062dc:	0541                	addi	a0,a0,16
    800062de:	00001097          	auipc	ra,0x1
    800062e2:	e00080e7          	jalr	-512(ra) # 800070de <initlock>
  mbufq_init(&si->rxq);
    800062e6:	028a8513          	addi	a0,s5,40
    800062ea:	00000097          	auipc	ra,0x0
    800062ee:	a7a080e7          	jalr	-1414(ra) # 80005d64 <mbufq_init>
  (*f)->type = FD_SOCK;
    800062f2:	00093783          	ld	a5,0(s2)
    800062f6:	4711                	li	a4,4
    800062f8:	c398                	sw	a4,0(a5)
  (*f)->readable = 1;
    800062fa:	00093703          	ld	a4,0(s2)
    800062fe:	4785                	li	a5,1
    80006300:	00f70423          	sb	a5,8(a4)
  (*f)->writable = 1;
    80006304:	00093703          	ld	a4,0(s2)
    80006308:	00f704a3          	sb	a5,9(a4)
  (*f)->sock = si;
    8000630c:	00093783          	ld	a5,0(s2)
    80006310:	0357b023          	sd	s5,32(a5) # f020020 <_entry-0x70fdffe0>

  // add to list of sockets
  acquire(&lock);
    80006314:	00019517          	auipc	a0,0x19
    80006318:	00c50513          	addi	a0,a0,12 # 8001f320 <lock>
    8000631c:	00001097          	auipc	ra,0x1
    80006320:	e52080e7          	jalr	-430(ra) # 8000716e <acquire>
  pos = sockets;
    80006324:	00004597          	auipc	a1,0x4
    80006328:	d045b583          	ld	a1,-764(a1) # 8000a028 <sockets>
  while (pos) {
    8000632c:	c9b1                	beqz	a1,80006380 <sockalloc+0xee>
  pos = sockets;
    8000632e:	87ae                	mv	a5,a1
    if (pos->raddr == raddr &&
    80006330:	000a061b          	sext.w	a2,s4
        pos->lport == lport &&
    80006334:	0009869b          	sext.w	a3,s3
    80006338:	a019                	j	8000633e <sockalloc+0xac>
	pos->rport == rport) {
      release(&lock);
      goto bad;
    }
  ...
  while (pos) {
    8000633c:	c3b1                	beqz	a5,80006380 <sockalloc+0xee>
    if (pos->raddr == raddr &&
    8000633e:	4798                	lw	a4,8(a5)
    80006340:	fe971de3          	bne	a4,s1,8000633a <sockalloc+0xa8>
    80006344:	00c7d703          	lhu	a4,12(a5)
    80006348:	fec719e3          	bne	a4,a2,8000633a <sockalloc+0xa8>
        pos->lport == lport &&
    8000634c:	00e7d703          	lhu	a4,14(a5)
    80006350:	fed715e3          	bne	a4,a3,8000633a <sockalloc+0xa8>
      release(&lock);
    80006354:	00019517          	auipc	a0,0x19
    80006358:	fcc50513          	addi	a0,a0,-52 # 8001f320 <lock>
    8000635c:	00001097          	auipc	ra,0x1
    80006360:	ec6080e7          	jalr	-314(ra) # 80007222 <release>
  release(&lock);
  return 0;
...
bad:
  if (si)
    ...
    8000636a:	cb6080e7          	jalr	-842(ra) # 8000001c <kfree>
  if (*f)
    8000636e:	00093503          	ld	a0,0(s2)
    80006372:	c129                	beqz	a0,800063b4 <sockalloc+0x122>
    fileclose(*f);
    80006374:	ffffd097          	auipc	ra,0xffffd
    80006378:	618080e7          	jalr	1560(ra) # 8000398c <fileclose>
  return -1;
    8000637c:	557d                	li	a0,-1
    8000637e:	a005                	j	8000639e <sockalloc+0x10c>
  si->next = sockets;
    80006380:	00bab023          	sd	a1,0(s5)
  sockets = si;
    80006384:	00004797          	auipc	a5,0x4
    80006388:	cb57b223          	sd	s5,-860(a5) # 8000a028 <sockets>
  release(&lock);
    8000638c:	00019517          	auipc	a0,0x19
    80006390:	f9450513          	addi	a0,a0,-108 # 8001f320 <lock>
    80006394:	00001097          	auipc	ra,0x1
    80006398:	e8e080e7          	jalr	-370(ra) # 80007222 <release>
  return 0;
  ...
  return -1;
    ...
    800063b2:	b7f5                	j	8000639e <sockalloc+0x10c>
    800063b4:	557d                	li	a0,-1
    800063b6:	b7e5                	j	8000639e <sockalloc+0x10c>

00000000800063b8 <sockclose>:
...
sockclose(struct sock *si)
{
  ...
  acquire(&lock);
    800063c6:	00019517          	auipc	a0,0x19
    800063ca:	f5a50513          	addi	a0,a0,-166 # 8001f320 <lock>
    800063ce:	00001097          	auipc	ra,0x1
    800063d2:	da0080e7          	jalr	-608(ra) # 8000716e <acquire>
  pos = &sockets;
    800063d6:	00004797          	auipc	a5,0x4
    800063da:	c527b783          	ld	a5,-942(a5) # 8000a028 <sockets>
  while (*pos) {
    800063de:	cb99                	beqz	a5,800063f4 <sockclose+0x3c>
    if (*pos == si){
    800063e0:	02f90563          	beq	s2,a5,8000640a <sockclose+0x52>
      *pos = si->next;
      break;
    }
    pos = &(*pos)->next;
    800063e4:	873e                	mv	a4,a5
    800063e6:	639c                	ld	a5,0(a5)
  while (*pos) {
    800063e8:	c791                	beqz	a5,800063f4 <sockclose+0x3c>
    if (*pos == si){
    800063ea:	fef91de3          	bne	s2,a5,800063e4 <sockclose+0x2c>
      *pos = si->next;
    800063ee:	00093783          	ld	a5,0(s2)
    800063f2:	e31c                	sd	a5,0(a4)
  }
  release(&lock);
    800063f4:	00019517          	auipc	a0,0x19
    800063f8:	f2c50513          	addi	a0,a0,-212 # 8001f320 <lock>
    800063fc:	00001097          	auipc	ra,0x1
    80006400:	e26080e7          	jalr	-474(ra) # 80007222 <release>

  // free any pending mbufs
  while (!mbufq_empty(&si->rxq)) {
    80006404:	02890493          	addi	s1,s2,40
    80006408:	a839                	j	80006426 <sockclose+0x6e>
  pos = &sockets;
    8000640a:	00004717          	auipc	a4,0x4
    8000640e:	c1e70713          	addi	a4,a4,-994 # 8000a028 <sockets>
    80006412:	bff1                	j	800063ee <sockclose+0x36>
    m = mbufq_pophead(&si->rxq);
    80006414:	8526                	mv	a0,s1
    80006416:	00000097          	auipc	ra,0x0
    8000641a:	926080e7          	jalr	-1754(ra) # 80005d3c <mbufq_pophead>
    mbuffree(m);
    8000641e:	00000097          	auipc	ra,0x0
    80006422:	8e6080e7          	jalr	-1818(ra) # 80005d04 <mbuffree>
  while (!mbufq_empty(&si->rxq)) {
    80006426:	8526                	mv	a0,s1
    80006428:	00000097          	auipc	ra,0x0
    8000642c:	92a080e7          	jalr	-1750(ra) # 80005d52 <mbufq_empty>
    80006430:	d175                	beqz	a0,80006414 <sockclose+0x5c>
  }

  kfree((char*)si);
    80006432:	854a                	mv	a0,s2
    80006434:	ffffa097          	auipc	ra,0xffffa
    80006438:	be8080e7          	jalr	-1048(ra) # 8000001c <kfree>
}
...
0000000080006448 <sockread>:

int
sockread(struct sock *si, uint64 addr, int n)
{
    80006448:	7139                	addi	sp,sp,-64
    8000644a:	fc06                	sd	ra,56(sp)
    8000644c:	f822                	sd	s0,48(sp)
    8000644e:	f426                	sd	s1,40(sp)
    80006450:	f04a                	sd	s2,32(sp)
    80006452:	ec4e                	sd	s3,24(sp)
    80006454:	e852                	sd	s4,16(sp)
    80006456:	e456                	sd	s5,8(sp)
    80006458:	0080                	addi	s0,sp,64
    8000645a:	84aa                	mv	s1,a0
    8000645c:	8a2e                	mv	s4,a1
    8000645e:	8ab2                	mv	s5,a2
  struct proc *pr = myproc();
    80006460:	ffffb097          	auipc	ra,0xffffb
    80006464:	a40080e7          	jalr	-1472(ra) # 80000ea0 <myproc>
    80006468:	892a                	mv	s2,a0
  struct mbuf *m;
  int len;

  acquire(&si->lock);
    8000646a:	01048993          	addi	s3,s1,16
    8000646e:	854e                	mv	a0,s3
    80006470:	00001097          	auipc	ra,0x1
    80006474:	cfe080e7          	jalr	-770(ra) # 8000716e <acquire>
  while (mbufq_empty(&si->rxq) && !pr->killed) {
    80006478:	02848493          	addi	s1,s1,40
    8000647c:	8526                	mv	a0,s1
    8000647e:	00000097          	auipc	ra,0x0
    80006482:	8d4080e7          	jalr	-1836(ra) # 80005d52 <mbufq_empty>
    80006486:	c919                	beqz	a0,8000649c <sockread+0x54>
    80006488:	02892783          	lw	a5,40(s2)
    8000648c:	eba5                	bnez	a5,800064fc <sockread+0xb4>
    sleep(&si->rxq, &si->lock);
    8000648e:	85ce                	mv	a1,s3
    80006490:	8526                	mv	a0,s1
    80006492:	ffffb097          	auipc	ra,0xffffb
    80006496:	0ca080e7          	jalr	202(ra) # 8000155c <sleep>
    8000649a:	b7cd                	j	8000647c <sockread+0x34>
  }
  if (pr->killed) {
    8000649c:	02892783          	lw	a5,40(s2)
    800064a0:	efb1                	bnez	a5,800064fc <sockread+0xb4>
    release(&si->lock);
    return -1;
  }
  m = mbufq_pophead(&si->rxq);
    ...
    800064a8:	898080e7          	jalr	-1896(ra) # 80005d3c <mbufq_pophead>
    800064ac:	84aa                	mv	s1,a0
  release(&si->lock);
    800064ae:	854e                	mv	a0,s3
    800064b0:	00001097          	auipc	ra,0x1
    800064b4:	d72080e7          	jalr	-654(ra) # 80007222 <release>

  len = m->len;
    800064b8:	489c                	lw	a5,16(s1)
  if (len > n)
    800064ba:	89be                	mv	s3,a5
    800064bc:	00fad363          	bge	s5,a5,800064c2 <sockread+0x7a>
    800064c0:	89d6                	mv	s3,s5
    800064c2:	2981                	sext.w	s3,s3
    len = n;
  if (copyout(pr->pagetable, addr, m->head, len) == -1) {
    800064c4:	86ce                	mv	a3,s3
    800064c6:	6490                	ld	a2,8(s1)
    800064c8:	85d2                	mv	a1,s4
    800064ca:	05093503          	ld	a0,80(s2)
    800064ce:	ffffa097          	auipc	ra,0xffffa
    800064d2:	698080e7          	jalr	1688(ra) # 80000b66 <copyout>
    800064d6:	892a                	mv	s2,a0
    800064d8:	57fd                	li	a5,-1
    800064da:	02f50863          	beq	a0,a5,8000650a <sockread+0xc2>
    mbuffree(m);
    return -1;
  }
  mbuffree(m);
    ...
    800064e4:	824080e7          	jalr	-2012(ra) # 80005d04 <mbuffree>
  return len;
}
    800064e8:	854e                	mv	a0,s3
    800064ea:	70e2                	ld	ra,56(sp)
    800064ec:	7442                	ld	s0,48(sp)
    800064ee:	74a2                	ld	s1,40(sp)
    800064f0:	7902                	ld	s2,32(sp)
    800064f2:	69e2                	ld	s3,24(sp)
    800064f4:	6a42                	ld	s4,16(sp)
    800064f6:	6aa2                	ld	s5,8(sp)
    800064f8:	6121                	addi	sp,sp,64
    800064fa:	8082                	ret
    release(&si->lock);
    800064fc:	854e                	mv	a0,s3
    800064fe:	00001097          	auipc	ra,0x1
    80006502:	d24080e7          	jalr	-732(ra) # 80007222 <release>
    return -1;
    80006506:	59fd                	li	s3,-1
    80006508:	b7c5                	j	800064e8 <sockread+0xa0>
    mbuffree(m);
    8000650a:	8526                	mv	a0,s1
    8000650c:	fffff097          	auipc	ra,0xfffff
    80006510:	7f8080e7          	jalr	2040(ra) # 80005d04 <mbuffree>
    return -1;
    80006514:	89ca                	mv	s3,s2
    80006516:	bfc9                	j	800064e8 <sockread+0xa0>

0000000080006518 <sockwrite>:
...
sockwrite(struct sock *si, uint64 addr, int n)
{
    ...
    8000651e:	f426                	sd	s1,40(sp)
    80006520:	f04a                	sd	s2,32(sp)
    80006522:	ec4e                	sd	s3,24(sp)
    80006524:	e852                	sd	s4,16(sp)
    80006526:	e456                	sd	s5,8(sp)
    80006528:	0080                	addi	s0,sp,64
    8000652a:	8aaa                	mv	s5,a0
    8000652c:	89ae                	mv	s3,a1
    8000652e:	8932                	mv	s2,a2
  struct proc *pr = myproc();
    80006530:	ffffb097          	auipc	ra,0xffffb
    80006534:	970080e7          	jalr	-1680(ra) # 80000ea0 <myproc>
    80006538:	8a2a                	mv	s4,a0
  struct mbuf *m;

  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    8000653a:	08000513          	li	a0,128
    8000653e:	fffff097          	auipc	ra,0xfffff
    80006542:	76e080e7          	jalr	1902(ra) # 80005cac <mbufalloc>
  if (!m)
    80006546:	c12d                	beqz	a0,800065a8 <sockwrite+0x90>
    80006548:	84aa                	mv	s1,a0
    return -1;

  if (copyin(pr->pagetable, mbufput(m, n), addr, n) == -1) {
    8000654a:	050a3a03          	ld	s4,80(s4)
    8000654e:	85ca                	mv	a1,s2
    80006550:	fffff097          	auipc	ra,0xfffff
    80006554:	700080e7          	jalr	1792(ra) # 80005c50 <mbufput>
    80006558:	85aa                	mv	a1,a0
    8000655a:	86ca                	mv	a3,s2
    8000655c:	864e                	mv	a2,s3
    8000655e:	8552                	mv	a0,s4
    80006560:	ffffa097          	auipc	ra,0xffffa
    80006564:	692080e7          	jalr	1682(ra) # 80000bf2 <copyin>
    80006568:	89aa                	mv	s3,a0
    8000656a:	57fd                	li	a5,-1
    8000656c:	02f50863          	beq	a0,a5,8000659c <sockwrite+0x84>
    mbuffree(m);
    return -1;
  }
  net_tx_udp(m, si->raddr, si->lport, si->rport);
    80006570:	00ead683          	lhu	a3,14(s5)
    80006574:	00cad603          	lhu	a2,12(s5)
    80006578:	008aa583          	lw	a1,8(s5)
    8000657c:	8526                	mv	a0,s1
    8000657e:	fffff097          	auipc	ra,0xfffff
    80006582:	7f6080e7          	jalr	2038(ra) # 80005d74 <net_tx_udp>
  return n;
    80006586:	89ca                	mv	s3,s2
}
    80006588:	854e                	mv	a0,s3
    8000658a:	70e2                	ld	ra,56(sp)
    8000658c:	7442                	ld	s0,48(sp)
    8000658e:	74a2                	ld	s1,40(sp)
    80006590:	7902                	ld	s2,32(sp)
    80006592:	69e2                	ld	s3,24(sp)
    80006594:	6a42                	ld	s4,16(sp)
    80006596:	6aa2                	ld	s5,8(sp)
    80006598:	6121                	addi	sp,sp,64
    8000659a:	8082                	ret
    mbuffree(m);
    8000659c:	8526                	mv	a0,s1
    8000659e:	fffff097          	auipc	ra,0xfffff
    800065a2:	766080e7          	jalr	1894(ra) # 80005d04 <mbuffree>
    return -1;
    800065a6:	b7cd                	j	80006588 <sockwrite+0x70>
    return -1;
    800065a8:	59fd                	li	s3,-1
    800065aa:	bff9                	j	80006588 <sockwrite+0x70>

00000000800065ac <sockrecvudp>:

// called by protocol handler layer to deliver UDP packets
void
sockrecvudp(struct mbuf *m, uint32 raddr, uint16 lport, uint16 rport)
{
    800065ac:	7139                	addi	sp,sp,-64
    800065ae:	fc06                	sd	ra,56(sp)
    800065b0:	f822                	sd	s0,48(sp)
    800065b2:	f426                	sd	s1,40(sp)
    800065b4:	f04a                	sd	s2,32(sp)
    800065b6:	ec4e                	sd	s3,24(sp)
    800065b8:	e852                	sd	s4,16(sp)
    800065ba:	e456                	sd	s5,8(sp)
    800065bc:	0080                	addi	s0,sp,64
    800065be:	8a2a                	mv	s4,a0
    800065c0:	892e                	mv	s2,a1
    800065c2:	89b2                	mv	s3,a2
    800065c4:	8ab6                	mv	s5,a3
  ...
  acquire(&lock);
    800065c6:	00019517          	auipc	a0,0x19
    800065ca:	d5a50513          	addi	a0,a0,-678 # 8001f320 <lock>
    800065ce:	00001097          	auipc	ra,0x1
    800065d2:	ba0080e7          	jalr	-1120(ra) # 8000716e <acquire>
  si = sockets;
    800065d6:	00004497          	auipc	s1,0x4
    800065da:	a524b483          	ld	s1,-1454(s1) # 8000a028 <sockets>
  while (si) {
    800065de:	c4ad                	beqz	s1,80006648 <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065e0:	0009871b          	sext.w	a4,s3
    800065e4:	000a869b          	sext.w	a3,s5
    800065e8:	a019                	j	800065ee <sockrecvudp+0x42>
      goto found;
    si = si->next;
    800065ea:	6084                	ld	s1,0(s1)
  while (si) {
    800065ec:	ccb1                	beqz	s1,80006648 <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065ee:	449c                	lw	a5,8(s1)
    800065f0:	ff279de3          	bne	a5,s2,800065ea <sockrecvudp+0x3e>
    800065f4:	00c4d783          	lhu	a5,12(s1)
    800065f8:	fee799e3          	bne	a5,a4,800065ea <sockrecvudp+0x3e>
    800065fc:	00e4d783          	lhu	a5,14(s1)
    80006600:	fed795e3          	bne	a5,a3,800065ea <sockrecvudp+0x3e>
  release(&lock);
  mbuffree(m);
  return;
...
found:
  acquire(&si->lock);
    80006604:	01048913          	addi	s2,s1,16
    80006608:	854a                	mv	a0,s2
    8000660a:	00001097          	auipc	ra,0x1
    8000660e:	b64080e7          	jalr	-1180(ra) # 8000716e <acquire>
  mbufq_pushtail(&si->rxq, m);
    80006612:	02848493          	addi	s1,s1,40
    80006616:	85d2                	mv	a1,s4
    80006618:	8526                	mv	a0,s1
    8000661a:	fffff097          	auipc	ra,0xfffff
    8000661e:	702080e7          	jalr	1794(ra) # 80005d1c <mbufq_pushtail>
  wakeup(&si->rxq);
    80006622:	8526                	mv	a0,s1
    80006624:	ffffb097          	auipc	ra,0xffffb
    80006628:	0c4080e7          	jalr	196(ra) # 800016e8 <wakeup>
  release(&si->lock);
    8000662c:	854a                	mv	a0,s2
    8000662e:	00001097          	auipc	ra,0x1
    80006632:	bf4080e7          	jalr	-1036(ra) # 80007222 <release>
  release(&lock);
    80006636:	00019517          	auipc	a0,0x19
    8000663a:	cea50513          	addi	a0,a0,-790 # 8001f320 <lock>
    8000663e:	00001097          	auipc	ra,0x1
    80006642:	be4080e7          	jalr	-1052(ra) # 80007222 <release>
    80006646:	a831                	j	80006662 <sockrecvudp+0xb6>
  release(&lock);
    80006648:	00019517          	auipc	a0,0x19
    8000664c:	cd850513          	addi	a0,a0,-808 # 8001f320 <lock>
    80006650:	00001097          	auipc	ra,0x1
    80006654:	bd2080e7          	jalr	-1070(ra) # 80007222 <release>
  mbuffree(m);
    80006658:	8552                	mv	a0,s4
    8000665a:	fffff097          	auipc	ra,0xfffff
    8000665e:	6aa080e7          	jalr	1706(ra) # 80005d04 <mbuffree>
}
    80006662:	70e2                	ld	ra,56(sp)
    80006664:	7442                	ld	s0,48(sp)
    80006666:	74a2                	ld	s1,40(sp)
    80006668:	7902                	ld	s2,32(sp)
    8000666a:	69e2                	ld	s3,24(sp)
    8000666c:	6a42                	ld	s4,16(sp)
    8000666e:	6aa2                	ld	s5,8(sp)
    80006670:	6121                	addi	sp,sp,64
    80006672:	8082                	ret

0000000080006674 <pci_init>:
#include "proc.h"
#include "defs.h"
...
pci_init()
{
    80006674:	715d                	addi	sp,sp,-80
    80006676:	e486                	sd	ra,72(sp)
    80006678:	e0a2                	sd	s0,64(sp)
    8000667a:	fc26                	sd	s1,56(sp)
    8000667c:	f84a                	sd	s2,48(sp)
    8000667e:	f44e                	sd	s3,40(sp)
    80006680:	f052                	sd	s4,32(sp)
    80006682:	ec56                	sd	s5,24(sp)
    80006684:	e85a                	sd	s6,16(sp)
    80006686:	e45e                	sd	s7,8(sp)
    80006688:	0880                	addi	s0,sp,80
    8000668a:	300004b7          	lui	s1,0x30000
    ...
    if(id == 0x100e8086){
    8000668e:	100e8937          	lui	s2,0x100e8
    80006692:	08690913          	addi	s2,s2,134 # 100e8086 <_entry-0x6ff17f7a>
      // command and status register.
      // bit 0 : I/O access enable
      // bit 1 : memory access enable
      // bit 2 : enable mastering
      base[1] = 7;
    80006696:	4b9d                	li	s7,7
      for(int i = 0; i < 6; i++){
        uint32 old = base[4+i];
    ...
    80006698:	5afd                	li	s5,-1
      ...
      base[4+0] = e1000_regs;
    8000669a:	40000b37          	lui	s6,0x40000
    8000669e:	6a09                	lui	s4,0x2
  for(int dev = 0; dev < 32; dev++){
    800066a0:	300409b7          	lui	s3,0x30040
    800066a4:	a821                	j	800066bc <pci_init+0x48>
      base[4+0] = e1000_regs;
    800066a6:	0166a823          	sw	s6,16(a3)

      e1000_init((uint32*)e1000_regs);
    800066aa:	40000537          	lui	a0,0x40000
    800066ae:	fffff097          	auipc	ra,0xfffff
    800066b2:	0b2080e7          	jalr	178(ra) # 80005760 <e1000_init>
  for(int dev = 0; dev < 32; dev++){
    800066b6:	94d2                	add	s1,s1,s4
    800066b8:	03348a63          	beq	s1,s3,800066ec <pci_init+0x78>
    volatile uint32 *base = ecam + off;
    800066bc:	86a6                	mv	a3,s1
    uint32 id = base[0];
    800066be:	409c                	lw	a5,0(s1)
    800066c0:	2781                	sext.w	a5,a5
    if(id == 0x100e8086){
    800066c2:	ff279ae3          	bne	a5,s2,800066b6 <pci_init+0x42>
      base[1] = 7;
    800066c6:	0174a223          	sw	s7,4(s1) # 30000004 <_entry-0x4ffffffc>
      __sync_synchronize();
    800066ca:	0ff0000f          	fence
      for(int i = 0; i < 6; i++){
    800066ce:	01048793          	addi	a5,s1,16
    800066d2:	02848613          	addi	a2,s1,40
        uint32 old = base[4+i];
    800066d6:	4398                	lw	a4,0(a5)
    800066d8:	2701                	sext.w	a4,a4
        base[4+i] = 0xffffffff;
    800066da:	0157a023          	sw	s5,0(a5)
        __sync_synchronize();
    800066de:	0ff0000f          	fence
        base[4+i] = old;
    800066e2:	c398                	sw	a4,0(a5)
      for(int i = 0; i < 6; i++){
    800066e4:	0791                	addi	a5,a5,4
    800066e6:	fec798e3          	bne	a5,a2,800066d6 <pci_init+0x62>
    800066ea:	bf75                	j	800066a6 <pci_init+0x32>
    }
  }
}
    800066ec:	60a6                	ld	ra,72(sp)
    800066ee:	6406                	ld	s0,64(sp)
    800066f0:	74e2                	ld	s1,56(sp)
    800066f2:	7942                	ld	s2,48(sp)
    800066f4:	79a2                	ld	s3,40(sp)
    800066f6:	7a02                	ld	s4,32(sp)
    800066f8:	6ae2                	ld	s5,24(sp)
    800066fa:	6b42                	ld	s6,16(sp)
    800066fc:	6ba2                	ld	s7,8(sp)
    800066fe:	6161                	addi	sp,sp,80
    80006700:	8082                	ret

0000000080006702 <timerinit>:
...
timerinit()
{
  ...
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
    ...
    80006714:	02004737          	lui	a4,0x2004
    80006718:	97ba                	add	a5,a5,a4
    8000671a:	0200c737          	lui	a4,0x200c
    8000671e:	ff873583          	ld	a1,-8(a4) # 200bff8 <_entry-0x7dff4008>
    80006722:	000f4637          	lui	a2,0xf4
    80006726:	24060613          	addi	a2,a2,576 # f4240 <_entry-0x7ff0bdc0>
    8000672a:	95b2                	add	a1,a1,a2
    8000672c:	e38c                	sd	a1,0(a5)
  ...
  uint64 *scratch = &timer_scratch[id][0];
    8000672e:	00269713          	slli	a4,a3,0x2
    80006732:	9736                	add	a4,a4,a3
    80006734:	00371693          	slli	a3,a4,0x3
    80006738:	00019717          	auipc	a4,0x19
    8000673c:	c0870713          	addi	a4,a4,-1016 # 8001f340 <timer_scratch>
    80006740:	9736                	add	a4,a4,a3
  scratch[3] = CLINT_MTIMECMP(id);
    80006742:	ef1c                	sd	a5,24(a4)
  scratch[4] = interval;
    80006744:	f310                	sd	a2,32(a4)
  asm volatile("csrw mscratch, %0" : : "r" (x));
    80006746:	34071073          	csrw	mscratch,a4
  asm volatile("csrw mtvec, %0" : : "r" (x));
    8000674a:	fffff797          	auipc	a5,0xfffff
    8000674e:	9b678793          	addi	a5,a5,-1610 # 80005100 <timervec>
    80006752:	30579073          	csrw	mtvec,a5
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    80006756:	300027f3          	csrr	a5,mstatus
  ...
  w_mstatus(r_mstatus() | MSTATUS_MIE);
    8000675a:	0087e793          	ori	a5,a5,8
  asm volatile("csrw mstatus, %0" : : "r" (x));
    8000675e:	30079073          	csrw	mstatus,a5
  asm volatile("csrr %0, mie" : "=r" (x) );
    80006762:	304027f3          	csrr	a5,mie

  // enable machine-mode timer interrupts.
  w_mie(r_mie() | MIE_MTIE);
    80006766:	0807e793          	ori	a5,a5,128
  asm volatile("csrw mie, %0" : : "r" (x));
    8000676a:	30479073          	csrw	mie,a5
}
    8000676e:	6422                	ld	s0,8(sp)
    80006770:	0141                	addi	sp,sp,16
    80006772:	8082                	ret

0000000080006774 <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    80006780:	7779                	lui	a4,0xffffe
    80006782:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffd727f>
    80006786:	8ff9                	and	a5,a5,a4
  x |= MSTATUS_MPP_S;
    80006788:	6705                	lui	a4,0x1
    8000678a:	80070713          	addi	a4,a4,-2048 # 800 <_entry-0x7ffff800>
    8000678e:	8fd9                	or	a5,a5,a4
  asm volatile("csrw mstatus, %0" : : "r" (x));
    80006790:	30079073          	csrw	mstatus,a5
  asm volatile("csrw mepc, %0" : : "r" (x));
    80006794:	ffffa797          	auipc	a5,0xffffa
    80006798:	b9278793          	addi	a5,a5,-1134 # 80000326 <main>
    8000679c:	34179073          	csrw	mepc,a5
  asm volatile("csrw satp, %0" : : "r" (x));
    800067a0:	4781                	li	a5,0
    800067a2:	18079073          	csrw	satp,a5
  asm volatile("csrw medeleg, %0" : : "r" (x));
    800067a6:	67c1                	lui	a5,0x10
    800067a8:	17fd                	addi	a5,a5,-1
    800067aa:	30279073          	csrw	medeleg,a5
  asm volatile("csrw mideleg, %0" : : "r" (x));
    800067ae:	30379073          	csrw	mideleg,a5
  asm volatile("csrr %0, sie" : "=r" (x) );
    800067b2:	104027f3          	csrr	a5,sie
  w_sie(r_sie() | SIE_SEIE | SIE_STIE | SIE_SSIE);
    800067b6:	2227e793          	ori	a5,a5,546
  asm volatile("csrw sie, %0" : : "r" (x));
    800067ba:	10479073          	csrw	sie,a5
  asm volatile("csrw pmpaddr0, %0" : : "r" (x));
    800067be:	57fd                	li	a5,-1
    800067c0:	83a9                	srli	a5,a5,0xa
    800067c2:	3b079073          	csrw	pmpaddr0,a5
  asm volatile("csrw pmpcfg0, %0" : : "r" (x));
    800067c6:	47bd                	li	a5,15
    800067c8:	3a079073          	csrw	pmpcfg0,a5
  timerinit();
    800067cc:	00000097          	auipc	ra,0x0
    800067d0:	f36080e7          	jalr	-202(ra) # 80006702 <timerinit>
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    800067d4:	f14027f3          	csrr	a5,mhartid
  w_tp(id);
    800067d8:	2781                	sext.w	a5,a5
  asm volatile("mv tp, %0" : : "r" (x));
    800067da:	823e                	mv	tp,a5
  asm volatile("mret");
    800067dc:	30200073          	mret
}
    800067e0:	60a2                	ld	ra,8(sp)
    800067e2:	6402                	ld	s0,0(sp)
    800067e4:	0141                	addi	sp,sp,16
    800067e6:	8082                	ret

00000000800067e8 <consolewrite>:
//
...
{
    800067e8:	715d                	addi	sp,sp,-80
    800067ea:	e486                	sd	ra,72(sp)
    800067ec:	e0a2                	sd	s0,64(sp)
    800067ee:	fc26                	sd	s1,56(sp)
    800067f0:	f84a                	sd	s2,48(sp)
    800067f2:	f44e                	sd	s3,40(sp)
    800067f4:	f052                	sd	s4,32(sp)
    800067f6:	ec56                	sd	s5,24(sp)
    800067f8:	0880                	addi	s0,sp,80
  int i;

  for(i = 0; i < n; i++){
    800067fa:	04c05663          	blez	a2,80006846 <consolewrite+0x5e>
    800067fe:	8a2a                	mv	s4,a0
    80006800:	84ae                	mv	s1,a1
    80006802:	89b2                	mv	s3,a2
    80006804:	4901                	li	s2,0
    char c;
    if(either_copyin(&c, user_src, src+i, 1) == -1)
    80006806:	5afd                	li	s5,-1
    80006808:	4685                	li	a3,1
    8000680a:	8626                	mv	a2,s1
    8000680c:	85d2                	mv	a1,s4
    8000680e:	fbf40513          	addi	a0,s0,-65
    80006812:	ffffb097          	auipc	ra,0xffffb
    80006816:	144080e7          	jalr	324(ra) # 80001956 <either_copyin>
    8000681a:	01550c63          	beq	a0,s5,80006832 <consolewrite+0x4a>
      break;
    uartputc(c);
    8000681e:	fbf44503          	lbu	a0,-65(s0)
    80006822:	00000097          	auipc	ra,0x0
    80006826:	78e080e7          	jalr	1934(ra) # 80006fb0 <uartputc>
  for(i = 0; i < n; i++){
    8000682a:	2905                	addiw	s2,s2,1
    8000682c:	0485                	addi	s1,s1,1
    8000682e:	fd299de3          	bne	s3,s2,80006808 <consolewrite+0x20>
  }

  return i;
}
    80006832:	854a                	mv	a0,s2
    80006834:	60a6                	ld	ra,72(sp)
    80006836:	6406                	ld	s0,64(sp)
    80006838:	74e2                	ld	s1,56(sp)
    8000683a:	7942                	ld	s2,48(sp)
    8000683c:	79a2                	ld	s3,40(sp)
    8000683e:	7a02                	ld	s4,32(sp)
    80006840:	6ae2                	ld	s5,24(sp)
    80006842:	6161                	addi	sp,sp,80
    80006844:	8082                	ret
  for(i = 0; i < n; i++){
    80006846:	4901                	li	s2,0
    80006848:	b7ed                	j	80006832 <consolewrite+0x4a>

000000008000684a <consoleread>:
...
{
    8000684a:	7119                	addi	sp,sp,-128
    8000684c:	fc86                	sd	ra,120(sp)
    8000684e:	f8a2                	sd	s0,112(sp)
    80006850:	f4a6                	sd	s1,104(sp)
    80006852:	f0ca                	sd	s2,96(sp)
    80006854:	ecce                	sd	s3,88(sp)
    80006856:	e8d2                	sd	s4,80(sp)
    80006858:	e4d6                	sd	s5,72(sp)
    8000685a:	e0da                	sd	s6,64(sp)
    8000685c:	fc5e                	sd	s7,56(sp)
    8000685e:	f862                	sd	s8,48(sp)
    80006860:	f466                	sd	s9,40(sp)
    80006862:	f06a                	sd	s10,32(sp)
    80006864:	ec6e                	sd	s11,24(sp)
    80006866:	0100                	addi	s0,sp,128
    80006868:	8b2a                	mv	s6,a0
    8000686a:	8aae                	mv	s5,a1
    8000686c:	8a32                	mv	s4,a2
  uint target;
  int c;
  char cbuf;

  target = n;
    8000686e:	00060b9b          	sext.w	s7,a2
  acquire(&cons.lock);
    80006872:	00021517          	auipc	a0,0x21
    80006876:	c0e50513          	addi	a0,a0,-1010 # 80027480 <cons>
    8000687a:	00001097          	auipc	ra,0x1
    8000687e:	8f4080e7          	jalr	-1804(ra) # 8000716e <acquire>
  while(n > 0){
    // wait until interrupt handler has put some
    // input into cons.buffer.
    while(cons.r == cons.w){
    80006882:	00021497          	auipc	s1,0x21
    80006886:	bfe48493          	addi	s1,s1,-1026 # 80027480 <cons>
      if(myproc()->killed){
        release(&cons.lock);
        return -1;
      }
      sleep(&cons.r, &cons.lock);
    8000688a:	89a6                	mv	s3,s1
    8000688c:	00021917          	auipc	s2,0x21
    80006890:	c8c90913          	addi	s2,s2,-884 # 80027518 <cons+0x98>
    }

    c = cons.buf[cons.r++ % INPUT_BUF];

    if(c == C('D')){  // end-of-file
    80006894:	4c91                	li	s9,4
      break;
    }
    ...
    if(c == '\n'){
    80006898:	4da9                	li	s11,10
  while(n > 0){
    8000689a:	07405863          	blez	s4,8000690a <consoleread+0xc0>
    while(cons.r == cons.w){
    8000689e:	0984a783          	lw	a5,152(s1)
    800068a2:	09c4a703          	lw	a4,156(s1)
    800068a6:	02f71463          	bne	a4,a5,800068ce <consoleread+0x84>
      if(myproc()->killed){
    800068aa:	ffffa097          	auipc	ra,0xffffa
    800068ae:	5f6080e7          	jalr	1526(ra) # 80000ea0 <myproc>
    800068b2:	551c                	lw	a5,40(a0)
    800068b4:	e7b5                	bnez	a5,80006920 <consoleread+0xd6>
      sleep(&cons.r, &cons.lock);
    800068b6:	85ce                	mv	a1,s3
    800068b8:	854a                	mv	a0,s2
    800068ba:	ffffb097          	auipc	ra,0xffffb
    800068be:	ca2080e7          	jalr	-862(ra) # 8000155c <sleep>
    while(cons.r == cons.w){
    800068c2:	0984a783          	lw	a5,152(s1)
    800068c6:	09c4a703          	lw	a4,156(s1)
    800068ca:	fef700e3          	beq	a4,a5,800068aa <consoleread+0x60>
    c = cons.buf[cons.r++ % INPUT_BUF];
    800068ce:	0017871b          	addiw	a4,a5,1
    800068d2:	08e4ac23          	sw	a4,152(s1)
    800068d6:	07f7f713          	andi	a4,a5,127
    800068da:	9726                	add	a4,a4,s1
    800068dc:	01874703          	lbu	a4,24(a4)
    800068e0:	00070c1b          	sext.w	s8,a4
    if(c == C('D')){  // end-of-file
    800068e4:	079c0663          	beq	s8,s9,80006950 <consoleread+0x106>
    cbuf = c;
    800068e8:	f8e407a3          	sb	a4,-113(s0)
    if(either_copyout(user_dst, dst, &cbuf, 1) == -1)
    800068ec:	4685                	li	a3,1
    800068ee:	f8f40613          	addi	a2,s0,-113
    800068f2:	85d6                	mv	a1,s5
    800068f4:	855a                	mv	a0,s6
    800068f6:	ffffb097          	auipc	ra,0xffffb
    800068fa:	00a080e7          	jalr	10(ra) # 80001900 <either_copyout>
    800068fe:	01a50663          	beq	a0,s10,8000690a <consoleread+0xc0>
    dst++;
    80006902:	0a85                	addi	s5,s5,1
    --n;
    80006904:	3a7d                	addiw	s4,s4,-1
    if(c == '\n'){
    80006906:	f9bc1ae3          	bne	s8,s11,8000689a <consoleread+0x50>
  ...
  release(&cons.lock);
    8000690a:	00021517          	auipc	a0,0x21
    8000690e:	b7650513          	addi	a0,a0,-1162 # 80027480 <cons>
    80006912:	00001097          	auipc	ra,0x1
    80006916:	910080e7          	jalr	-1776(ra) # 80007222 <release>

  return target - n;
    8000691a:	414b853b          	subw	a0,s7,s4
    8000691e:	a811                	j	80006932 <consoleread+0xe8>
        release(&cons.lock);
    80006920:	00021517          	auipc	a0,0x21
    80006924:	b6050513          	addi	a0,a0,-1184 # 80027480 <cons>
    80006928:	00001097          	auipc	ra,0x1
    8000692c:	8fa080e7          	jalr	-1798(ra) # 80007222 <release>
        return -1;
    ...
    8000694c:	6109                	addi	sp,sp,128
    8000694e:	8082                	ret
      if(n < target){
    80006950:	000a071b          	sext.w	a4,s4
    80006954:	fb777be3          	bgeu	a4,s7,8000690a <consoleread+0xc0>
        cons.r--;
    80006958:	00021717          	auipc	a4,0x21
    8000695c:	bcf72023          	sw	a5,-1088(a4) # 80027518 <cons+0x98>
    80006960:	b76d                	j	8000690a <consoleread+0xc0>

0000000080006962 <consputc>:
{
    80006962:	1141                	addi	sp,sp,-16
    80006964:	e406                	sd	ra,8(sp)
    80006966:	e022                	sd	s0,0(sp)
    80006968:	0800                	addi	s0,sp,16
  if(c == BACKSPACE){
    8000696a:	10000793          	li	a5,256
    8000696e:	00f50a63          	beq	a0,a5,80006982 <consputc+0x20>
    uartputc_sync(c);
    80006972:	00000097          	auipc	ra,0x0
    80006976:	564080e7          	jalr	1380(ra) # 80006ed6 <uartputc_sync>
}
    ...
    80006982:	4521                	li	a0,8
    80006984:	00000097          	auipc	ra,0x0
    80006988:	552080e7          	jalr	1362(ra) # 80006ed6 <uartputc_sync>
    8000698c:	02000513          	li	a0,32
    80006990:	00000097          	auipc	ra,0x0
    80006994:	546080e7          	jalr	1350(ra) # 80006ed6 <uartputc_sync>
    80006998:	4521                	li	a0,8
    8000699a:	00000097          	auipc	ra,0x0
    8000699e:	53c080e7          	jalr	1340(ra) # 80006ed6 <uartputc_sync>
    800069a2:	bfe1                	j	8000697a <consputc+0x18>

00000000800069a4 <consoleintr>:
...
consoleintr(int c)
{
    800069a4:	1101                	addi	sp,sp,-32
    800069a6:	ec06                	sd	ra,24(sp)
    800069a8:	e822                	sd	s0,16(sp)
    800069aa:	e426                	sd	s1,8(sp)
    800069ac:	e04a                	sd	s2,0(sp)
    800069ae:	1000                	addi	s0,sp,32
  ...
  acquire(&cons.lock);
    ...
    800069be:	7b4080e7          	jalr	1972(ra) # 8000716e <acquire>

  switch(c){
    800069c2:	47d5                	li	a5,21
    800069c4:	0af48663          	beq	s1,a5,80006a70 <consoleintr+0xcc>
    800069c8:	0297ca63          	blt	a5,s1,800069fc <consoleintr+0x58>
    800069cc:	47a1                	li	a5,8
    800069ce:	0ef48763          	beq	s1,a5,80006abc <consoleintr+0x118>
    800069d2:	47c1                	li	a5,16
    800069d4:	10f49a63          	bne	s1,a5,80006ae8 <consoleintr+0x144>
  case C('P'):  // Print process list.
    procdump();
    800069d8:	ffffb097          	auipc	ra,0xffffb
    800069dc:	fd4080e7          	jalr	-44(ra) # 800019ac <procdump>
      }
    }
    break;
  }
  ...
  release(&cons.lock);
    800069e0:	00021517          	auipc	a0,0x21
    800069e4:	aa050513          	addi	a0,a0,-1376 # 80027480 <cons>
    800069e8:	00001097          	auipc	ra,0x1
    800069ec:	83a080e7          	jalr	-1990(ra) # 80007222 <release>
}
    800069f0:	60e2                	ld	ra,24(sp)
    800069f2:	6442                	ld	s0,16(sp)
    800069f4:	64a2                	ld	s1,8(sp)
    800069f6:	6902                	ld	s2,0(sp)
    800069f8:	6105                	addi	sp,sp,32
    800069fa:	8082                	ret
  switch(c){
    800069fc:	07f00793          	li	a5,127
    80006a00:	0af48e63          	beq	s1,a5,80006abc <consoleintr+0x118>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    80006a04:	00021717          	auipc	a4,0x21
    80006a08:	a7c70713          	addi	a4,a4,-1412 # 80027480 <cons>
    80006a0c:	0a072783          	lw	a5,160(a4)
    80006a10:	09872703          	lw	a4,152(a4)
    80006a14:	9f99                	subw	a5,a5,a4
    80006a16:	07f00713          	li	a4,127
    80006a1a:	fcf763e3          	bltu	a4,a5,800069e0 <consoleintr+0x3c>
      c = (c == '\r') ? '\n' : c;
    80006a1e:	47b5                	li	a5,13
    80006a20:	0cf48763          	beq	s1,a5,80006aee <consoleintr+0x14a>
      consputc(c);
    80006a24:	8526                	mv	a0,s1
    80006a26:	00000097          	auipc	ra,0x0
    80006a2a:	f3c080e7          	jalr	-196(ra) # 80006962 <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a2e:	00021797          	auipc	a5,0x21
    80006a32:	a5278793          	addi	a5,a5,-1454 # 80027480 <cons>
    80006a36:	0a07a703          	lw	a4,160(a5)
    80006a3a:	0017069b          	addiw	a3,a4,1
    80006a3e:	0006861b          	sext.w	a2,a3
    80006a42:	0ad7a023          	sw	a3,160(a5)
    80006a46:	07f77713          	andi	a4,a4,127
    80006a4a:	97ba                	add	a5,a5,a4
    80006a4c:	00978c23          	sb	s1,24(a5)
      if(c == '\n' || c == C('D') || cons.e == cons.r+INPUT_BUF){
    80006a50:	47a9                	li	a5,10
    80006a52:	0cf48563          	beq	s1,a5,80006b1c <consoleintr+0x178>
    80006a56:	4791                	li	a5,4
    80006a58:	0cf48263          	beq	s1,a5,80006b1c <consoleintr+0x178>
    80006a5c:	00021797          	auipc	a5,0x21
    80006a60:	abc7a783          	lw	a5,-1348(a5) # 80027518 <cons+0x98>
    80006a64:	0807879b          	addiw	a5,a5,128
    80006a68:	f6f61ce3          	bne	a2,a5,800069e0 <consoleintr+0x3c>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a6c:	863e                	mv	a2,a5
    80006a6e:	a07d                	j	80006b1c <consoleintr+0x178>
    while(cons.e != cons.w &&
    80006a70:	00021717          	auipc	a4,0x21
    80006a74:	a1070713          	addi	a4,a4,-1520 # 80027480 <cons>
    80006a78:	0a072783          	lw	a5,160(a4)
    80006a7c:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a80:	00021497          	auipc	s1,0x21
    80006a84:	a0048493          	addi	s1,s1,-1536 # 80027480 <cons>
    while(cons.e != cons.w &&
    80006a88:	4929                	li	s2,10
    80006a8a:	f4f70be3          	beq	a4,a5,800069e0 <consoleintr+0x3c>
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a8e:	37fd                	addiw	a5,a5,-1
    80006a90:	07f7f713          	andi	a4,a5,127
    80006a94:	9726                	add	a4,a4,s1
    while(cons.e != cons.w &&
    80006a96:	01874703          	lbu	a4,24(a4)
    80006a9a:	f52703e3          	beq	a4,s2,800069e0 <consoleintr+0x3c>
      cons.e--;
    80006a9e:	0af4a023          	sw	a5,160(s1)
      consputc(BACKSPACE);
    80006aa2:	10000513          	li	a0,256
    80006aa6:	00000097          	auipc	ra,0x0
    80006aaa:	ebc080e7          	jalr	-324(ra) # 80006962 <consputc>
    while(cons.e != cons.w &&
    80006aae:	0a04a783          	lw	a5,160(s1)
    80006ab2:	09c4a703          	lw	a4,156(s1)
    80006ab6:	fcf71ce3          	bne	a4,a5,80006a8e <consoleintr+0xea>
    80006aba:	b71d                	j	800069e0 <consoleintr+0x3c>
    if(cons.e != cons.w){
    80006abc:	00021717          	auipc	a4,0x21
    80006ac0:	9c470713          	addi	a4,a4,-1596 # 80027480 <cons>
    80006ac4:	0a072783          	lw	a5,160(a4)
    80006ac8:	09c72703          	lw	a4,156(a4)
    80006acc:	f0f70ae3          	beq	a4,a5,800069e0 <consoleintr+0x3c>
      cons.e--;
    80006ad0:	37fd                	addiw	a5,a5,-1
    80006ad2:	00021717          	auipc	a4,0x21
    80006ad6:	a4f72723          	sw	a5,-1458(a4) # 80027520 <cons+0xa0>
      consputc(BACKSPACE);
    80006ada:	10000513          	li	a0,256
    80006ade:	00000097          	auipc	ra,0x0
    80006ae2:	e84080e7          	jalr	-380(ra) # 80006962 <consputc>
    80006ae6:	bded                	j	800069e0 <consoleintr+0x3c>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    80006ae8:	ee048ce3          	beqz	s1,800069e0 <consoleintr+0x3c>
    80006aec:	bf21                	j	80006a04 <consoleintr+0x60>
      consputc(c);
    80006aee:	4529                	li	a0,10
    80006af0:	00000097          	auipc	ra,0x0
    80006af4:	e72080e7          	jalr	-398(ra) # 80006962 <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006af8:	00021797          	auipc	a5,0x21
    80006afc:	98878793          	addi	a5,a5,-1656 # 80027480 <cons>
    80006b00:	0a07a703          	lw	a4,160(a5)
    80006b04:	0017069b          	addiw	a3,a4,1
    80006b08:	0006861b          	sext.w	a2,a3
    80006b0c:	0ad7a023          	sw	a3,160(a5)
    80006b10:	07f77713          	andi	a4,a4,127
    80006b14:	97ba                	add	a5,a5,a4
    80006b16:	4729                	li	a4,10
    80006b18:	00e78c23          	sb	a4,24(a5)
        cons.w = cons.e;
    80006b1c:	00021797          	auipc	a5,0x21
    80006b20:	a0c7a023          	sw	a2,-1536(a5) # 8002751c <cons+0x9c>
        wakeup(&cons.r);
    80006b24:	00021517          	auipc	a0,0x21
    80006b28:	9f450513          	addi	a0,a0,-1548 # 80027518 <cons+0x98>
    80006b2c:	ffffb097          	auipc	ra,0xffffb
    80006b30:	bbc080e7          	jalr	-1092(ra) # 800016e8 <wakeup>
    80006b34:	b575                	j	800069e0 <consoleintr+0x3c>

0000000080006b36 <consoleinit>:
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    80006b3e:	00003597          	auipc	a1,0x3
    80006b42:	d0a58593          	addi	a1,a1,-758 # 80009848 <syscalls+0x470>
    80006b46:	00021517          	auipc	a0,0x21
    80006b4a:	93a50513          	addi	a0,a0,-1734 # 80027480 <cons>
    80006b4e:	00000097          	auipc	ra,0x0
    80006b52:	590080e7          	jalr	1424(ra) # 800070de <initlock>

  uartinit();
    80006b56:	00000097          	auipc	ra,0x0
    80006b5a:	330080e7          	jalr	816(ra) # 80006e86 <uartinit>

  // connect read and write system calls
  // to consoleread and consolewrite.
  devsw[CONSOLE].read = consoleread;
    80006b5e:	00013797          	auipc	a5,0x13
    80006b62:	58a78793          	addi	a5,a5,1418 # 8001a0e8 <devsw>
    80006b66:	00000717          	auipc	a4,0x0
    80006b6a:	ce470713          	addi	a4,a4,-796 # 8000684a <consoleread>
    80006b6e:	eb98                	sd	a4,16(a5)
  devsw[CONSOLE].write = consolewrite;
    80006b70:	00000717          	auipc	a4,0x0
    80006b74:	c7870713          	addi	a4,a4,-904 # 800067e8 <consolewrite>
    80006b78:	ef98                	sd	a4,24(a5)
}
...
{
    80006b82:	7179                	addi	sp,sp,-48
    80006b84:	f406                	sd	ra,40(sp)
    80006b86:	f022                	sd	s0,32(sp)
    80006b88:	ec26                	sd	s1,24(sp)
    80006b8a:	e84a                	sd	s2,16(sp)
    80006b8c:	1800                	addi	s0,sp,48
  char buf[16];
  int i;
  uint x;

  if(sign && (sign = xx < 0))
    80006b8e:	c219                	beqz	a2,80006b94 <printint+0x12>
    80006b90:	08054663          	bltz	a0,80006c1c <printint+0x9a>
    x = -xx;
  else
    x = xx;
    80006b94:	2501                	sext.w	a0,a0
    80006b96:	4881                	li	a7,0
    80006b98:	fd040693          	addi	a3,s0,-48

  i = 0;
    80006b9c:	4701                	li	a4,0
  do {
    buf[i++] = digits[x % base];
    80006b9e:	2581                	sext.w	a1,a1
    80006ba0:	00003617          	auipc	a2,0x3
    80006ba4:	cd860613          	addi	a2,a2,-808 # 80009878 <digits>
    80006ba8:	883a                	mv	a6,a4
    80006baa:	2705                	addiw	a4,a4,1
    80006bac:	02b577bb          	remuw	a5,a0,a1
    80006bb0:	1782                	slli	a5,a5,0x20
    80006bb2:	9381                	srli	a5,a5,0x20
    80006bb4:	97b2                	add	a5,a5,a2
    80006bb6:	0007c783          	lbu	a5,0(a5)
    80006bba:	00f68023          	sb	a5,0(a3)
  } while((x /= base) != 0);
    80006bbe:	0005079b          	sext.w	a5,a0
    80006bc2:	02b5553b          	divuw	a0,a0,a1
    80006bc6:	0685                	addi	a3,a3,1
    80006bc8:	feb7f0e3          	bgeu	a5,a1,80006ba8 <printint+0x26>

  if(sign)
    80006bcc:	00088b63          	beqz	a7,80006be2 <printint+0x60>
    buf[i++] = '-';
    80006bd0:	fe040793          	addi	a5,s0,-32
    80006bd4:	973e                	add	a4,a4,a5
    80006bd6:	02d00793          	li	a5,45
    80006bda:	fef70823          	sb	a5,-16(a4)
    80006bde:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    80006be2:	02e05763          	blez	a4,80006c10 <printint+0x8e>
    80006be6:	fd040793          	addi	a5,s0,-48
    80006bea:	00e784b3          	add	s1,a5,a4
    80006bee:	fff78913          	addi	s2,a5,-1
    80006bf2:	993a                	add	s2,s2,a4
    80006bf4:	377d                	addiw	a4,a4,-1
    80006bf6:	1702                	slli	a4,a4,0x20
    80006bf8:	9301                	srli	a4,a4,0x20
    80006bfa:	40e90933          	sub	s2,s2,a4
    consputc(buf[i]);
    80006bfe:	fff4c503          	lbu	a0,-1(s1)
    80006c02:	00000097          	auipc	ra,0x0
    80006c06:	d60080e7          	jalr	-672(ra) # 80006962 <consputc>
  while(--i >= 0)
    80006c0a:	14fd                	addi	s1,s1,-1
    80006c0c:	ff2499e3          	bne	s1,s2,80006bfe <printint+0x7c>
}
    80006c10:	70a2                	ld	ra,40(sp)
    80006c12:	7402                	ld	s0,32(sp)
    80006c14:	64e2                	ld	s1,24(sp)
    80006c16:	6942                	ld	s2,16(sp)
    80006c18:	6145                	addi	sp,sp,48
    80006c1a:	8082                	ret
    x = -xx;
    80006c1c:	40a0053b          	negw	a0,a0
  if(sign && (sign = xx < 0))
    80006c20:	4885                	li	a7,1
    x = -xx;
    80006c22:	bf9d                	j	80006b98 <printint+0x16>

0000000080006c24 <panic>:
    release(&pr.lock);
}
...
panic(char *s)
{
  ...
  pr.locking = 0;
    80006c30:	00021797          	auipc	a5,0x21
    80006c34:	9007a823          	sw	zero,-1776(a5) # 80027540 <pr+0x18>
  printf("panic: ");
    80006c38:	00003517          	auipc	a0,0x3
    80006c3c:	c1850513          	addi	a0,a0,-1000 # 80009850 <syscalls+0x478>
    80006c40:	00000097          	auipc	ra,0x0
    80006c44:	02e080e7          	jalr	46(ra) # 80006c6e <printf>
  printf(s);
    80006c48:	8526                	mv	a0,s1
    80006c4a:	00000097          	auipc	ra,0x0
    80006c4e:	024080e7          	jalr	36(ra) # 80006c6e <printf>
  printf("\n");
    80006c52:	00002517          	auipc	a0,0x2
    80006c56:	3f650513          	addi	a0,a0,1014 # 80009048 <etext+0x48>
    80006c5a:	00000097          	auipc	ra,0x0
    80006c5e:	014080e7          	jalr	20(ra) # 80006c6e <printf>
  panicked = 1; // freeze uart output from other CPUs
    80006c62:	4785                	li	a5,1
    80006c64:	00003717          	auipc	a4,0x3
    80006c68:	3cf72623          	sw	a5,972(a4) # 8000a030 <panicked>
  for(;;)
    80006c6c:	a001                	j	80006c6c <panic+0x48>

0000000080006c6e <printf>:
{
    80006c6e:	7131                	addi	sp,sp,-192
    80006c70:	fc86                	sd	ra,120(sp)
    80006c72:	f8a2                	sd	s0,112(sp)
    80006c74:	f4a6                	sd	s1,104(sp)
    80006c76:	f0ca                	sd	s2,96(sp)
    80006c78:	ecce                	sd	s3,88(sp)
    80006c7a:	e8d2                	sd	s4,80(sp)
    80006c7c:	e4d6                	sd	s5,72(sp)
    80006c7e:	e0da                	sd	s6,64(sp)
    80006c80:	fc5e                	sd	s7,56(sp)
    80006c82:	f862                	sd	s8,48(sp)
    80006c84:	f466                	sd	s9,40(sp)
    80006c86:	f06a                	sd	s10,32(sp)
    80006c88:	ec6e                	sd	s11,24(sp)
    80006c8a:	0100                	addi	s0,sp,128
    80006c8c:	8a2a                	mv	s4,a0
    80006c8e:	e40c                	sd	a1,8(s0)
    80006c90:	e810                	sd	a2,16(s0)
    80006c92:	ec14                	sd	a3,24(s0)
    80006c94:	f018                	sd	a4,32(s0)
    80006c96:	f41c                	sd	a5,40(s0)
    80006c98:	03043823          	sd	a6,48(s0)
    80006c9c:	03143c23          	sd	a7,56(s0)
  locking = pr.locking;
    80006ca0:	00021d97          	auipc	s11,0x21
    80006ca4:	8a0dad83          	lw	s11,-1888(s11) # 80027540 <pr+0x18>
  if(locking)
    80006ca8:	020d9b63          	bnez	s11,80006cde <printf+0x70>
  if (fmt == 0)
    80006cac:	040a0263          	beqz	s4,80006cf0 <printf+0x82>
  va_start(ap, fmt);
    80006cb0:	00840793          	addi	a5,s0,8
    80006cb4:	f8f43423          	sd	a5,-120(s0)
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006cb8:	000a4503          	lbu	a0,0(s4) # 2000 <_entry-0x7fffe000>
    80006cbc:	16050263          	beqz	a0,80006e20 <printf+0x1b2>
    80006cc0:	4481                	li	s1,0
    if(c != '%'){
    80006cc2:	02500a93          	li	s5,37
    switch(c){
    80006cc6:	07000b13          	li	s6,112
  consputc('x');
    80006cca:	4d41                	li	s10,16
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006ccc:	00003b97          	auipc	s7,0x3
    80006cd0:	bacb8b93          	addi	s7,s7,-1108 # 80009878 <digits>
    switch(c){
    80006cd4:	07300c93          	li	s9,115
    80006cd8:	06400c13          	li	s8,100
    80006cdc:	a82d                	j	80006d16 <printf+0xa8>
    acquire(&pr.lock);
    80006cde:	00021517          	auipc	a0,0x21
    80006ce2:	84a50513          	addi	a0,a0,-1974 # 80027528 <pr>
    80006ce6:	00000097          	auipc	ra,0x0
    80006cea:	488080e7          	jalr	1160(ra) # 8000716e <acquire>
    80006cee:	bf7d                	j	80006cac <printf+0x3e>
    panic("null fmt");
    80006cf0:	00003517          	auipc	a0,0x3
    80006cf4:	b7050513          	addi	a0,a0,-1168 # 80009860 <syscalls+0x488>
    80006cf8:	00000097          	auipc	ra,0x0
    80006cfc:	f2c080e7          	jalr	-212(ra) # 80006c24 <panic>
      consputc(c);
    80006d00:	00000097          	auipc	ra,0x0
    80006d04:	c62080e7          	jalr	-926(ra) # 80006962 <consputc>
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006d08:	2485                	addiw	s1,s1,1
    80006d0a:	009a07b3          	add	a5,s4,s1
    80006d0e:	0007c503          	lbu	a0,0(a5)
    80006d12:	10050763          	beqz	a0,80006e20 <printf+0x1b2>
    if(c != '%'){
    80006d16:	ff5515e3          	bne	a0,s5,80006d00 <printf+0x92>
    c = fmt[++i] & 0xff;
    80006d1a:	2485                	addiw	s1,s1,1
    80006d1c:	009a07b3          	add	a5,s4,s1
    80006d20:	0007c783          	lbu	a5,0(a5)
    80006d24:	0007891b          	sext.w	s2,a5
    if(c == 0)
    80006d28:	cfe5                	beqz	a5,80006e20 <printf+0x1b2>
    switch(c){
    80006d2a:	05678a63          	beq	a5,s6,80006d7e <printf+0x110>
    80006d2e:	02fb7663          	bgeu	s6,a5,80006d5a <printf+0xec>
    80006d32:	09978963          	beq	a5,s9,80006dc4 <printf+0x156>
    80006d36:	07800713          	li	a4,120
    80006d3a:	0ce79863          	bne	a5,a4,80006e0a <printf+0x19c>
      printint(va_arg(ap, int), 16, 1);
    80006d3e:	f8843783          	ld	a5,-120(s0)
    80006d42:	00878713          	addi	a4,a5,8
    80006d46:	f8e43423          	sd	a4,-120(s0)
    80006d4a:	4605                	li	a2,1
    80006d4c:	85ea                	mv	a1,s10
    80006d4e:	4388                	lw	a0,0(a5)
    80006d50:	00000097          	auipc	ra,0x0
    80006d54:	e32080e7          	jalr	-462(ra) # 80006b82 <printint>
      break;
    80006d58:	bf45                	j	80006d08 <printf+0x9a>
    switch(c){
    80006d5a:	0b578263          	beq	a5,s5,80006dfe <printf+0x190>
    80006d5e:	0b879663          	bne	a5,s8,80006e0a <printf+0x19c>
      printint(va_arg(ap, int), 10, 1);
    80006d62:	f8843783          	ld	a5,-120(s0)
    80006d66:	00878713          	addi	a4,a5,8
    80006d6a:	f8e43423          	sd	a4,-120(s0)
    80006d6e:	4605                	li	a2,1
    80006d70:	45a9                	li	a1,10
    80006d72:	4388                	lw	a0,0(a5)
    80006d74:	00000097          	auipc	ra,0x0
    80006d78:	e0e080e7          	jalr	-498(ra) # 80006b82 <printint>
      break;
    80006d7c:	b771                	j	80006d08 <printf+0x9a>
      printptr(va_arg(ap, uint64));
    80006d7e:	f8843783          	ld	a5,-120(s0)
    80006d82:	00878713          	addi	a4,a5,8
    80006d86:	f8e43423          	sd	a4,-120(s0)
    80006d8a:	0007b983          	ld	s3,0(a5)
  consputc('0');
    80006d8e:	03000513          	li	a0,48
    80006d92:	00000097          	auipc	ra,0x0
    80006d96:	bd0080e7          	jalr	-1072(ra) # 80006962 <consputc>
  consputc('x');
    80006d9a:	07800513          	li	a0,120
    80006d9e:	00000097          	auipc	ra,0x0
    80006da2:	bc4080e7          	jalr	-1084(ra) # 80006962 <consputc>
    80006da6:	896a                	mv	s2,s10
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006da8:	03c9d793          	srli	a5,s3,0x3c
    80006dac:	97de                	add	a5,a5,s7
    80006dae:	0007c503          	lbu	a0,0(a5)
    80006db2:	00000097          	auipc	ra,0x0
    80006db6:	bb0080e7          	jalr	-1104(ra) # 80006962 <consputc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    80006dba:	0992                	slli	s3,s3,0x4
    80006dbc:	397d                	addiw	s2,s2,-1
    80006dbe:	fe0915e3          	bnez	s2,80006da8 <printf+0x13a>
    80006dc2:	b799                	j	80006d08 <printf+0x9a>
      if((s = va_arg(ap, char*)) == 0)
    80006dc4:	f8843783          	ld	a5,-120(s0)
    80006dc8:	00878713          	addi	a4,a5,8
    80006dcc:	f8e43423          	sd	a4,-120(s0)
    80006dd0:	0007b903          	ld	s2,0(a5)
    80006dd4:	00090e63          	beqz	s2,80006df0 <printf+0x182>
      for(; *s; s++)
    80006dd8:	00094503          	lbu	a0,0(s2)
    80006ddc:	d515                	beqz	a0,80006d08 <printf+0x9a>
        consputc(*s);
    80006dde:	00000097          	auipc	ra,0x0
    80006de2:	b84080e7          	jalr	-1148(ra) # 80006962 <consputc>
      for(; *s; s++)
    80006de6:	0905                	addi	s2,s2,1
    80006de8:	00094503          	lbu	a0,0(s2)
    80006dec:	f96d                	bnez	a0,80006dde <printf+0x170>
    80006dee:	bf29                	j	80006d08 <printf+0x9a>
        s = "(null)";
    80006df0:	00003917          	auipc	s2,0x3
    80006df4:	a6890913          	addi	s2,s2,-1432 # 80009858 <syscalls+0x480>
      for(; *s; s++)
    80006df8:	02800513          	li	a0,40
    80006dfc:	b7cd                	j	80006dde <printf+0x170>
      consputc('%');
    80006dfe:	8556                	mv	a0,s5
    80006e00:	00000097          	auipc	ra,0x0
    80006e04:	b62080e7          	jalr	-1182(ra) # 80006962 <consputc>
      break;
    80006e08:	b701                	j	80006d08 <printf+0x9a>
      consputc('%');
    80006e0a:	8556                	mv	a0,s5
    80006e0c:	00000097          	auipc	ra,0x0
    80006e10:	b56080e7          	jalr	-1194(ra) # 80006962 <consputc>
      consputc(c);
    80006e14:	854a                	mv	a0,s2
    80006e16:	00000097          	auipc	ra,0x0
    80006e1a:	b4c080e7          	jalr	-1204(ra) # 80006962 <consputc>
      break;
    80006e1e:	b5ed                	j	80006d08 <printf+0x9a>
  if(locking)
    80006e20:	020d9163          	bnez	s11,80006e42 <printf+0x1d4>
}
    80006e24:	70e6                	ld	ra,120(sp)
    80006e26:	7446                	ld	s0,112(sp)
    80006e28:	74a6                	ld	s1,104(sp)
    80006e2a:	7906                	ld	s2,96(sp)
    80006e2c:	69e6                	ld	s3,88(sp)
    80006e2e:	6a46                	ld	s4,80(sp)
    80006e30:	6aa6                	ld	s5,72(sp)
    80006e32:	6b06                	ld	s6,64(sp)
    80006e34:	7be2                	ld	s7,56(sp)
    80006e36:	7c42                	ld	s8,48(sp)
    80006e38:	7ca2                	ld	s9,40(sp)
    80006e3a:	7d02                	ld	s10,32(sp)
    80006e3c:	6de2                	ld	s11,24(sp)
    80006e3e:	6129                	addi	sp,sp,192
    80006e40:	8082                	ret
    release(&pr.lock);
    80006e42:	00020517          	auipc	a0,0x20
    80006e46:	6e650513          	addi	a0,a0,1766 # 80027528 <pr>
    80006e4a:	00000097          	auipc	ra,0x0
    80006e4e:	3d8080e7          	jalr	984(ra) # 80007222 <release>
}
    80006e52:	bfc9                	j	80006e24 <printf+0x1b6>

0000000080006e54 <printfinit>:
    ;
}
...
printfinit(void)
{
    80006e54:	1101                	addi	sp,sp,-32
    80006e56:	ec06                	sd	ra,24(sp)
    80006e58:	e822                	sd	s0,16(sp)
    80006e5a:	e426                	sd	s1,8(sp)
    80006e5c:	1000                	addi	s0,sp,32
  initlock(&pr.lock, "pr");
    80006e5e:	00020497          	auipc	s1,0x20
    80006e62:	6ca48493          	addi	s1,s1,1738 # 80027528 <pr>
    80006e66:	00003597          	auipc	a1,0x3
    80006e6a:	a0a58593          	addi	a1,a1,-1526 # 80009870 <syscalls+0x498>
    80006e6e:	8526                	mv	a0,s1
    80006e70:	00000097          	auipc	ra,0x0
    80006e74:	26e080e7          	jalr	622(ra) # 800070de <initlock>
  pr.locking = 1;
    80006e78:	4785                	li	a5,1
    80006e7a:	cc9c                	sw	a5,24(s1)
}
...
uartinit(void)
{
    ...
    80006e88:	e406                	sd	ra,8(sp)
    80006e8a:	e022                	sd	s0,0(sp)
    80006e8c:	0800                	addi	s0,sp,16
  // disable interrupts.
  WriteReg(IER, 0x00);
    80006e8e:	100007b7          	lui	a5,0x10000
    80006e92:	000780a3          	sb	zero,1(a5) # 10000001 <_entry-0x6fffffff>

  // special mode to set baud rate.
  WriteReg(LCR, LCR_BAUD_LATCH);
    80006e96:	f8000713          	li	a4,-128
    80006e9a:	00e781a3          	sb	a4,3(a5)

  // LSB for baud rate of 38.4K.
  WriteReg(0, 0x03);
    80006e9e:	470d                	li	a4,3
    80006ea0:	00e78023          	sb	a4,0(a5)

  // MSB for baud rate of 38.4K.
  WriteReg(1, 0x00);
    80006ea4:	000780a3          	sb	zero,1(a5)

  // leave set-baud mode,
  // and set word length to 8 bits, no parity.
  WriteReg(LCR, LCR_EIGHT_BITS);
    80006ea8:	00e781a3          	sb	a4,3(a5)

  // reset and enable FIFOs.
  WriteReg(FCR, FCR_FIFO_ENABLE | FCR_FIFO_CLEAR);
    80006eac:	469d                	li	a3,7
    80006eae:	00d78123          	sb	a3,2(a5)

  // enable transmit and receive interrupts.
  WriteReg(IER, IER_TX_ENABLE | IER_RX_ENABLE);
    80006eb2:	00e780a3          	sb	a4,1(a5)

  initlock(&uart_tx_lock, "uart");
    80006eb6:	00003597          	auipc	a1,0x3
    80006eba:	9da58593          	addi	a1,a1,-1574 # 80009890 <digits+0x18>
    80006ebe:	00020517          	auipc	a0,0x20
    80006ec2:	68a50513          	addi	a0,a0,1674 # 80027548 <uart_tx_lock>
    80006ec6:	00000097          	auipc	ra,0x0
    80006eca:	218080e7          	jalr	536(ra) # 800070de <initlock>
}
    80006ece:	60a2                	ld	ra,8(sp)
    80006ed0:	6402                	ld	s0,0(sp)
    80006ed2:	0141                	addi	sp,sp,16
    80006ed4:	8082                	ret

0000000080006ed6 <uartputc_sync>:
...
uartputc_sync(int c)
{
    ...
    80006ee0:	84aa                	mv	s1,a0
  push_off();
    80006ee2:	00000097          	auipc	ra,0x0
    80006ee6:	240080e7          	jalr	576(ra) # 80007122 <push_off>

  if(panicked){
    80006eea:	00003797          	auipc	a5,0x3
    80006eee:	1467a783          	lw	a5,326(a5) # 8000a030 <panicked>
    for(;;)
      ;
  }
  ...
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006ef2:	10000737          	lui	a4,0x10000
  if(panicked){
    80006ef6:	c391                	beqz	a5,80006efa <uartputc_sync+0x24>
    for(;;)
    80006ef8:	a001                	j	80006ef8 <uartputc_sync+0x22>
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006efa:	00574783          	lbu	a5,5(a4) # 10000005 <_entry-0x6ffffffb>
    80006efe:	0ff7f793          	andi	a5,a5,255
    80006f02:	0207f793          	andi	a5,a5,32
    80006f06:	dbf5                	beqz	a5,80006efa <uartputc_sync+0x24>
    ;
  WriteReg(THR, c);
    80006f08:	0ff4f793          	andi	a5,s1,255
    80006f0c:	10000737          	lui	a4,0x10000
    80006f10:	00f70023          	sb	a5,0(a4) # 10000000 <_entry-0x70000000>

  pop_off();
    80006f14:	00000097          	auipc	ra,0x0
    80006f18:	2ae080e7          	jalr	686(ra) # 800071c2 <pop_off>
}
    80006f1c:	60e2                	ld	ra,24(sp)
    80006f1e:	6442                	ld	s0,16(sp)
    80006f20:	64a2                	ld	s1,8(sp)
    80006f22:	6105                	addi	sp,sp,32
    80006f24:	8082                	ret

0000000080006f26 <uartstart>:
...
uartstart()
{
  while(1){
    ...
    80006f26:	00003717          	auipc	a4,0x3
    80006f2a:	11273703          	ld	a4,274(a4) # 8000a038 <uart_tx_r>
    80006f2e:	00003797          	auipc	a5,0x3
    80006f32:	1127b783          	ld	a5,274(a5) # 8000a040 <uart_tx_w>
    80006f36:	06e78c63          	beq	a5,a4,80006fae <uartstart+0x88>
{
    80006f3a:	7139                	addi	sp,sp,-64
    80006f3c:	fc06                	sd	ra,56(sp)
    80006f3e:	f822                	sd	s0,48(sp)
    80006f40:	f426                	sd	s1,40(sp)
    80006f42:	f04a                	sd	s2,32(sp)
    80006f44:	ec4e                	sd	s3,24(sp)
    80006f46:	e852                	sd	s4,16(sp)
    80006f48:	e456                	sd	s5,8(sp)
    ...
    80006f4c:	10000937          	lui	s2,0x10000
    ...
    80006f50:	00020a17          	auipc	s4,0x20
    80006f54:	5f8a0a13          	addi	s4,s4,1528 # 80027548 <uart_tx_lock>
    uart_tx_r += 1;
    80006f58:	00003497          	auipc	s1,0x3
    80006f5c:	0e048493          	addi	s1,s1,224 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    80006f60:	00003997          	auipc	s3,0x3
    80006f64:	0e098993          	addi	s3,s3,224 # 8000a040 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006f68:	00594783          	lbu	a5,5(s2) # 10000005 <_entry-0x6ffffffb>
    80006f6c:	0ff7f793          	andi	a5,a5,255
    80006f70:	0207f793          	andi	a5,a5,32
    80006f74:	c785                	beqz	a5,80006f9c <uartstart+0x76>
    int c = uart_tx_buf[uart_tx_r % UART_TX_BUF_SIZE];
    80006f76:	01f77793          	andi	a5,a4,31
    80006f7a:	97d2                	add	a5,a5,s4
    80006f7c:	0187ca83          	lbu	s5,24(a5)
    uart_tx_r += 1;
    80006f80:	0705                	addi	a4,a4,1
    80006f82:	e098                	sd	a4,0(s1)
    
    // maybe uartputc() is waiting for space in the buffer.
    wakeup(&uart_tx_r);
    80006f84:	8526                	mv	a0,s1
    80006f86:	ffffa097          	auipc	ra,0xffffa
    80006f8a:	762080e7          	jalr	1890(ra) # 800016e8 <wakeup>
    
    WriteReg(THR, c);
    80006f8e:	01590023          	sb	s5,0(s2)
    if(uart_tx_w == uart_tx_r){
    80006f92:	6098                	ld	a4,0(s1)
    80006f94:	0009b783          	ld	a5,0(s3)
    80006f98:	fce798e3          	bne	a5,a4,80006f68 <uartstart+0x42>
  }
}
    80006f9c:	70e2                	ld	ra,56(sp)
    80006f9e:	7442                	ld	s0,48(sp)
    80006fa0:	74a2                	ld	s1,40(sp)
    80006fa2:	7902                	ld	s2,32(sp)
    80006fa4:	69e2                	ld	s3,24(sp)
    80006fa6:	6a42                	ld	s4,16(sp)
    80006fa8:	6aa2                	ld	s5,8(sp)
    80006faa:	6121                	addi	sp,sp,64
    80006fac:	8082                	ret
    80006fae:	8082                	ret

0000000080006fb0 <uartputc>:
{
    80006fb0:	7179                	addi	sp,sp,-48
    80006fb2:	f406                	sd	ra,40(sp)
    80006fb4:	f022                	sd	s0,32(sp)
    80006fb6:	ec26                	sd	s1,24(sp)
    80006fb8:	e84a                	sd	s2,16(sp)
    80006fba:	e44e                	sd	s3,8(sp)
    80006fbc:	e052                	sd	s4,0(sp)
    80006fbe:	1800                	addi	s0,sp,48
    80006fc0:	89aa                	mv	s3,a0
  acquire(&uart_tx_lock);
    80006fc2:	00020517          	auipc	a0,0x20
    80006fc6:	58650513          	addi	a0,a0,1414 # 80027548 <uart_tx_lock>
    80006fca:	00000097          	auipc	ra,0x0
    80006fce:	1a4080e7          	jalr	420(ra) # 8000716e <acquire>
  if(panicked){
    80006fd2:	00003797          	auipc	a5,0x3
    80006fd6:	05e7a783          	lw	a5,94(a5) # 8000a030 <panicked>
    80006fda:	c391                	beqz	a5,80006fde <uartputc+0x2e>
    for(;;)
    80006fdc:	a001                	j	80006fdc <uartputc+0x2c>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006fde:	00003797          	auipc	a5,0x3
    80006fe2:	0627b783          	ld	a5,98(a5) # 8000a040 <uart_tx_w>
    80006fe6:	00003717          	auipc	a4,0x3
    80006fea:	05273703          	ld	a4,82(a4) # 8000a038 <uart_tx_r>
    80006fee:	02070713          	addi	a4,a4,32
    80006ff2:	02f71b63          	bne	a4,a5,80007028 <uartputc+0x78>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006ff6:	00020a17          	auipc	s4,0x20
    80006ffa:	552a0a13          	addi	s4,s4,1362 # 80027548 <uart_tx_lock>
    80006ffe:	00003497          	auipc	s1,0x3
    80007002:	03a48493          	addi	s1,s1,58 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80007006:	00003917          	auipc	s2,0x3
    8000700a:	03a90913          	addi	s2,s2,58 # 8000a040 <uart_tx_w>
      sleep(&uart_tx_r, &uart_tx_lock);
    8000700e:	85d2                	mv	a1,s4
    80007010:	8526                	mv	a0,s1
    80007012:	ffffa097          	auipc	ra,0xffffa
    80007016:	54a080e7          	jalr	1354(ra) # 8000155c <sleep>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    8000701a:	00093783          	ld	a5,0(s2)
    8000701e:	6098                	ld	a4,0(s1)
    80007020:	02070713          	addi	a4,a4,32
    80007024:	fef705e3          	beq	a4,a5,8000700e <uartputc+0x5e>
      uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    80007028:	00020497          	auipc	s1,0x20
    8000702c:	52048493          	addi	s1,s1,1312 # 80027548 <uart_tx_lock>
    80007030:	01f7f713          	andi	a4,a5,31
    80007034:	9726                	add	a4,a4,s1
    80007036:	01370c23          	sb	s3,24(a4)
      uart_tx_w += 1;
    8000703a:	0785                	addi	a5,a5,1
    8000703c:	00003717          	auipc	a4,0x3
    80007040:	00f73223          	sd	a5,4(a4) # 8000a040 <uart_tx_w>
      uartstart();
    80007044:	00000097          	auipc	ra,0x0
    80007048:	ee2080e7          	jalr	-286(ra) # 80006f26 <uartstart>
      release(&uart_tx_lock);
    8000704c:	8526                	mv	a0,s1
    8000704e:	00000097          	auipc	ra,0x0
    80007052:	1d4080e7          	jalr	468(ra) # 80007222 <release>
}
    80007056:	70a2                	ld	ra,40(sp)
    80007058:	7402                	ld	s0,32(sp)
    8000705a:	64e2                	ld	s1,24(sp)
    8000705c:	6942                	ld	s2,16(sp)
    8000705e:	69a2                	ld	s3,8(sp)
    80007060:	6a02                	ld	s4,0(sp)
    80007062:	6145                	addi	sp,sp,48
    80007064:	8082                	ret

0000000080007066 <uartgetc>:
...
uartgetc(void)
{
  ...
  if(ReadReg(LSR) & 0x01){
    ...
    80007070:	0057c783          	lbu	a5,5(a5) # 10000005 <_entry-0x6ffffffb>
    80007074:	8b85                	andi	a5,a5,1
    80007076:	cb91                	beqz	a5,8000708a <uartgetc+0x24>
    // input data is ready.
    return ReadReg(RHR);
    80007078:	100007b7          	lui	a5,0x10000
    8000707c:	0007c503          	lbu	a0,0(a5) # 10000000 <_entry-0x70000000>
    80007080:	0ff57513          	andi	a0,a0,255
  } else {
    return -1;
  }
}
    80007084:	6422                	ld	s0,8(sp)
    80007086:	0141                	addi	sp,sp,16
    80007088:	8082                	ret
    return -1;
    8000708a:	557d                	li	a0,-1
    8000708c:	bfe5                	j	80007084 <uartgetc+0x1e>

000000008000708e <uartintr>:
...
uartintr(void)
{
  ...
  while(1){
    int c = uartgetc();
    if(c == -1)
    80007098:	54fd                	li	s1,-1
    int c = uartgetc();
    8000709a:	00000097          	auipc	ra,0x0
    8000709e:	fcc080e7          	jalr	-52(ra) # 80007066 <uartgetc>
    if(c == -1)
    800070a2:	00950763          	beq	a0,s1,800070b0 <uartintr+0x22>
      break;
    consoleintr(c);
    800070a6:	00000097          	auipc	ra,0x0
    800070aa:	8fe080e7          	jalr	-1794(ra) # 800069a4 <consoleintr>
  while(1){
    800070ae:	b7f5                	j	8000709a <uartintr+0xc>
  }

  // send buffered characters.
  acquire(&uart_tx_lock);
    800070b0:	00020497          	auipc	s1,0x20
    800070b4:	49848493          	addi	s1,s1,1176 # 80027548 <uart_tx_lock>
    800070b8:	8526                	mv	a0,s1
    800070ba:	00000097          	auipc	ra,0x0
    800070be:	0b4080e7          	jalr	180(ra) # 8000716e <acquire>
  uartstart();
    800070c2:	00000097          	auipc	ra,0x0
    800070c6:	e64080e7          	jalr	-412(ra) # 80006f26 <uartstart>
  release(&uart_tx_lock);
    800070ca:	8526                	mv	a0,s1
    800070cc:	00000097          	auipc	ra,0x0
    800070d0:	156080e7          	jalr	342(ra) # 80007222 <release>
}
    800070d4:	60e2                	ld	ra,24(sp)
    800070d6:	6442                	ld	s0,16(sp)
    800070d8:	64a2                	ld	s1,8(sp)
    800070da:	6105                	addi	sp,sp,32
    800070dc:	8082                	ret

00000000800070de <initlock>:
}
#endif
...
{
    800070de:	1141                	addi	sp,sp,-16
    800070e0:	e422                	sd	s0,8(sp)
    800070e2:	0800                	addi	s0,sp,16
  lk->name = name;
    800070e4:	e50c                	sd	a1,8(a0)
  lk->locked = 0;
    800070e6:	00052023          	sw	zero,0(a0)
  lk->cpu = 0;
    800070ea:	00053823          	sd	zero,16(a0)
#ifdef LAB_LOCK
  lk->nts = 0;
  lk->n = 0;
  findslot(lk);
    ...
    800070ee:	6422                	ld	s0,8(sp)
    800070f0:	0141                	addi	sp,sp,16
    800070f2:	8082                	ret

00000000800070f4 <holding>:
...
holding(struct spinlock *lk)
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    800070f4:	411c                	lw	a5,0(a0)
    800070f6:	e399                	bnez	a5,800070fc <holding+0x8>
    800070f8:	4501                	li	a0,0
  return r;
}
    800070fa:	8082                	ret
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    80007106:	6904                	ld	s1,16(a0)
    80007108:	ffffa097          	auipc	ra,0xffffa
    8000710c:	d7c080e7          	jalr	-644(ra) # 80000e84 <mycpu>
    80007110:	40a48533          	sub	a0,s1,a0
    80007114:	00153513          	seqz	a0,a0
}
    80007118:	60e2                	ld	ra,24(sp)
    8000711a:	6442                	ld	s0,16(sp)
    8000711c:	64a2                	ld	s1,8(sp)
    8000711e:	6105                	addi	sp,sp,32
    80007120:	8082                	ret

0000000080007122 <push_off>:
...
push_off(void)
{
    80007122:	1101                	addi	sp,sp,-32
    80007124:	ec06                	sd	ra,24(sp)
    80007126:	e822                	sd	s0,16(sp)
    80007128:	e426                	sd	s1,8(sp)
    8000712a:	1000                	addi	s0,sp,32
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    8000712c:	100024f3          	csrr	s1,sstatus
    80007130:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() & ~SSTATUS_SIE);
    80007134:	9bf5                	andi	a5,a5,-3
  asm volatile("csrw sstatus, %0" : : "r" (x));
    80007136:	10079073          	csrw	sstatus,a5
  int old = intr_get();

  intr_off();
  if(mycpu()->noff == 0)
    8000713a:	ffffa097          	auipc	ra,0xffffa
    8000713e:	d4a080e7          	jalr	-694(ra) # 80000e84 <mycpu>
    80007142:	5d3c                	lw	a5,120(a0)
    80007144:	cf89                	beqz	a5,8000715e <push_off+0x3c>
    mycpu()->intena = old;
  mycpu()->noff += 1;
    80007146:	ffffa097          	auipc	ra,0xffffa
    8000714a:	d3e080e7          	jalr	-706(ra) # 80000e84 <mycpu>
    8000714e:	5d3c                	lw	a5,120(a0)
    80007150:	2785                	addiw	a5,a5,1
    80007152:	dd3c                	sw	a5,120(a0)
}
    80007154:	60e2                	ld	ra,24(sp)
    80007156:	6442                	ld	s0,16(sp)
    80007158:	64a2                	ld	s1,8(sp)
    8000715a:	6105                	addi	sp,sp,32
    8000715c:	8082                	ret
    mycpu()->intena = old;
    8000715e:	ffffa097          	auipc	ra,0xffffa
    80007162:	d26080e7          	jalr	-730(ra) # 80000e84 <mycpu>
  return (x & SSTATUS_SIE) != 0;
    80007166:	8085                	srli	s1,s1,0x1
    80007168:	8885                	andi	s1,s1,1
    8000716a:	dd64                	sw	s1,124(a0)
    8000716c:	bfe9                	j	80007146 <push_off+0x24>

000000008000716e <acquire>:
{
    8000716e:	1101                	addi	sp,sp,-32
    80007170:	ec06                	sd	ra,24(sp)
    80007172:	e822                	sd	s0,16(sp)
    80007174:	e426                	sd	s1,8(sp)
    80007176:	1000                	addi	s0,sp,32
    80007178:	84aa                	mv	s1,a0
  push_off(); // disable interrupts to avoid deadlock.
    8000717a:	00000097          	auipc	ra,0x0
    8000717e:	fa8080e7          	jalr	-88(ra) # 80007122 <push_off>
  if(holding(lk))
    80007182:	8526                	mv	a0,s1
    80007184:	00000097          	auipc	ra,0x0
    80007188:	f70080e7          	jalr	-144(ra) # 800070f4 <holding>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    8000718c:	4705                	li	a4,1
  if(holding(lk))
    8000718e:	e115                	bnez	a0,800071b2 <acquire+0x44>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    80007190:	87ba                	mv	a5,a4
    80007192:	0cf4a7af          	amoswap.w.aq	a5,a5,(s1)
    80007196:	2781                	sext.w	a5,a5
    80007198:	ffe5                	bnez	a5,80007190 <acquire+0x22>
  __sync_synchronize();
    8000719a:	0ff0000f          	fence
  lk->cpu = mycpu();
    8000719e:	ffffa097          	auipc	ra,0xffffa
    800071a2:	ce6080e7          	jalr	-794(ra) # 80000e84 <mycpu>
    800071a6:	e888                	sd	a0,16(s1)
}
    800071a8:	60e2                	ld	ra,24(sp)
    800071aa:	6442                	ld	s0,16(sp)
    800071ac:	64a2                	ld	s1,8(sp)
    800071ae:	6105                	addi	sp,sp,32
    800071b0:	8082                	ret
    panic("acquire");
    800071b2:	00002517          	auipc	a0,0x2
    800071b6:	6e650513          	addi	a0,a0,1766 # 80009898 <digits+0x20>
    800071ba:	00000097          	auipc	ra,0x0
    800071be:	a6a080e7          	jalr	-1430(ra) # 80006c24 <panic>

00000000800071c2 <pop_off>:

void
pop_off(void)
{
    800071c2:	1141                	addi	sp,sp,-16
    800071c4:	e406                	sd	ra,8(sp)
    800071c6:	e022                	sd	s0,0(sp)
    800071c8:	0800                	addi	s0,sp,16
  struct cpu *c = mycpu();
    800071ca:	ffffa097          	auipc	ra,0xffffa
    800071ce:	cba080e7          	jalr	-838(ra) # 80000e84 <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800071d2:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    800071d6:	8b89                	andi	a5,a5,2
  if(intr_get())
    800071d8:	e78d                	bnez	a5,80007202 <pop_off+0x40>
    panic("pop_off - interruptible");
  if(c->noff < 1)
    800071da:	5d3c                	lw	a5,120(a0)
    800071dc:	02f05b63          	blez	a5,80007212 <pop_off+0x50>
    panic("pop_off");
  c->noff -= 1;
    800071e0:	37fd                	addiw	a5,a5,-1
    800071e2:	0007871b          	sext.w	a4,a5
    800071e6:	dd3c                	sw	a5,120(a0)
  if(c->noff == 0 && c->intena)
    800071e8:	eb09                	bnez	a4,800071fa <pop_off+0x38>
    800071ea:	5d7c                	lw	a5,124(a0)
    800071ec:	c799                	beqz	a5,800071fa <pop_off+0x38>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800071ee:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() | SSTATUS_SIE);
    800071f2:	0027e793          	ori	a5,a5,2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    800071f6:	10079073          	csrw	sstatus,a5
    intr_on();
}
    800071fa:	60a2                	ld	ra,8(sp)
    800071fc:	6402                	ld	s0,0(sp)
    800071fe:	0141                	addi	sp,sp,16
    80007200:	8082                	ret
    panic("pop_off - interruptible");
    80007202:	00002517          	auipc	a0,0x2
    80007206:	69e50513          	addi	a0,a0,1694 # 800098a0 <digits+0x28>
    8000720a:	00000097          	auipc	ra,0x0
    8000720e:	a1a080e7          	jalr	-1510(ra) # 80006c24 <panic>
    panic("pop_off");
    80007212:	00002517          	auipc	a0,0x2
    80007216:	6a650513          	addi	a0,a0,1702 # 800098b8 <digits+0x40>
    8000721a:	00000097          	auipc	ra,0x0
    8000721e:	a0a080e7          	jalr	-1526(ra) # 80006c24 <panic>

0000000080007222 <release>:
{
    80007222:	1101                	addi	sp,sp,-32
    80007224:	ec06                	sd	ra,24(sp)
    80007226:	e822                	sd	s0,16(sp)
    80007228:	e426                	sd	s1,8(sp)
    8000722a:	1000                	addi	s0,sp,32
    8000722c:	84aa                	mv	s1,a0
  if(!holding(lk))
    8000722e:	00000097          	auipc	ra,0x0
    80007232:	ec6080e7          	jalr	-314(ra) # 800070f4 <holding>
    80007236:	c115                	beqz	a0,8000725a <release+0x38>
  lk->cpu = 0;
    80007238:	0004b823          	sd	zero,16(s1)
  __sync_synchronize();
    8000723c:	0ff0000f          	fence
  __sync_lock_release(&lk->locked);
    80007240:	0f50000f          	fence	iorw,ow
    80007244:	0804a02f          	amoswap.w	zero,zero,(s1)
  pop_off();
    80007248:	00000097          	auipc	ra,0x0
    8000724c:	f7a080e7          	jalr	-134(ra) # 800071c2 <pop_off>
}
    ...
    8000725e:	66650513          	addi	a0,a0,1638 # 800098c0 <digits+0x48>
    80007262:	00000097          	auipc	ra,0x0
    80007266:	9c2080e7          	jalr	-1598(ra) # 80006c24 <panic>

000000008000726a <lockfree_read8>:
...
lockfree_read8(uint64 *addr) {
  ...
  __atomic_load(addr, &val, __ATOMIC_SEQ_CST);
    ...
    80007274:	6108                	ld	a0,0(a0)
    80007276:	0ff0000f          	fence
  return val;
}
...
0000000080007280 <lockfree_read4>:

// Read a shared 32-bit value without holding a lock
int
lockfree_read4(int *addr) {
    80007280:	1141                	addi	sp,sp,-16
    80007282:	e422                	sd	s0,8(sp)
    80007284:	0800                	addi	s0,sp,16
  uint32 val;
  __atomic_load(addr, &val, __ATOMIC_SEQ_CST);
    80007286:	0ff0000f          	fence
    8000728a:	4108                	lw	a0,0(a0)
    8000728c:	0ff0000f          	fence
  return val;
}
    80007290:	2501                	sext.w	a0,a0
    80007292:	6422                	ld	s0,8(sp)
    80007294:	0141                	addi	sp,sp,16
    80007296:	8082                	ret
	...
