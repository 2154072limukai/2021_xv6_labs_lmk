...
if(p->usyscall)
    8000115e:	16853503          	ld	a0,360(a0)
    80001162:	c509                	beqz	a0,8000116c <freeproc+0x1a>
kfree((void*)p->usyscall);
    80001164:	fffff097          	auipc	ra,0xfffff
    80001168:	eb8080e7          	jalr	-328(ra) # 8000001c <kfree>
p->usyscall = 0;
    8000116c:	1604b423          	sd	zero,360(s1)
  if(p->trapframe)
    80001170:	6ca8                	ld	a0,88(s1)
    80001172:	c509                	beqz	a0,8000117c <freeproc+0x2a>
    kfree((void*)p->trapframe);
    80001174:	fffff097          	auipc	ra,0xfffff
    80001178:	ea8080e7          	jalr	-344(ra) # 8000001c <kfree>
  p->trapframe = 0;
    8000117c:	0404bc23          	sd	zero,88(s1)
  if(p->pagetable)
    80001180:	68a8                	ld	a0,80(s1)
    80001182:	c511                	beqz	a0,8000118e <freeproc+0x3c>
    proc_freepagetable(p->pagetable, p->sz);
    80001184:	64ac                	ld	a1,72(s1)
    80001186:	00000097          	auipc	ra,0x0
    8000118a:	f60080e7          	jalr	-160(ra) # 800010e6 <proc_freepagetable>
  p->pagetable = 0;
    8000118e:	0404b823          	sd	zero,80(s1)
  p->sz = 0;
    80001192:	0404b423          	sd	zero,72(s1)
  p->pid = 0;
    80001196:	0204a823          	sw	zero,48(s1)
  p->parent = 0;
    8000119a:	0204bc23          	sd	zero,56(s1)
  p->name[0] = 0;
    8000119e:	14048c23          	sb	zero,344(s1)
  p->chan = 0;
    800011a2:	0204b023          	sd	zero,32(s1)
  p->killed = 0;
    800011a6:	0204a423          	sw	zero,40(s1)
  p->xstate = 0;
    800011aa:	0204a623          	sw	zero,44(s1)
  p->state = UNUSED;
    800011ae:	0004ac23          	sw	zero,24(s1)
}
