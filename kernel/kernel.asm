...
kfree(void *pa)
{
  ...
  acquire(&kmem.lock);
    ...
    8000005e:	1a6080e7          	jalr	422(ra) # 80006200 <acquire>
  ...
  release(&kmem.lock);
    ...
    80000072:	246080e7          	jalr	582(ra) # 800062b4 <release>
}
...
00000000800000dc <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    800000f8:	07c080e7          	jalr	124(ra) # 80006170 <initlock>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000130:	0d4080e7          	jalr	212(ra) # 80006200 <acquire>
  r = kmem.freelist;
  ...
  release(&kmem.lock);
    ...
    80000148:	170080e7          	jalr	368(ra) # 800062b4 <release>
  ...
  release(&kmem.lock);
    ...
    80000172:	146080e7          	jalr	326(ra) # 800062b4 <release>
  if(r)
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000d94:	3e0080e7          	jalr	992(ra) # 80006170 <initlock>
  initlock(&wait_lock, "wait_lock");
    ...
    80000dac:	3c8080e7          	jalr	968(ra) # 80006170 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000de2:	392080e7          	jalr	914(ra) # 80006170 <initlock>
      p->kstack = KSTACK((int) (p - proc));
...
myproc(void) {
  ...
  push_off();
    ...
    80000e56:	362080e7          	jalr	866(ra) # 800061b4 <push_off>
  ...
  pop_off();
    ...
    80000e70:	3e8080e7          	jalr	1000(ra) # 80006254 <pop_off>
  return p;
}
...
forkret(void)
{
  ...
  release(&myproc()->lock);
    ...
    80000e94:	424080e7          	jalr	1060(ra) # 800062b4 <release>

  if (first) {
    80000e98:	00008797          	auipc	a5,0x8
    80000e9c:	9a87a783          	lw	a5,-1624(a5) # 80008840 <first.1682>
  ...
  usertrapret();
    ...
    80000eb6:	9807a723          	sw	zero,-1650(a5) # 80008840 <first.1682>
    fsinit(ROOTDEV);
...
allocpid() {
  ...
  acquire(&pid_lock);
    ...
    80000ee0:	324080e7          	jalr	804(ra) # 80006200 <acquire>
  pid = nextpid;
  ...
  release(&pid_lock);
    ...
    80000efa:	3be080e7          	jalr	958(ra) # 800062b4 <release>
}
...
0000000080001052 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001074:	190080e7          	jalr	400(ra) # 80006200 <acquire>
    if(p->state == UNUSED) {
    ...
    80001082:	236080e7          	jalr	566(ra) # 800062b4 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  p->sigreturned = 1;
    ...
    8000110e:	1aa080e7          	jalr	426(ra) # 800062b4 <release>
    return 0;
    ...
    80001126:	192080e7          	jalr	402(ra) # 800062b4 <release>
    return 0;
...
000000008000112e <userinit>:
{
  ...
  uvminit(p->pagetable, initcode, sizeof(initcode));
    ...
    80001152:	70258593          	addi	a1,a1,1794 # 80008850 <initcode>
  ...
  release(&p->lock);
    ...
    800011a2:	116080e7          	jalr	278(ra) # 800062b4 <release>
}
...
0000000080001224 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    800012ba:	ffe080e7          	jalr	-2(ra) # 800062b4 <release>
    return -1;
  ...
  release(&np->lock);
    ...
    8000130c:	fac080e7          	jalr	-84(ra) # 800062b4 <release>
  acquire(&wait_lock);
    ...
    8000131e:	ee6080e7          	jalr	-282(ra) # 80006200 <acquire>
  np->parent = p;
    80001322:	0329bc23          	sd	s2,56(s3)
  release(&wait_lock);
    80001326:	8526                	mv	a0,s1
    80001328:	00005097          	auipc	ra,0x5
    8000132c:	f8c080e7          	jalr	-116(ra) # 800062b4 <release>
  acquire(&np->lock);
    80001330:	854e                	mv	a0,s3
    80001332:	00005097          	auipc	ra,0x5
    80001336:	ece080e7          	jalr	-306(ra) # 80006200 <acquire>
  np->state = RUNNABLE;
  ...
  release(&np->lock);
    ...
    80001346:	f72080e7          	jalr	-142(ra) # 800062b4 <release>
}
...
0000000080001360 <scheduler>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    800013e2:	ed6080e7          	jalr	-298(ra) # 800062b4 <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800013f4:	e10080e7          	jalr	-496(ra) # 80006200 <acquire>
      if(p->state == RUNNABLE) {
...
0000000080001400 <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    8000141c:	d6e080e7          	jalr	-658(ra) # 80006186 <holding>
...
00000000800014d6 <yield>:
{
  ...
  acquire(&p->lock);
    ...
    800014ee:	d16080e7          	jalr	-746(ra) # 80006200 <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    80001504:	db4080e7          	jalr	-588(ra) # 800062b4 <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    ...
    80001532:	cd2080e7          	jalr	-814(ra) # 80006200 <acquire>
  release(lk);
    80001536:	854a                	mv	a0,s2
    80001538:	00005097          	auipc	ra,0x5
    8000153c:	d7c080e7          	jalr	-644(ra) # 800062b4 <release>
  ...
  release(&p->lock);
    ...
    8000155a:	d5e080e7          	jalr	-674(ra) # 800062b4 <release>
  acquire(lk);
    8000155e:	854a                	mv	a0,s2
    80001560:	00005097          	auipc	ra,0x5
    80001564:	ca0080e7          	jalr	-864(ra) # 80006200 <acquire>
}
...
0000000080001576 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    800015a6:	c5e080e7          	jalr	-930(ra) # 80006200 <acquire>
    havekids = 0;
    ...
    80001644:	bc0080e7          	jalr	-1088(ra) # 80006200 <acquire>
        if(np->state == ZOMBIE){
    ...
    80001654:	c64080e7          	jalr	-924(ra) # 800062b4 <release>
        havekids = 1;
    ...
    80001670:	c48080e7          	jalr	-952(ra) # 800062b4 <release>
      return -1;
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800016d2:	be6080e7          	jalr	-1050(ra) # 800062b4 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800016f0:	b14080e7          	jalr	-1260(ra) # 80006200 <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
...
000000008000176e <exit>:
{
  ...
  if(p == initproc)
    ...
    800017aa:	4a2080e7          	jalr	1186(ra) # 80005c48 <panic>
      fileclose(f);
  ...
  acquire(&wait_lock);
    ...
    800017f4:	a10080e7          	jalr	-1520(ra) # 80006200 <acquire>
  reparent(p);
  ...
  acquire(&p->lock);
    ...
    80001814:	9f0080e7          	jalr	-1552(ra) # 80006200 <acquire>
  p->xstate = status;
  ...
  release(&wait_lock);
    ...
    80001828:	a90080e7          	jalr	-1392(ra) # 800062b4 <release>
  sched();
  ...
  panic("zombie exit");
    ...
    80001840:	40c080e7          	jalr	1036(ra) # 80005c48 <panic>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    8000186a:	99a080e7          	jalr	-1638(ra) # 80006200 <acquire>
    if(p->pid == pid){
    ...
    8000187a:	a3e080e7          	jalr	-1474(ra) # 800062b4 <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    8000189c:	a1c080e7          	jalr	-1508(ra) # 800062b4 <release>
      return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    80001984:	312080e7          	jalr	786(ra) # 80005c92 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800019c6:	2d0080e7          	jalr	720(ra) # 80005c92 <printf>
    printf("\n");
    800019ca:	8552                	mv	a0,s4
    800019cc:	00004097          	auipc	ra,0x4
    800019d0:	2c6080e7          	jalr	710(ra) # 80005c92 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001a96:	6de080e7          	jalr	1758(ra) # 80006170 <initlock>
}
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001b70:	694080e7          	jalr	1684(ra) # 80006200 <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001b90:	728080e7          	jalr	1832(ra) # 800062b4 <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001bf8:	09e080e7          	jalr	158(ra) # 80005c92 <printf>
      plic_complete(irq);
    ...
    80001c0e:	516080e7          	jalr	1302(ra) # 80006120 <uartintr>
...
0000000080001c40 <usertrap>:
{
  ...
  usertrapret();
    ...
    80001cc2:	f8a080e7          	jalr	-118(ra) # 80005c48 <panic>
      exit(-1);
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001cf6:	fa0080e7          	jalr	-96(ra) # 80005c92 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001d0e:	f88080e7          	jalr	-120(ra) # 80005c92 <printf>
    p->killed = 1;
...
0000000080001d9c <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001df6:	e56080e7          	jalr	-426(ra) # 80005c48 <panic>
    ...
    80001e06:	e46080e7          	jalr	-442(ra) # 80005c48 <panic>
    printf("scause %p\n", scause);
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001e40:	e0c080e7          	jalr	-500(ra) # 80005c48 <panic>
  if(which_dev == 2 && myproc() != 0 && myproc()->state == RUNNING)
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001ecc:	d80080e7          	jalr	-640(ra) # 80005c48 <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002034:	c62080e7          	jalr	-926(ra) # 80005c92 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  uint ticks0;
   backtrace();
    ...
    8000213e:	d70080e7          	jalr	-656(ra) # 80005eaa <backtrace>
  if(argint(0, &n) < 0)
  ...
  acquire(&tickslock);
    ...
    80002162:	0a2080e7          	jalr	162(ra) # 80006200 <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    800021b6:	102080e7          	jalr	258(ra) # 800062b4 <release>
  return 0;
    ...
    800021d8:	0e0080e7          	jalr	224(ra) # 800062b4 <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002228:	fdc080e7          	jalr	-36(ra) # 80006200 <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    80002240:	078080e7          	jalr	120(ra) # 800062b4 <release>
  return xticks;
}
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    8000232a:	e4a080e7          	jalr	-438(ra) # 80006170 <initlock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    800023b2:	e52080e7          	jalr	-430(ra) # 80006200 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    800023f2:	ec6080e7          	jalr	-314(ra) # 800062b4 <release>
      acquiresleep(&b->lock);
  ...
  panic("bget: no buffers");
    ...
    80002430:	81c080e7          	jalr	-2020(ra) # 80005c48 <panic>
      b->dev = dev;
    ...
    80002450:	e68080e7          	jalr	-408(ra) # 800062b4 <release>
      acquiresleep(&b->lock);
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    800024c0:	78c080e7          	jalr	1932(ra) # 80005c48 <panic>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    800024f8:	d0c080e7          	jalr	-756(ra) # 80006200 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002542:	d76080e7          	jalr	-650(ra) # 800062b4 <release>
}
    ...
    8000255e:	6ee080e7          	jalr	1774(ra) # 80005c48 <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000257a:	c8a080e7          	jalr	-886(ra) # 80006200 <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    80002590:	d28080e7          	jalr	-728(ra) # 800062b4 <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800025b6:	c4e080e7          	jalr	-946(ra) # 80006200 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    800025cc:	cec080e7          	jalr	-788(ra) # 800062b4 <release>
}
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    80002652:	5fa080e7          	jalr	1530(ra) # 80005c48 <panic>
...
0000000080002656 <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    80002718:	534080e7          	jalr	1332(ra) # 80005c48 <panic>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    8000285e:	3ee080e7          	jalr	1006(ra) # 80005c48 <panic>
...
0000000080002862 <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    80002882:	982080e7          	jalr	-1662(ra) # 80006200 <acquire>
  empty = 0;
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    800028c8:	9f0080e7          	jalr	-1552(ra) # 800062b4 <release>
      return ip;
  ...
  release(&itable.lock);
    ...
    800028f8:	9c0080e7          	jalr	-1600(ra) # 800062b4 <release>
}
    ...
    8000291a:	332080e7          	jalr	818(ra) # 80005c48 <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    8000299a:	2b2080e7          	jalr	690(ra) # 80005c48 <panic>
...
000000008000299e <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    800029c0:	7b4080e7          	jalr	1972(ra) # 80006170 <initlock>
  for(i = 0; i < NINODE; i++) {
...
00000000800029fe <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    80002a7e:	1ce080e7          	jalr	462(ra) # 80005c48 <panic>
...
0000000080002b58 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002b70:	694080e7          	jalr	1684(ra) # 80006200 <acquire>
  ip->ref++;
  ...
  release(&itable.lock);
    ...
    80002b86:	732080e7          	jalr	1842(ra) # 800062b4 <release>
}
...
0000000080002b96 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002bd2:	07a080e7          	jalr	122(ra) # 80005c48 <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002c54:	ff8080e7          	jalr	-8(ra) # 80005c48 <panic>
...
0000000080002c58 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002ca0:	fac080e7          	jalr	-84(ra) # 80005c48 <panic>
...
0000000080002d50 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80002d6a:	49a080e7          	jalr	1178(ra) # 80006200 <acquire>
  ...
  release(&itable.lock);
    ...
    80002d88:	530080e7          	jalr	1328(ra) # 800062b4 <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002dbc:	4fc080e7          	jalr	1276(ra) # 800062b4 <release>
    itrunc(ip);
    ...
    80002df2:	412080e7          	jalr	1042(ra) # 80006200 <acquire>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    800030b0:	b9c080e7          	jalr	-1124(ra) # 80005c48 <panic>
    ...
    800030c0:	b8c080e7          	jalr	-1140(ra) # 80005c48 <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
...
00000000800034c4 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    800034ec:	c88080e7          	jalr	-888(ra) # 80006170 <initlock>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003580:	c84080e7          	jalr	-892(ra) # 80006200 <acquire>
  while(1){
    if(log.committing){
    ...
    800035d8:	ce0080e7          	jalr	-800(ra) # 800062b4 <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003608:	bfc080e7          	jalr	-1028(ra) # 80006200 <acquire>
  log.outstanding -= 1;
  ...
  release(&log.lock);
    ...
    80003630:	c88080e7          	jalr	-888(ra) # 800062b4 <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80003648:	bbc080e7          	jalr	-1092(ra) # 80006200 <acquire>
    log.committing = 0;
    ...
    80003660:	c58080e7          	jalr	-936(ra) # 800062b4 <release>
}
    ...
    80003682:	5ca080e7          	jalr	1482(ra) # 80005c48 <panic>
    wakeup(&log);
  ...
  release(&log.lock);
    ...
    8000369e:	c1a080e7          	jalr	-998(ra) # 800062b4 <release>
  if(do_commit){
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    8000375c:	aa8080e7          	jalr	-1368(ra) # 80006200 <acquire>
  ...
  release(&log.lock);
    ...
    80003816:	aa2080e7          	jalr	-1374(ra) # 800062b4 <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    80003844:	930080e7          	jalr	-1744(ra) # 80006170 <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003878:	98c080e7          	jalr	-1652(ra) # 80006200 <acquire>
  while (lk->locked) {
  ...
  release(&lk->lk);
    ...
    800038a6:	a12080e7          	jalr	-1518(ra) # 800062b4 <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800038ce:	936080e7          	jalr	-1738(ra) # 80006200 <acquire>
  lk->locked = 0;
  ...
  release(&lk->lk);
    ...
    800038ea:	9ce080e7          	jalr	-1586(ra) # 800062b4 <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003914:	8f0080e7          	jalr	-1808(ra) # 80006200 <acquire>
  ...
  release(&lk->lk);
    ...
    80003924:	994080e7          	jalr	-1644(ra) # 800062b4 <release>
  return r;
}
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    8000396c:	808080e7          	jalr	-2040(ra) # 80006170 <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    8000398e:	876080e7          	jalr	-1930(ra) # 80006200 <acquire>
  ...
  release(&ftable.lock);
    ...
    800039ba:	8fe080e7          	jalr	-1794(ra) # 800062b4 <release>
  return 0;
    ...
    800039d2:	8e6080e7          	jalr	-1818(ra) # 800062b4 <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800039fa:	80a080e7          	jalr	-2038(ra) # 80006200 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    80003a14:	8a4080e7          	jalr	-1884(ra) # 800062b4 <release>
  return f;
}
    ...
    80003a30:	21c080e7          	jalr	540(ra) # 80005c48 <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003a54:	7b0080e7          	jalr	1968(ra) # 80006200 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    80003a8e:	82a080e7          	jalr	-2006(ra) # 800062b4 <release>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80003c20:	02c080e7          	jalr	44(ra) # 80005c48 <panic>
    return -1;
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  return ret;
    ...
    80003d54:	ef8080e7          	jalr	-264(ra) # 80005c48 <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003dc4:	3b0080e7          	jalr	944(ra) # 80006170 <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003e52:	3b2080e7          	jalr	946(ra) # 80006200 <acquire>
  if(writable){
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003e76:	442080e7          	jalr	1090(ra) # 800062b4 <release>
    kfree((char*)pi);
    ...
    80003ea8:	410080e7          	jalr	1040(ra) # 800062b4 <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003ede:	326080e7          	jalr	806(ra) # 80006200 <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003efc:	3bc080e7          	jalr	956(ra) # 800062b4 <release>
      return -1;
  ...
  release(&pi->lock);
    ...
    80003f9e:	31a080e7          	jalr	794(ra) # 800062b4 <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003fd4:	230080e7          	jalr	560(ra) # 80006200 <acquire>
  ...
  release(&pi->lock);
    ...
    80004068:	250080e7          	jalr	592(ra) # 800062b4 <release>
  return i;
}
    ...
    80004088:	230080e7          	jalr	560(ra) # 800062b4 <release>
      return -1;
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004190:	abc080e7          	jalr	-1348(ra) # 80005c48 <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    800045c2:	68a080e7          	jalr	1674(ra) # 80005c48 <panic>
    dp->nlink++;  // for ".."
...
0000000080004930 <sys_unlink>:
{
  ...
  return 0;
    ...
    80004a5c:	1f0080e7          	jalr	496(ra) # 80005c48 <panic>
...
0000000080005242 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005260:	f14080e7          	jalr	-236(ra) # 80006170 <initlock>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800053c0:	e44080e7          	jalr	-444(ra) # 80006200 <acquire>
  for(int i = 0; i < 3; i++){
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  release(&disk.vdisk_lock);
    ...
    800055fa:	cbe080e7          	jalr	-834(ra) # 800062b4 <release>
}
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005674:	b90080e7          	jalr	-1136(ra) # 80006200 <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80005706:	bb2080e7          	jalr	-1102(ra) # 800062b4 <release>
}
...
consolewrite(int user_src, uint64 src, int n)
{
  ...
  for(i = 0; i < n; i++){
    ...
    8000584a:	7fc080e7          	jalr	2044(ra) # 80006042 <uartputc>
  for(i = 0; i < n; i++){
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    800058a2:	962080e7          	jalr	-1694(ra) # 80006200 <acquire>
  while(n > 0){
  ...
  release(&cons.lock);
    ...
    8000593a:	97e080e7          	jalr	-1666(ra) # 800062b4 <release>
  ...
  return target - n;
    ...
    80005950:	968080e7          	jalr	-1688(ra) # 800062b4 <release>
        return -1;
...
0000000080005986 <consputc>:
{
  ...
  if(c == BACKSPACE){
    ...
    8000599a:	5d2080e7          	jalr	1490(ra) # 80005f68 <uartputc_sync>
}
    ...
    800059ac:	5c0080e7          	jalr	1472(ra) # 80005f68 <uartputc_sync>
    800059b0:	02000513          	li	a0,32
    800059b4:	00000097          	auipc	ra,0x0
    800059b8:	5b4080e7          	jalr	1460(ra) # 80005f68 <uartputc_sync>
    800059bc:	4521                	li	a0,8
    800059be:	00000097          	auipc	ra,0x0
    800059c2:	5aa080e7          	jalr	1450(ra) # 80005f68 <uartputc_sync>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    800059e2:	822080e7          	jalr	-2014(ra) # 80006200 <acquire>
  ...
  release(&cons.lock);
    ...
    80005a10:	8a8080e7          	jalr	-1880(ra) # 800062b4 <release>
}
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80005b76:	5fe080e7          	jalr	1534(ra) # 80006170 <initlock>

  uartinit();
    80005b7a:	00000097          	auipc	ra,0x0
    80005b7e:	39e080e7          	jalr	926(ra) # 80005f18 <uartinit>
...
printint(int xx, int base, int sign)
{
  ...
  do {
    ...
    80005bc8:	c2460613          	addi	a2,a2,-988 # 800087e8 <digits>
...
panic(char *s)
{
  ...
  pr.locking = 0;
    80005c54:	00024797          	auipc	a5,0x24
    80005c58:	5a07a623          	sw	zero,1452(a5) # 8002a200 <pr+0x18>
  printf("panic: ");
    80005c5c:	00003517          	auipc	a0,0x3
    80005c60:	b4c50513          	addi	a0,a0,-1204 # 800087a8 <syscalls+0x3e0>
...
0000000080005c92 <printf>:
{
  ...
  locking = pr.locking;
    80005cc4:	00024d97          	auipc	s11,0x24
    80005cc8:	53cdad83          	lw	s11,1340(s11) # 8002a200 <pr+0x18>
  if(locking)
  ...
  consputc('x');
    ...
    80005cf4:	af8b8b93          	addi	s7,s7,-1288 # 800087e8 <digits>
    switch(c){
    80005cf8:	07300c93          	li	s9,115
    80005cfc:	06400c13          	li	s8,100
    80005d00:	a82d                	j	80005d3a <printf+0xa8>
    acquire(&pr.lock);
    80005d02:	00024517          	auipc	a0,0x24
    80005d06:	4e650513          	addi	a0,a0,1254 # 8002a1e8 <pr>
    80005d0a:	00000097          	auipc	ra,0x0
    80005d0e:	4f6080e7          	jalr	1270(ra) # 80006200 <acquire>
    80005d12:	bf7d                	j	80005cd0 <printf+0x3e>
    panic("null fmt");
    80005d14:	00003517          	auipc	a0,0x3
    80005d18:	aa450513          	addi	a0,a0,-1372 # 800087b8 <syscalls+0x3f0>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    80005e18:	99c90913          	addi	s2,s2,-1636 # 800087b0 <syscalls+0x3e8>
      for(; *s; s++)
  ...
  if(locking)
    ...
    80005e64:	8082                	ret
    release(&pr.lock);
    80005e66:	00024517          	auipc	a0,0x24
    80005e6a:	38250513          	addi	a0,a0,898 # 8002a1e8 <pr>
    80005e6e:	00000097          	auipc	ra,0x0
    80005e72:	446080e7          	jalr	1094(ra) # 800062b4 <release>
}
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    80005e82:	00024497          	auipc	s1,0x24
    80005e86:	36648493          	addi	s1,s1,870 # 8002a1e8 <pr>
    80005e8a:	00003597          	auipc	a1,0x3
    80005e8e:	93e58593          	addi	a1,a1,-1730 # 800087c8 <syscalls+0x400>
    80005e92:	8526                	mv	a0,s1
    80005e94:	00000097          	auipc	ra,0x0
    80005e98:	2dc080e7          	jalr	732(ra) # 80006170 <initlock>
  pr.locking = 1;
...
backtrace(void)
{
  ...
  printf("backtrace:\n");
    ...
    80005ebe:	91650513          	addi	a0,a0,-1770 # 800087d0 <syscalls+0x408>
...
r_fp()
{
  ...
  asm volatile("mv %0, s0" : "=r" (x) );
    80005eca:	87a2                	mv	a5,s0
  for (uint64 *fp = (uint64 *)r_fp(); (uint64)fp < PGROUNDUP((uint64)fp); fp = (uint64 *)(*(fp-2)))
    80005ecc:	84be                	mv	s1,a5
    80005ece:	6705                	lui	a4,0x1
    80005ed0:	177d                	addi	a4,a4,-1
    80005ed2:	97ba                	add	a5,a5,a4
    80005ed4:	777d                	lui	a4,0xfffff
    80005ed6:	8ff9                	and	a5,a5,a4
    80005ed8:	02f4f863          	bgeu	s1,a5,80005f08 <backtrace+0x5e>
  {
    printf("%p\n",*(fp-1));
    80005edc:	00003a17          	auipc	s4,0x3
    80005ee0:	904a0a13          	addi	s4,s4,-1788 # 800087e0 <syscalls+0x418>
  for (uint64 *fp = (uint64 *)r_fp(); (uint64)fp < PGROUNDUP((uint64)fp); fp = (uint64 *)(*(fp-2)))
    80005ee4:	6905                	lui	s2,0x1
    80005ee6:	197d                	addi	s2,s2,-1
    80005ee8:	79fd                	lui	s3,0xfffff
    printf("%p\n",*(fp-1));
    80005eea:	ff84b583          	ld	a1,-8(s1)
    80005eee:	8552                	mv	a0,s4
    80005ef0:	00000097          	auipc	ra,0x0
    80005ef4:	da2080e7          	jalr	-606(ra) # 80005c92 <printf>
  for (uint64 *fp = (uint64 *)r_fp(); (uint64)fp < PGROUNDUP((uint64)fp); fp = (uint64 *)(*(fp-2)))
    80005ef8:	ff04b483          	ld	s1,-16(s1)
    80005efc:	012487b3          	add	a5,s1,s2
    80005f00:	0137f7b3          	and	a5,a5,s3
    80005f04:	fef4e3e3          	bltu	s1,a5,80005eea <backtrace+0x40>
  }
}
    80005f08:	70a2                	ld	ra,40(sp)
    80005f0a:	7402                	ld	s0,32(sp)
    80005f0c:	64e2                	ld	s1,24(sp)
    80005f0e:	6942                	ld	s2,16(sp)
    80005f10:	69a2                	ld	s3,8(sp)
    80005f12:	6a02                	ld	s4,0(sp)
    80005f14:	6145                	addi	sp,sp,48
    80005f16:	8082                	ret

0000000080005f18 <uartinit>:
...
uartinit(void)
{
  ...
  // disable interrupts.
  WriteReg(IER, 0x00);
    80005f20:	100007b7          	lui	a5,0x10000
    80005f24:	000780a3          	sb	zero,1(a5) # 10000001 <_entry-0x6fffffff>

  // special mode to set baud rate.
  WriteReg(LCR, LCR_BAUD_LATCH);
    80005f28:	f8000713          	li	a4,-128
    80005f2c:	00e781a3          	sb	a4,3(a5)

  // LSB for baud rate of 38.4K.
  WriteReg(0, 0x03);
    80005f30:	470d                	li	a4,3
    80005f32:	00e78023          	sb	a4,0(a5)

  // MSB for baud rate of 38.4K.
  WriteReg(1, 0x00);
    80005f36:	000780a3          	sb	zero,1(a5)

  // leave set-baud mode,
  // and set word length to 8 bits, no parity.
  WriteReg(LCR, LCR_EIGHT_BITS);
    80005f3a:	00e781a3          	sb	a4,3(a5)

  // reset and enable FIFOs.
  WriteReg(FCR, FCR_FIFO_ENABLE | FCR_FIFO_CLEAR);
    80005f3e:	469d                	li	a3,7
    80005f40:	00d78123          	sb	a3,2(a5)

  // enable transmit and receive interrupts.
  WriteReg(IER, IER_TX_ENABLE | IER_RX_ENABLE);
    80005f44:	00e780a3          	sb	a4,1(a5)

  initlock(&uart_tx_lock, "uart");
    80005f48:	00003597          	auipc	a1,0x3
    80005f4c:	8b858593          	addi	a1,a1,-1864 # 80008800 <digits+0x18>
    80005f50:	00024517          	auipc	a0,0x24
    80005f54:	2b850513          	addi	a0,a0,696 # 8002a208 <uart_tx_lock>
    80005f58:	00000097          	auipc	ra,0x0
    80005f5c:	218080e7          	jalr	536(ra) # 80006170 <initlock>
}
...
0000000080005f68 <uartputc_sync>:
...
uartputc_sync(int c)
{
  ...
  push_off();
    ...
    80005f78:	240080e7          	jalr	576(ra) # 800061b4 <push_off>

  if(panicked){
    80005f7c:	00003797          	auipc	a5,0x3
    80005f80:	0a07a783          	lw	a5,160(a5) # 8000901c <panicked>
    for(;;)
      ;
  }
  ...
  if(panicked){
    80005f88:	c391                	beqz	a5,80005f8c <uartputc_sync+0x24>
    for(;;)
    80005f8a:	a001                	j	80005f8a <uartputc_sync+0x22>
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80005f8c:	00574783          	lbu	a5,5(a4) # 10000005 <_entry-0x6ffffffb>
    80005f90:	0ff7f793          	andi	a5,a5,255
    80005f94:	0207f793          	andi	a5,a5,32
    80005f98:	dbf5                	beqz	a5,80005f8c <uartputc_sync+0x24>
    ;
  WriteReg(THR, c);
    80005f9a:	0ff4f793          	andi	a5,s1,255
    80005f9e:	10000737          	lui	a4,0x10000
    80005fa2:	00f70023          	sb	a5,0(a4) # 10000000 <_entry-0x70000000>

  pop_off();
    80005fa6:	00000097          	auipc	ra,0x0
    80005faa:	2ae080e7          	jalr	686(ra) # 80006254 <pop_off>
}
...
uartstart()
{
  while(1){
    ...
    80005fbc:	06873703          	ld	a4,104(a4) # 80009020 <uart_tx_r>
    80005fc0:	00003797          	auipc	a5,0x3
    80005fc4:	0687b783          	ld	a5,104(a5) # 80009028 <uart_tx_w>
    80005fc8:	06e78c63          	beq	a5,a4,80006040 <uartstart+0x88>
{
    80005fcc:	7139                	addi	sp,sp,-64
    80005fce:	fc06                	sd	ra,56(sp)
    80005fd0:	f822                	sd	s0,48(sp)
    80005fd2:	f426                	sd	s1,40(sp)
    80005fd4:	f04a                	sd	s2,32(sp)
    80005fd6:	ec4e                	sd	s3,24(sp)
    80005fd8:	e852                	sd	s4,16(sp)
    80005fda:	e456                	sd	s5,8(sp)
    ...
    80005fde:	10000937          	lui	s2,0x10000
    ...
    80005fe2:	00024a17          	auipc	s4,0x24
    80005fe6:	226a0a13          	addi	s4,s4,550 # 8002a208 <uart_tx_lock>
    uart_tx_r += 1;
    80005fea:	00003497          	auipc	s1,0x3
    80005fee:	03648493          	addi	s1,s1,54 # 80009020 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    80005ff2:	00003997          	auipc	s3,0x3
    80005ff6:	03698993          	addi	s3,s3,54 # 80009028 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80005ffa:	00594783          	lbu	a5,5(s2) # 10000005 <_entry-0x6ffffffb>
    80005ffe:	0ff7f793          	andi	a5,a5,255
    80006002:	0207f793          	andi	a5,a5,32
    80006006:	c785                	beqz	a5,8000602e <uartstart+0x76>
    int c = uart_tx_buf[uart_tx_r % UART_TX_BUF_SIZE];
    80006008:	01f77793          	andi	a5,a4,31
    8000600c:	97d2                	add	a5,a5,s4
    8000600e:	0187ca83          	lbu	s5,24(a5)
    uart_tx_r += 1;
    80006012:	0705                	addi	a4,a4,1
    80006014:	e098                	sd	a4,0(s1)
    
    // maybe uartputc() is waiting for space in the buffer.
    wakeup(&uart_tx_r);
    80006016:	8526                	mv	a0,s1
    80006018:	ffffb097          	auipc	ra,0xffffb
    8000601c:	686080e7          	jalr	1670(ra) # 8000169e <wakeup>
    
    WriteReg(THR, c);
    80006020:	01590023          	sb	s5,0(s2)
    if(uart_tx_w == uart_tx_r){
    80006024:	6098                	ld	a4,0(s1)
    80006026:	0009b783          	ld	a5,0(s3)
    8000602a:	fce798e3          	bne	a5,a4,80005ffa <uartstart+0x42>
  }
}
    8000602e:	70e2                	ld	ra,56(sp)
    80006030:	7442                	ld	s0,48(sp)
    80006032:	74a2                	ld	s1,40(sp)
    80006034:	7902                	ld	s2,32(sp)
    80006036:	69e2                	ld	s3,24(sp)
    80006038:	6a42                	ld	s4,16(sp)
...
0000000080006042 <uartputc>:
{
    ...
    8000604a:	e84a                	sd	s2,16(sp)
    8000604c:	e44e                	sd	s3,8(sp)
    8000604e:	e052                	sd	s4,0(sp)
    80006050:	1800                	addi	s0,sp,48
    80006052:	89aa                	mv	s3,a0
  acquire(&uart_tx_lock);
    80006054:	00024517          	auipc	a0,0x24
    80006058:	1b450513          	addi	a0,a0,436 # 8002a208 <uart_tx_lock>
    8000605c:	00000097          	auipc	ra,0x0
    80006060:	1a4080e7          	jalr	420(ra) # 80006200 <acquire>
  if(panicked){
    80006064:	00003797          	auipc	a5,0x3
    80006068:	fb87a783          	lw	a5,-72(a5) # 8000901c <panicked>
    8000606c:	c391                	beqz	a5,80006070 <uartputc+0x2e>
    for(;;)
    8000606e:	a001                	j	8000606e <uartputc+0x2c>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006070:	00003797          	auipc	a5,0x3
    80006074:	fb87b783          	ld	a5,-72(a5) # 80009028 <uart_tx_w>
    80006078:	00003717          	auipc	a4,0x3
    8000607c:	fa873703          	ld	a4,-88(a4) # 80009020 <uart_tx_r>
    80006080:	02070713          	addi	a4,a4,32
    80006084:	02f71b63          	bne	a4,a5,800060ba <uartputc+0x78>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006088:	00024a17          	auipc	s4,0x24
    8000608c:	180a0a13          	addi	s4,s4,384 # 8002a208 <uart_tx_lock>
    ...
    8000609c:	f9090913          	addi	s2,s2,-112 # 80009028 <uart_tx_w>
      sleep(&uart_tx_r, &uart_tx_lock);
    800060a0:	85d2                	mv	a1,s4
    800060a2:	8526                	mv	a0,s1
    800060a4:	ffffb097          	auipc	ra,0xffffb
    800060a8:	46e080e7          	jalr	1134(ra) # 80001512 <sleep>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    800060ac:	00093783          	ld	a5,0(s2)
    800060b0:	6098                	ld	a4,0(s1)
    800060b2:	02070713          	addi	a4,a4,32
    800060b6:	fef705e3          	beq	a4,a5,800060a0 <uartputc+0x5e>
      uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    800060ba:	00024497          	auipc	s1,0x24
    800060be:	14e48493          	addi	s1,s1,334 # 8002a208 <uart_tx_lock>
    800060c2:	01f7f713          	andi	a4,a5,31
    800060c6:	9726                	add	a4,a4,s1
    800060c8:	01370c23          	sb	s3,24(a4)
      uart_tx_w += 1;
    800060cc:	0785                	addi	a5,a5,1
    800060ce:	00003717          	auipc	a4,0x3
    800060d2:	f4f73d23          	sd	a5,-166(a4) # 80009028 <uart_tx_w>
      uartstart();
    800060d6:	00000097          	auipc	ra,0x0
    800060da:	ee2080e7          	jalr	-286(ra) # 80005fb8 <uartstart>
      release(&uart_tx_lock);
    800060de:	8526                	mv	a0,s1
    800060e0:	00000097          	auipc	ra,0x0
    800060e4:	1d4080e7          	jalr	468(ra) # 800062b4 <release>
}
    800060e8:	70a2                	ld	ra,40(sp)
    800060ea:	7402                	ld	s0,32(sp)
    800060ec:	64e2                	ld	s1,24(sp)
    800060ee:	6942                	ld	s2,16(sp)
    800060f0:	69a2                	ld	s3,8(sp)
...
uartgetc(void)
{
  ...
  if(ReadReg(LSR) & 0x01){
    ...
    80006102:	0057c783          	lbu	a5,5(a5) # 10000005 <_entry-0x6ffffffb>
    80006106:	8b85                	andi	a5,a5,1
    80006108:	cb91                	beqz	a5,8000611c <uartgetc+0x24>
    // input data is ready.
    return ReadReg(RHR);
    8000610a:	100007b7          	lui	a5,0x10000
    8000610e:	0007c503          	lbu	a0,0(a5) # 10000000 <_entry-0x70000000>
    80006112:	0ff57513          	andi	a0,a0,255
  } else {
    return -1;
  }
}
    ...
    8000611e:	bfe5                	j	80006116 <uartgetc+0x1e>

0000000080006120 <uartintr>:
...
uartintr(void)
{
  ...
  while(1){
    int c = uartgetc();
    if(c == -1)
    8000612a:	54fd                	li	s1,-1
    int c = uartgetc();
    8000612c:	00000097          	auipc	ra,0x0
    80006130:	fcc080e7          	jalr	-52(ra) # 800060f8 <uartgetc>
    if(c == -1)
    80006134:	00950763          	beq	a0,s1,80006142 <uartintr+0x22>
      break;
    consoleintr(c);
    80006138:	00000097          	auipc	ra,0x0
    8000613c:	890080e7          	jalr	-1904(ra) # 800059c8 <consoleintr>
  while(1){
    80006140:	b7f5                	j	8000612c <uartintr+0xc>
  }

  // send buffered characters.
  acquire(&uart_tx_lock);
    80006142:	00024497          	auipc	s1,0x24
    80006146:	0c648493          	addi	s1,s1,198 # 8002a208 <uart_tx_lock>
    8000614a:	8526                	mv	a0,s1
    8000614c:	00000097          	auipc	ra,0x0
    80006150:	0b4080e7          	jalr	180(ra) # 80006200 <acquire>
  uartstart();
    80006154:	00000097          	auipc	ra,0x0
    80006158:	e64080e7          	jalr	-412(ra) # 80005fb8 <uartstart>
  release(&uart_tx_lock);
    8000615c:	8526                	mv	a0,s1
    8000615e:	00000097          	auipc	ra,0x0
    80006162:	156080e7          	jalr	342(ra) # 800062b4 <release>
}
...
holding(struct spinlock *lk)
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    80006186:	411c                	lw	a5,0(a0)
    80006188:	e399                	bnez	a5,8000618e <holding+0x8>
    ...
    8000618c:	8082                	ret
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    80006198:	6904                	ld	s1,16(a0)
    8000619a:	ffffb097          	auipc	ra,0xffffb
    8000619e:	c92080e7          	jalr	-878(ra) # 80000e2c <mycpu>
    800061a2:	40a48533          	sub	a0,s1,a0
    800061a6:	00153513          	seqz	a0,a0
}
...
push_off(void)
{
  ...
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800061be:	100024f3          	csrr	s1,sstatus
    800061c2:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() & ~SSTATUS_SIE);
    800061c6:	9bf5                	andi	a5,a5,-3
  asm volatile("csrw sstatus, %0" : : "r" (x));
    800061c8:	10079073          	csrw	sstatus,a5
  int old = intr_get();

  intr_off();
  if(mycpu()->noff == 0)
    800061cc:	ffffb097          	auipc	ra,0xffffb
    800061d0:	c60080e7          	jalr	-928(ra) # 80000e2c <mycpu>
    800061d4:	5d3c                	lw	a5,120(a0)
    800061d6:	cf89                	beqz	a5,800061f0 <push_off+0x3c>
    mycpu()->intena = old;
  mycpu()->noff += 1;
    800061d8:	ffffb097          	auipc	ra,0xffffb
    800061dc:	c54080e7          	jalr	-940(ra) # 80000e2c <mycpu>
    800061e0:	5d3c                	lw	a5,120(a0)
    800061e2:	2785                	addiw	a5,a5,1
    800061e4:	dd3c                	sw	a5,120(a0)
}
    ...
    800061f4:	c3c080e7          	jalr	-964(ra) # 80000e2c <mycpu>
  return (x & SSTATUS_SIE) != 0;
    800061f8:	8085                	srli	s1,s1,0x1
    800061fa:	8885                	andi	s1,s1,1
    800061fc:	dd64                	sw	s1,124(a0)
    800061fe:	bfe9                	j	800061d8 <push_off+0x24>

0000000080006200 <acquire>:
{
  ...
  push_off(); // disable interrupts to avoid deadlock.
    ...
    80006210:	fa8080e7          	jalr	-88(ra) # 800061b4 <push_off>
  if(holding(lk))
    80006214:	8526                	mv	a0,s1
    80006216:	00000097          	auipc	ra,0x0
    8000621a:	f70080e7          	jalr	-144(ra) # 80006186 <holding>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0)
    8000621e:	4705                	li	a4,1
  if(holding(lk))
    80006220:	e115                	bnez	a0,80006244 <acquire+0x44>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0)
    80006222:	87ba                	mv	a5,a4
    80006224:	0cf4a7af          	amoswap.w.aq	a5,a5,(s1)
    80006228:	2781                	sext.w	a5,a5
    8000622a:	ffe5                	bnez	a5,80006222 <acquire+0x22>
  __sync_synchronize();
    8000622c:	0ff0000f          	fence
  lk->cpu = mycpu();
    80006230:	ffffb097          	auipc	ra,0xffffb
    80006234:	bfc080e7          	jalr	-1028(ra) # 80000e2c <mycpu>
    ...
    80006248:	5c450513          	addi	a0,a0,1476 # 80008808 <digits+0x20>
    8000624c:	00000097          	auipc	ra,0x0
    80006250:	9fc080e7          	jalr	-1540(ra) # 80005c48 <panic>

0000000080006254 <pop_off>:
...
pop_off(void)
{
  ...
  struct cpu *c = mycpu();
    ...
    80006260:	bd0080e7          	jalr	-1072(ra) # 80000e2c <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80006264:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    80006268:	8b89                	andi	a5,a5,2
  if(intr_get())
    8000626a:	e78d                	bnez	a5,80006294 <pop_off+0x40>
    panic("pop_off - interruptible");
  if(c->noff < 1)
    8000626c:	5d3c                	lw	a5,120(a0)
    8000626e:	02f05b63          	blez	a5,800062a4 <pop_off+0x50>
    panic("pop_off");
  c->noff -= 1;
    80006272:	37fd                	addiw	a5,a5,-1
    80006274:	0007871b          	sext.w	a4,a5
    80006278:	dd3c                	sw	a5,120(a0)
  if(c->noff == 0 && c->intena)
    8000627a:	eb09                	bnez	a4,8000628c <pop_off+0x38>
    8000627c:	5d7c                	lw	a5,124(a0)
    8000627e:	c799                	beqz	a5,8000628c <pop_off+0x38>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80006280:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() | SSTATUS_SIE);
    80006284:	0027e793          	ori	a5,a5,2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    80006288:	10079073          	csrw	sstatus,a5
    intr_on();
}
    ...
    80006298:	57c50513          	addi	a0,a0,1404 # 80008810 <digits+0x28>
    8000629c:	00000097          	auipc	ra,0x0
    800062a0:	9ac080e7          	jalr	-1620(ra) # 80005c48 <panic>
    panic("pop_off");
    800062a4:	00002517          	auipc	a0,0x2
    800062a8:	58450513          	addi	a0,a0,1412 # 80008828 <digits+0x40>
    800062ac:	00000097          	auipc	ra,0x0
    800062b0:	99c080e7          	jalr	-1636(ra) # 80005c48 <panic>

00000000800062b4 <release>:
{
    ...
    800062be:	84aa                	mv	s1,a0
  if(!holding(lk))
    800062c0:	00000097          	auipc	ra,0x0
    800062c4:	ec6080e7          	jalr	-314(ra) # 80006186 <holding>
    800062c8:	c115                	beqz	a0,800062ec <release+0x38>
  lk->cpu = 0;
    800062ca:	0004b823          	sd	zero,16(s1)
  __sync_synchronize();
    800062ce:	0ff0000f          	fence
  __sync_lock_release(&lk->locked);
    800062d2:	0f50000f          	fence	iorw,ow
    800062d6:	0804a02f          	amoswap.w	zero,zero,(s1)
  pop_off();
    800062da:	00000097          	auipc	ra,0x0
    800062de:	f7a080e7          	jalr	-134(ra) # 80006254 <pop_off>
}
    800062e2:	60e2                	ld	ra,24(sp)
    800062e4:	6442                	ld	s0,16(sp)
    800062e6:	64a2                	ld	s1,8(sp)
    800062e8:	6105                	addi	sp,sp,32
    800062ea:	8082                	ret
    panic("release");
    800062ec:	00002517          	auipc	a0,0x2
    800062f0:	54450513          	addi	a0,a0,1348 # 80008830 <digits+0x48>
    800062f4:	00000097          	auipc	ra,0x0
    800062f8:	954080e7          	jalr	-1708(ra) # 80005c48 <panic>
	...
